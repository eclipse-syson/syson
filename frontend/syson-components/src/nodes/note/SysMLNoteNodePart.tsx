...
import { GQLSysMLNoteNodeStyle, SysMLNoteNodePartProps } from './SysMLNoteNodePart.types';
import { useUpdateSysMLNoteNodeAppearance } from './useUpdateSysMLNoteNodeAppearance';
import { GQLSysMLNoteNodeAppearanceInput } from './useUpdateSysMLNoteNodeAppearance.types';
...
export const SysMLNoteNodePart = ({ element }: SysMLNoteNodePartProps) => {
  const style = element.data.nodeAppearanceData.gqlStyle as GQLSysMLNoteNodeStyle;
  ...
  const handleEditProperty = (newValue: Partial<GQLSysMLNoteNodeAppearanceInput>) =>
    updateSysMLNoteNodeAppearance(editingContextId, diagramId, element.id, newValue);
