...
- [releng] Switch to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.4.6]
...
- https://github.com/eclipse-syson/syson/issues/1339[#1339] [details] Make the Details view more extensible in how it determines whether an element is read-only or not.
