...
- https://github.com/eclipse-syson/syson/issues/1079[#1079] [metamodel] Align metamodel to SysMLv2 Beta 4 specification released on December 2024(see https://www.omg.org/spec/SysML/ for more details) and KerML Beta 4 specification released on December 2024(see https://www.omg.org/spec/KerML/ for more details).
...
* `InvocationExpression#operand` is now a containment reference
...
- [releng] Switch to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.2.1]
