...
- [releng] Update to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.8.2]
- [releng] Update to https://github.com/spring-projects/spring-boot/releases/tag/v3.5.4[Spring Boot 3.5.4]
