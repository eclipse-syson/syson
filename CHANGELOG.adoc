...
The first one creates a simple _ExhibitState_.
The second one shows a dialog allowing to select an existing _State_ to associate to the new _ExhibitState_.
