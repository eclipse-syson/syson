...
- [releng] Switch to Sirius Web 2024.7.11
...
- https://github.com/eclipse-syson/syson/issues/717[#717] [import] Correcting namespace visibility when handling 'package' elements.
