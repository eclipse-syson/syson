...
- https://github.com/eclipse-syson/syson/issues/1407[#1407] [metamodel] `Feature` with `ChainingFeature` should be typped with the type of the last `ChainingFeature`.
