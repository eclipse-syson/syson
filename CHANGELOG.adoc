...
- https://github.com/eclipse-syson/syson/issues/585[#585] [diagrams] Add a new tool allowing to create an _ExhibitState_ at the root of General View and StateTransition View.
This tool shows a dialog allowing to select an existing _State_ to associate to the new _ExhibitState_.
