...
A new node creation tool is available in the `Requirements` section of the palette, allowing the creation of `Satisfy Requirement Usage` objects.
A new drop node tool is available on the diagram, allowing representing `Satisfy Requirement Usage` objects as nodes of the diagram.
