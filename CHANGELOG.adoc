...
- https://github.com/eclipse-syson/syson/issues/1257[#1257] [general-view] Add `perform actions` compartment in Parts
- https://github.com/eclipse-syson/syson/issues/1277[#1277] [general-view] Add `perform actions` compartment in Actions
