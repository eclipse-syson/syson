...
- https://github.com/eclipse-syson/syson/issues/2528[#2528] https://github.com/eclipse-syson/syson/issues/2429[#2429] https://github.com/eclipse-syson/syson/issues/2213[#2213] [export] Export successions with an implicit target as `then <action>;` instead of a dangling `then;`, and export unnamed decision nodes as `decide;`.
