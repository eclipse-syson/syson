...
- https://github.com/eclipse-syson/syson/issues/1813[#1813] [diagrams] Add _creation tool_ for `Comment` graphical nodes in the _General View_ diagram background.
