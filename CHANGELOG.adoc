...
- [releng] Update to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.12.1]
...
- https://github.com/eclipse-syson/syson/issues/1762[#1762] [diagrams] Adjust the default size of nodes.
...
- https://github.com/eclipse-syson/syson/issues/1740[#1740] [diagrams] Add __items__ compartment and graphical border node on `PortDefinition` graphical nodes in the _General View_ diagram.
