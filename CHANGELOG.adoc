...
- Switch to Sirius Web 2024.1.5: `GeneralViewRegistryConfigurer` has been renamed to `GeneralViewDescriptionProvider` as it now implements `IEditingContextRepresentationDescriptionProvider` instead of `IRepresentationDescriptionRegistryConfigurer`. Same for `InterconnectionViewRegistryConfigurer`.
...
- https://github.com/eclipse-syson/syson/issues/93[#93] [diagrams] Add new Action Flow view diagram.
