...
The following module have been deleted:

* `syson-diagram-interconnection-view`
* `syson-diagram-actionflow-view`
* `syson-diagram-statetransition-view`

`syson-diagram-general-view` handles all the graphical nodes and edges of the previous modules.
...
- [releng] Update to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.8.1]
