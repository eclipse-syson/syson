...
- https://github.com/eclipse-syson/syson/issues/1870[#1870] [diagrams] When dragging some `Element` into a diagram, hide their node compartment unless it's an _interconnection_ compartment
