...
- [releng] Switch to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.4.5]
...
- https://github.com/eclipse-syson/syson/issues/1321[#1321] [general-view] Prevent `TransitionUsage` source/target reconnection to another `TransitionUsage`.
