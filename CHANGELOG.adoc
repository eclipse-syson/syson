...
- https://github.com/eclipse-syson/syson/issues/2507[#2507] [explorer] Fix the missing _New objects from text_ tree palette tool when filtered by the tree palette search.
