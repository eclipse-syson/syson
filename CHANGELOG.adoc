...
=== Breaking changes
- https://github.com/eclipse-syson/syson/issues/554[#554] [diagrams] Moved StateTransitionCompartmentNodeDescriptionProvider from syson-diagram-statetransition-view to module syson-diagram-common-view.
...
- https://github.com/eclipse-syson/syson/issues/507[#507] [general-view] Add missing tools to create Items and Parts in Port and PortDefinition
- https://github.com/eclipse-syson/syson/issues/508[#508] [general-view] Add missing tool to create Requirements in RequirementDefinition
