...
- https://github.com/eclipse-syson/syson/issues/1452[#1452] [explorer] Contextual menu action "New objects from text" no longer appears for non-SysML semantic objects.
