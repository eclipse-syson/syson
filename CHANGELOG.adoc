...
- [releng] Switch to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.2.4]
...
- https://github.com/eclipse-syson/syson/issues/1120[#1120] [general-view] A edge should represent the composition between `OccurrenceDefinition` and `OccurrenceUsage`
