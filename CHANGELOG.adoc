...
- https://github.com/eclipse-syson/syson/issues/1978[#1978] [diagram] Allow to edit the _timeslice_ and _snapshot_ properties of `OccurrenceUsage` and subtypes graphical nodes with the direct edit.
