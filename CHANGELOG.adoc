...
- https://github.com/eclipse-syson/syson/issues/2391[#2391] [diagrams] Add support of inheritance of actor in _actors_ compartment of `CaseDefinition` and `CaseUsage` graphical nodes.
