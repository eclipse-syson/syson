...
- https://github.com/eclipse-syson/syson/issues/960[#960] [general-view] In the selection dialog of the creation tool for 'StakeholderParameter', present possible PartUsage candidates in a tree instead of a list.
