...
- https://github.com/eclipse-syson/syson/issues/1033[#1033] [common-view] Make it possible to create a diagram representation directly under a root namespace element
