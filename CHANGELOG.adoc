...
- https://github.com/eclipse-syson/syson/issues/1752[#1752] [diagrams] In Standard view, hide the node displayed on the top of the diagram if the candidate compartment is not hidden.
