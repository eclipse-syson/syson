...
For more information about the GraphQL API, refer to the https://github.com/eclipse-sirius/sirius-web[Sirius Web repository], on which SysON is built. It contains all GraphQL APIs used by SysON.
