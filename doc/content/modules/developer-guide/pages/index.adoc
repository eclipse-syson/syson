...
All {product} backend modules use Checkstyle to verify formatting, coding rules... so you must install Checkstyle plugin in Eclipse. The version to use is the latest *10.x.y*.
