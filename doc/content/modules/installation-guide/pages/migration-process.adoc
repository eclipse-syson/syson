...
Adopting the 2026.5.0 version doesn't require a migration process.

But in any case, please download all your models/projects and back up your database before upgrading to 2026.5.0.
