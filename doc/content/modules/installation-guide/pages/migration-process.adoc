...
Adopting the 2026.11.0 version doesn't require a migration process.

But in any case, please download all your models/projects and back up your database before upgrading to 2026.11.0.
...
But in any case, please download all your models/projects and back up your database before upgrading to 2026.9.0.
...
Please download all your models/projects and back up your database before upgrading to 2026.5.0.
...
But in any case, please download all your models/projects and back up your database before upgrading to 2026.1.0.
...
Align the metamodel with the SysMLv2 Beta 2 specification, released on 3 February 2024 (see https://www.omg.org/spec/SysML/ for more details), and the KerML Beta 2 specification, released on 17 February 2024 (see https://www.omg.org/spec/KerML/ for more details).
