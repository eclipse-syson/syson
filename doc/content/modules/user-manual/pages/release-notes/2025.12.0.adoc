...
- *Updated developer guide*: the developer guide has been updated to explain how to setup the development environment and contribute changes to the codebase.
