...
- *Requirements table view*: Add a new table view named _Requirements Table_ to display and edit requirements in a tabular way. This table is available on any element. xref:user-manual:features/requirement-managaement.adoc[See the documentation for more details].
...
xref:user-manual:features/requirement-managaement.adoc[See the documentation for more details].
== Bug fixes
