...
If you are using the docker image and want to upgrade to PostgreSQL 15, please refer to xref:installation-guide:how-tos/install/migration-process.adoc[the migration process page of the official documentation].
