...
* Downtream applications can now easily choose which SysML validation rules to apply, by providing an implementation of `ISysMLValidationRulesProvider`.
...
** Fix textual import of `LiteralString` containing escaped backslash. In the following model, the value of "a1" is now "A \ B".
