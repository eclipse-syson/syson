...
+
image::release-note-views-explorer.png[_Views Explorer_ view with diagrams and table, width=40%,height=40%]
...
+
image::validation-view-labels-with-document.png[_Validation_ view with labels indicating containing document, width=50%,height=50%]
