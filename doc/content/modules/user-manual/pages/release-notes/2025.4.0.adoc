...
```
- In _General View_ diagram, `Comments` can now be created from a `Dependency` graphical edge, using the graphical edge contextual menu (a.k.a. the palette).
...
- Switch to https://github.com/eclipse-sirius/sirius-web[Sirius Web 2025.2.11]
