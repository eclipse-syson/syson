...
image::release-notes-library-update-action.png[Contextual menu action 'Update library' for documents from imported-by-reference published libraries, width=50%,height=50%]
...
image::GV_TextualRepresentation.png[TextualRepresentation on General View Diagram, width=85%,height=85%]
...
image::release-notes-navigation-bar-menu.png[navigation bar menu, width=85%,height=85%]
