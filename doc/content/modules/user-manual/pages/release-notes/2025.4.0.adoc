...
- Fix a problem encountered during the import of a SysML textual file in a specific model configuration. The model incorrectly resolves the target of a `Redefintion` when a name conflict is encountered.
