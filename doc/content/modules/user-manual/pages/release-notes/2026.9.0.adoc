...
** Add support of inheritance of subject in _subject_ compartment of `CaseDefinition` and `CaseUsage` graphical nodes.
The _subject_ compartment is also visible in the following graphical nodes:
