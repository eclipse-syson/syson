...
** Add support of inheritance of actor in _actors_ compartment of `CaseDefinition` and `CaseUsage` graphical nodes.
The _actors_ compartment is also visible in the following graphical nodes:
