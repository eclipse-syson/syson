...
- *New "Insert textual SysMLv2" menu entry*: from elements in _Explorer_ view, allow to insert textual SysMLv2 under the selected element.
The menu entry shows a dialog with a textarea allowing to write or paste textual SysMLv2.

image::release-notes-insert-textual-sysmlv2-menu.png[Insert textual SysMLv2 menu]

A click on the _Insert_ button converts the textual SysMLv2 into model elements and add them under the selected element.

image::release-notes-insert-textual-sysmlv2-dialog.png[Insert textual SysMLv2 dialog]
...
- Handle prefix keywords in label for attribute compartment element and support direct edit
* Prefixing or not the name of an Usage attribute with direction or "abstract" or "variation" or "readonly" or "derived" or "end" sets its matching property with the correct value
- Handle multiplicity suffix property keyword in label for attribute compartment element and support direct edit
* Suffixing or not the name of an Usage attribute with "ordered" or "nonunique" sets its matching property with the correct value
...
- Add new "Insert textual SysMLv2" menu entry on elements in _Explorer_ view, allowing to insert textual SysMLv2 under the selected element.
The menu entry shows a dialog with a textarea allowing to write or paste textual SysMLv2.
