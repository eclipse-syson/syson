...
- The direct edit tool on `Feature` elements now allows to use the ":=" and "default" symbols (see for more details in xref:ROOT:how-tos/model-management.adoc#direct-edit[user documentation] ).
