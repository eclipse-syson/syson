...
The following element in _Definition_ compartments can be displayed in the {gv} diagram:
  ...
  * _Action Definition_ can contain in its body Action, Accept action, Start action, Done action, Fork action, Join action, Merge action, Decision action and Perform action,
