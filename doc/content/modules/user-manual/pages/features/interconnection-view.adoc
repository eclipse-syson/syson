...
From the root _Usage_, two elements can be displayed in the {iv} diagram:
...
From compartment of _Usage_ part, three elements can be displayed in the {iv} diagram:
