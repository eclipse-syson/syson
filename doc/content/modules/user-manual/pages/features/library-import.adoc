...
This dialog lists references that will be removed from your models because their target doesn't exist anymore (e.g. a `PartDefinition` that was typing a `PartUsage` in your model but doesn't exist in the new version of the library).
