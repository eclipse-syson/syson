...
* xref:hands-on/how-tos/explorer.adoc#select[Select element in Explorer]: Selects in the Explorer view what is already selected in the editor.
...
** xref:hands-on/how-tos/explorer.adoc#expand-all[Expand the entire model].
...
** xref:hands-on/how-tos/explorer.adoc#expand-all[Expand all child elements].
