...
[NOTE]
====
This action is only available on SysML `Element`s which are not `Relationship`s.
====
...
[NOTE]
====
It is strongly recommended to keep this option enabled to ensure a coherent model.
====
