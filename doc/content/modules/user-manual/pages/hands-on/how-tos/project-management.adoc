...
To create a new blank project, click the _Blank project_ card at the top of the homepage.
...
You are redirected to the newly created project, which is initially empty.
