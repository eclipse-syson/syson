...
public class DirectEditParser extends Parser {
	...
	public static final int
		...
		RULE_primaryAtom = 29, RULE_sequenceExpressionList = 30, RULE_operand = 31, 
		RULE_featureChainExpression = 32, RULE_transitionExpression = 33, RULE_triggerExpression = 34, 
		RULE_triggerExpressionName = 35, RULE_guardExpression = 36, RULE_effectExpression = 37, 
		RULE_qualifiedName = 38, RULE_shortName = 39, RULE_refName = 40, RULE_name = 41;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"sequenceExpressionList", "operand", "featureChainExpression", "transitionExpression", 
			"triggerExpression", "triggerExpressionName", "guardExpression", "effectExpression", 
			"qualifiedName", "shortName", "refName", "name"
		};
	}
