 ...
 */
public class MetamodelMutationElementServiceTests {
    ...
    public void checkElementWithNameDuplication() {
        org.eclipse.syson.sysml.Package package1 = this.modelBuilder.createWithName(Package.class, "package1");
        String package1Id = package1.getElementId();
        Optional<Element> result = this.metamodelMutationElementService.duplicateElement(package1, false, false);
    ...
    public void checkElementWithContentDuplication() {
        ...
        Optional<Element> result = this.metamodelMutationElementService.duplicateElement(package1, true, true);
