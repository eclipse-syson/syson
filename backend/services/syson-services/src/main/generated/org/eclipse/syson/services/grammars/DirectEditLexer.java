...
public class DirectEditLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "WS", "Boolean", "Integer", "Real", "SingleQuotedString", 
			"SingleQuoteEscape", "DoubleQuotedString", "Name", "BasicName", "BasicInitialCharacter", 
			"BasicNameCharacter", "UnrestrictedName", "Letter", "DeciamlDigit", "ABOUT", 
