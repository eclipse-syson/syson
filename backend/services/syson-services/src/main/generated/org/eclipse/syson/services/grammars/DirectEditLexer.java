...
public class DirectEditLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WS", "Boolean", "Integer", "Real", "SingleQuotedString", "SingleQuoteEscape", 
			"DoubleQuotedString", "BasicName", "BasicInitialCharacter", "BasicNameCharacter", 
			"Letter", "DeciamlDigit", "ABOUT", "ABSTRACT", "ALIAS", "ALL", "AND", 
