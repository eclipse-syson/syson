...
public class UtilService {
     ...
     * @return an actual instance of the part definition associated to the given part usage.
     */
    public Definition createRightPartDefinitionFrom(PartUsage partUsage) {
        return (Definition) SysmlFactory.eINSTANCE.create(this.getRightPartDefinitionEClassFrom(partUsage));
    }
     ...
     */
    public EClass getRightPartDefinitionEClassFrom(PartUsage partUsage) {
