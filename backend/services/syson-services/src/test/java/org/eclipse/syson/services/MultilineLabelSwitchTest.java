...
public class MultilineLabelSwitchTest extends AbstractServiceTest {
    ...
    protected static final SysmlPackage SYSML = SysmlPackage.eINSTANCE;
    ...
    private static final String DEFAULT_ASSIGNMENT_ACTION_USAGE_LABEL = LabelConstants.OPEN_QUOTE + REF_ATTRIBUTE_LABEL + "assign" + LabelConstants.CLOSE_QUOTE
            + LabelConstants.CR;
    ...
    private static final String DEFAULT_EXHIBIT_STATE_USAGE_LABEL = LabelConstants.OPEN_QUOTE + REF_ATTRIBUTE_LABEL + "exhibit state" + LabelConstants.CLOSE_QUOTE
            + LabelConstants.CR;
    ...
    private static final String DEFAULT_PERFORM_ACTION_USAGE_LABEL = LabelConstants.OPEN_QUOTE + REF_ATTRIBUTE_LABEL + "perform action" + LabelConstants.CLOSE_QUOTE
            + LabelConstants.CR + "null";
    ...
    private static final String DEFAULT_REQUIREMENT_USAGE_LABEL = LabelConstants.OPEN_QUOTE + REF_ATTRIBUTE_LABEL + "requirement" + LabelConstants.CLOSE_QUOTE
            + LabelConstants.CR;
    ...
    public void testPrefixLabelWithDefaultProperty(EClass elementType, String defaultLabel) {
    ...
    public void testPrefixLabelWithVariationProperty(EClass elementType, String defaultLabel) {
        ...
        String abstractPrefix = LabelConstants.OPEN_QUOTE + LabelConstants.VARIATION + LabelConstants.CLOSE_QUOTE + LabelConstants.CR;
        assertEquals(abstractPrefix + defaultLabel,
                this.multiLineLabelSwitch.doSwitch(newElement));
    }
    ...
    public void testPrefixLabelWithVariantProperty(EClass elementType, String defaultLabel) {
        ...
        String abstractPrefix = LabelConstants.OPEN_QUOTE + LabelConstants.VARIANT + LabelConstants.CLOSE_QUOTE + LabelConstants.CR;
        assertEquals(abstractPrefix + defaultLabel,
                this.multiLineLabelSwitch.doSwitch(newElement));
    }
