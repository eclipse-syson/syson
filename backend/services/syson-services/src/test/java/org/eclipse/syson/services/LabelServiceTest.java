...
public class LabelServiceTest extends AbstractServiceTest {
    ...
    @BeforeEach
    void beforeEach() {
        this.labelService = new LabelService(new TestFeedbackMessageService());
    }

    @DisplayName("Chek Usage prefix label with default properties")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with abstract property")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with derived property")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with end property")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with readonly property")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with many custom properties")
    @Test
    ...
    @DisplayName("Chek Usage prefix label with direction properties")
    @Test
    ...
    @DisplayName("Chek AttributeUsage prefix label with default properties")
    @Test
