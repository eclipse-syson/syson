...
public class DescriptionNameGeneratorTest {
    ...
    public void testIsCompartmentName() {
        ...
        this.assertIsCompartmentName(true, nameGenerator.getCompartmentItemName(SysmlPackage.eINSTANCE.getPartUsage(), SysmlPackage.eINSTANCE.getUsage_NestedPort()),
                nameGenerator);
        ...
        this.assertIsCompartmentName(true, nameGenerator.getInheritedCompartmentItemName(SysmlPackage.eINSTANCE.getPartUsage(), SysmlPackage.eINSTANCE.getUsage_NestedPort()), nameGenerator);
