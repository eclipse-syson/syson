...
/**
 * Node description provider for all SysMLv2 Composite State Usage elements in the StateTransition View diagram.
 *
 * @author adieumegard
 */
public class CompositeStateDefinitionNodeDescriptionProvider extends AbstractDefinitionNodeDescriptionProvider {
    ...
    public NodeDescription create() {
        ...
        return this.diagramBuilderHelper.newNodeDescription()
                ...
                .style(this.createCompositeStateUsageNodeStyle())
                .userResizable(true)
                .synchronizationPolicy(SynchronizationPolicy.UNSYNCHRONIZED)
                .build();
    }

    private NodeStyleDescription createCompositeStateUsageNodeStyle() {
    ...
    protected List<NodeDescription> getReusedChildren(IViewDiagramElementFinder cache) {
        ...
        cache.getNodeDescription(this.nameGenerator.getNodeName(SysmlPackage.eINSTANCE.getTransitionUsage())).ifPresent(reusedChildren::add);
