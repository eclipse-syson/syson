...
/**
 * Checks the structure of the State Transition View diagram.
 *
 * @author gdaniel
 */
public class StateTransitionViewDiagramDescriptionTests {

    private List<Class<?>> diagramServices;

    private DiagramDescription diagramDescription;

    private final DescriptionNameGenerator descriptionNameGenerator = new STVDescriptionNameGenerator();

    private final DiagramPredicates diagramPredicates = new DiagramPredicates("STV", this.descriptionNameGenerator);
    ...
    public void setUp() {
        ...
        IRepresentationDescriptionProvider representationDescriptionProvider = new StateTransitionViewDiagramDescriptionProvider();
        ...
        IJavaServiceProvider serviceProvider = new StateTransitionViewJavaServiceProvider();
    ...
    public void eachNodeHasDiagramPrefix() {
        ...
        new NodeDescriptionHasNameChecker().withExpectedPrefix("STV").checkAll(nodeDescriptionCandidates);
    }
