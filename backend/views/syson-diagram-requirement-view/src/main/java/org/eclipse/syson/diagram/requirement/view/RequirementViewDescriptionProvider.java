...
/**
 * Allows to register the Requirement View diagram in the application.
 *
 * @author Jerome Gout
 */
@Configuration
public class RequirementViewDescriptionProvider extends AbstractViewDescriptionProvider {

    public RequirementViewDescriptionProvider(IViewConverter viewConverter, Registry ePackagesRegistry, IInMemoryViewRegistry inMemoryViewRegistry) {
        super(viewConverter, ePackagesRegistry, inMemoryViewRegistry);
    }

    @Override
    protected String getViewDiagramId() {
        return "RequirementViewDiagram";
    }

    @Override
    protected IRepresentationDescriptionProvider getRepresentationDescriptionProvider() {
        return new RequirementViewDiagramDescriptionProvider();
    }
}
