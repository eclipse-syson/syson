...
import org.eclipse.syson.diagram.requirement.view.services.RequirementViewNodeToolSectionSwitch;
import org.eclipse.syson.sysml.SysmlPackage;

/**
 * Node description provider for all SysMLv2 Definitions elements in the Requirement View diagram.
 *
 * @author arichard
 */
public class DefinitionNodeDescriptionProvider extends AbstractDefinitionNodeDescriptionProvider {
    ...
    public DefinitionNodeDescriptionProvider(EClass eClass, IColorProvider colorProvider) {
        super(eClass, colorProvider, new RVDescriptionNameGenerator());
    }
    ...
    protected List<NodeToolSection> getToolSections(NodeDescription nodeDescription, IViewDiagramElementFinder cache) {
        RequirementViewNodeToolSectionSwitch toolSectionSwitch = new RequirementViewNodeToolSectionSwitch();
