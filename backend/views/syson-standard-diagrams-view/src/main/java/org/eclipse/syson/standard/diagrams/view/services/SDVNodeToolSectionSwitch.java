 ...
 * @author arichard
 */
public class SDVNodeToolSectionSwitch extends AbstractViewNodeToolSectionSwitch {
    ...
    public SDVNodeToolSectionSwitch(IViewDiagramElementFinder cache, List<NodeDescription> allNodeDescriptions) {
        super(new SDVDescriptionNameGenerator());
    ...
    public List<NodeToolSection> caseActionDefinition(ActionDefinition object) {
        ...
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, this.createNewActionParameterNodeTool(FeatureDirectionKind.IN));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, this.createNewActionParameterNodeTool(FeatureDirectionKind.INOUT));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, this.createNewActionParameterNodeTool(FeatureDirectionKind.OUT));
    ...
    public List<NodeToolSection> caseActionUsage(ActionUsage object) {
        var sections = this.toolDescriptionService.createDefaultNodeToolSections();
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE,
                new CompartmentNodeToolProvider(SysmlPackage.eINSTANCE.getUsage_NestedAttribute(), this.descriptionNameGenerator).create(this.cache));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE,
    ...
    @Override
    public List<NodeToolSection> caseAttributeUsage(AttributeUsage object) {
        var sections = this.toolDescriptionService.createDefaultNodeToolSections();
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, new ReferenceUsageCompartmentNodeToolProvider().create(this.cache));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, new SetAsCompositeToolProvider().create(this.cache));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE, new SetAsRefToolProvider().create(this.cache));

        this.createToolsForCompartmentItemsWithExclusions(object, List.of(SysmlPackage.eINSTANCE.getUsage_NestedReference()), sections, this.cache);
        sections.add(this.toolDescriptionService.relatedElementsNodeToolSection(true));
        this.toolDescriptionService.removeEmptyNodeToolSections(sections);
        return sections;
    }
    ...
    @Override
    public List<NodeToolSection> caseMetadataDefinition(MetadataDefinition object) {
        var sections = this.toolDescriptionService.createDefaultNodeToolSections();
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.BEHAVIOR, new OccurrenceUsageTimesliceNodeToolProvider().create(cache));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.BEHAVIOR, new OccurrenceUsageSnapshotNodeToolProvider().create(cache));
        this.toolDescriptionService.addNodeTool(sections, ToolConstants.STRUCTURE,
        ...
        this.createToolsForCompartmentItemsWithExclusions(object, List.of(SysmlPackage.eINSTANCE.getDefinition_OwnedReference()), sections, this.cache);
        sections.add(this.toolDescriptionService.relatedElementsNodeToolSection(true));
        this.toolDescriptionService.removeEmptyNodeToolSections(sections);
        return sections;
    }
    ...
    protected List<EReference> getElementCompartmentReferences(Element element) {
        ...
        List<EReference> refs = SDVDiagramDescriptionProvider.COMPARTMENTS_WITH_LIST_ITEMS.get(element.eClass());
        if (refs != null) {
    ...
    protected void createToolsForCompartmentItem(EReference eReference, List<NodeToolSection> sections, IViewDiagramElementFinder finder) {
        ...
        if (SDVDiagramDescriptionProvider.DIRECTIONAL_ELEMENTS.contains(eReference.getEType())) {
    ...
    private NodeTool createNewActionParameterNodeTool(FeatureDirectionKind direction) {
        var parameterCompartmentNodeToolProvider = new ParameterCompartmentNodeToolProvider(direction);
        return parameterCompartmentNodeToolProvider.create(this.cache);
    }
