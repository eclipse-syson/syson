...
import org.eclipse.syson.diagram.common.view.nodes.ReferenceUsageCompartmentNodeDescriptorProvider;
...
import org.eclipse.syson.standard.diagrams.view.nodes.InheritedReferenceUsageBorderNodeDescriptionProvider;
...
import org.eclipse.syson.standard.diagrams.view.nodes.UsageNodeDescriptionProvider;
...
public class SDVDiagramDescriptionProvider implements IRepresentationDescriptionProvider {
    ...
    public static  final Map<EClass, List<EReference>> COMPARTMENTS_WITH_LIST_ITEMS = Map.ofEntries(
            ...
            Map.entry(SysmlPackage.eINSTANCE.getPartDefinition(),          List.of(SysmlPackage.eINSTANCE.getElement_Documentation(), SysmlPackage.eINSTANCE.getDefinition_OwnedAttribute(), SysmlPackage.eINSTANCE.getDefinition_OwnedPort(), SysmlPackage.eINSTANCE.getDefinition_OwnedAction(), SysmlPackage.eINSTANCE.getDefinition_OwnedState(), SysmlPackage.eINSTANCE.getDefinition_OwnedPart(), SysmlPackage.eINSTANCE.getDefinition_OwnedRequirement(), SysmlPackage.eINSTANCE.getDefinition_OwnedConcern())),
            Map.entry(SysmlPackage.eINSTANCE.getPartUsage(),               List.of(SysmlPackage.eINSTANCE.getElement_Documentation(), SysmlPackage.eINSTANCE.getUsage_NestedAttribute(), SysmlPackage.eINSTANCE.getUsage_NestedAction(), SysmlPackage.eINSTANCE.getUsage_NestedPart(), SysmlPackage.eINSTANCE.getUsage_NestedPort(), SysmlPackage.eINSTANCE.getUsage_NestedState(), SysmlPackage.eINSTANCE.getUsage_NestedRequirement(), SysmlPackage.eINSTANCE.getUsage_NestedConcern())),
    ...
    private List<IDiagramElementDescriptionProvider<?>> createDiagramElementDescriptionProviders(IColorProvider colorProvider) {
        ...
        // add ReferenceUsage node provider because it has been removed from TOOL_SECTIONS
        diagramElementDescriptionProviders.add(new UsageNodeDescriptionProvider(SysmlPackage.eINSTANCE.getReferenceUsage(), colorProvider));
        ...
        COMPARTMENTS_WITH_LIST_ITEMS.forEach((eClass, eReferences) -> {
            eReferences.forEach(eReference -> {
                if (SysmlPackage.eINSTANCE.getExhibitStateUsage().equals(eClass) && SysmlPackage.eINSTANCE.getUsage_NestedState().equals(eReference)) {
                    ...
                    compartmentNodeDescriptionProviders.add(new PerformActionsCompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                    compartmentNodeDescriptionProviders.add(new PerformActionsCompartmentNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                } else if (SysmlPackage.eINSTANCE.getPortDefinition().equals(eClass) || SysmlPackage.eINSTANCE.getPortUsage().equals(eClass)) {
                    compartmentNodeDescriptionProviders.addAll(this.createPortCompartmentProviders(eClass, eReference, colorProvider));
                } else if ((SysmlPackage.eINSTANCE.getAttributeUsage().equals(eClass) || SysmlPackage.eINSTANCE.getItemUsage().equals(eClass)) && SysmlPackage.eINSTANCE.getUsage_NestedReference().equals(eReference)) {
                    compartmentNodeDescriptionProviders.add(new ReferenceUsageCompartmentNodeDescriptorProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                    compartmentNodeDescriptionProviders.add(new CompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                    compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                } else if (SysmlPackage.eINSTANCE.getMetadataDefinition().equals(eClass) && SysmlPackage.eINSTANCE.getDefinition_OwnedReference().equals(eReference)) {
                    compartmentNodeDescriptionProviders.add(new ReferenceUsageCompartmentNodeDescriptorProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                    compartmentNodeDescriptionProviders.add(new CompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                    compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
                } else {
    ...
    private List<IDiagramElementDescriptionProvider<?>> createPortCompartmentProviders(EClass eClass, EReference eReference, IColorProvider colorProvider) {
        final List<IDiagramElementDescriptionProvider<?>> compartmentNodeDescriptionProviders = new ArrayList<>();
        if (SysmlPackage.eINSTANCE.getDefinition_OwnedItem().equals(eReference)) {
            compartmentNodeDescriptionProviders.add(new CompartmentNodeDescriptionProvider(eClass, eReference, colorProvider));
        ...
        } else if (SysmlPackage.eINSTANCE.getUsage_NestedItem().equals(eReference)) {
            compartmentNodeDescriptionProviders.add(new CompartmentNodeDescriptionProvider(eClass, eReference, colorProvider));
        ...
        } else if (SysmlPackage.eINSTANCE.getUsage_NestedReference().equals(eReference) || SysmlPackage.eINSTANCE.getDefinition_OwnedReference().equals(eReference)) {
            compartmentNodeDescriptionProviders.add(new ReferenceUsageCompartmentNodeDescriptorProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
            compartmentNodeDescriptionProviders.add(new CompartmentItemNodeDescriptionProvider(eClass, eReference, colorProvider, this.getDescriptionNameGenerator()));
        } else {
            compartmentNodeDescriptionProviders.add(new CompartmentNodeDescriptionProvider(eClass, eReference, colorProvider));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createCompartmentsForActionParameters(IColorProvider colorProvider) {
        ...
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getActionDefinition(), SysmlPackage.eINSTANCE.getBehavior_Parameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders
        ...
        compartmentNodeDescriptionProviders
                .add(new CompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getActionUsage(), SysmlPackage.eINSTANCE.getUsage_NestedReference(), colorProvider,
                        this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getActionUsage(), SysmlPackage.eINSTANCE.getStep_Parameter(), colorProvider, this.getDescriptionNameGenerator()));
        return compartmentNodeDescriptionProviders;
    }
    ...
    private List<IDiagramElementDescriptionProvider<?>> createRequireConstraintCompartments(IColorProvider colorProvider) {
        ...
        compartmentNodeDescriptionProviders.add(new RequireConstraintCompartmentItemNodeDescription(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_RequiredConstraint(),
                colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_RequiredConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_RequiredConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_RequiredConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_RequiredConstraint(), colorProvider, this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAssumeConstraintCompartments(IColorProvider colorProvider) {
        ...
        compartmentNodeDescriptionProviders.add(new AssumeConstraintCompartmentItemNodeDescription(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_AssumedConstraint(),
                colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_AssumedConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_AssumedConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_AssumedConstraint(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_AssumedConstraint(), colorProvider, this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createCompartmentsForSubjectParameter(IColorProvider colorProvider) {
        ...
        compartmentNodeDescriptionProviders.add(new CompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(),
                colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getCaseDefinition(), SysmlPackage.eINSTANCE.getCaseDefinition_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getCaseUsage(), SysmlPackage.eINSTANCE.getCaseUsage_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
        compartmentNodeDescriptionProviders.add(new InheritedCompartmentItemNodeDescriptionProvider(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(), colorProvider, this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAllEdgeDescriptionProviders(IColorProvider colorProvider) {
        ...
        edgeDescriptionProviders.add(new RequirementDerivationEdgeDescriptionProvider(colorProvider, this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAllDefinitionOwnedUsageEdgeDescriptionProviders(IColorProvider colorProvider) {
        ...
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getActionUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedAction(),
                        colorProvider, this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getAssignmentActionUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedAction(),
                        colorProvider, this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
        ...
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getAttributeUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedAttribute(),
                        colorProvider, this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getCaseUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedCase(), colorProvider,
                        this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
        ...
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getExhibitStateUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedState(), colorProvider,
                        this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getUseCaseUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedUseCase(), colorProvider,
                        this.getDescriptionNameGenerator()));
        definitionOwnedUsageEdgeDescriptionProviders
                .add(new DefinitionOwnedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getViewUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedView(), colorProvider,
                        this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAllUsageRequirementCompositeEdgeDescriptionProviders(IColorProvider colorProvider) {
        ...
        usageCompositeEdgeDescriptionProviders.add(new NestedActorEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_ActorParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedActorEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_ActorParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedActorEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_ActorParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedActorEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_ActorParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedActorEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_ActorParameter(), colorProvider,
                this.getDescriptionNameGenerator()));

        usageCompositeEdgeDescriptionProviders.add(new NestedStakeholderEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_StakeholderParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedStakeholderEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getConcernUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_StakeholderParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedStakeholderEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_StakeholderParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedStakeholderEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_StakeholderParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedStakeholderEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_StakeholderParameter(), colorProvider,
                this.getDescriptionNameGenerator()));

        usageCompositeEdgeDescriptionProviders.add(new NestedSubjectEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementDefinition(), SysmlPackage.eINSTANCE.getRequirementDefinition_SubjectParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedSubjectEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new NestedSubjectEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(), SysmlPackage.eINSTANCE.getRequirementUsage_SubjectParameter(), colorProvider,
                this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAllUsageStructureCompositeEdgeDescriptionProviders(IColorProvider colorProvider) {
        ...
        usageCompositeEdgeDescriptionProviders.add(new UsageNestedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getAttributeUsage(), SysmlPackage.eINSTANCE.getUsage_NestedAttribute(),
                colorProvider, this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new UsageNestedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getInterfaceUsage(), SysmlPackage.eINSTANCE.getUsage_NestedInterface(),
                colorProvider, this.getDescriptionNameGenerator()));
    ...
    private List<IDiagramElementDescriptionProvider<?>> createAllUsageAnalysisCompositeEdgeDescriptionProviders(IColorProvider colorProvider) {
        ...
        usageCompositeEdgeDescriptionProviders.add(new UsageNestedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getCaseUsage(), SysmlPackage.eINSTANCE.getUsage_NestedCase(),
                colorProvider, this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new UsageNestedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getUseCaseUsage(), SysmlPackage.eINSTANCE.getUsage_NestedUseCase(),
                colorProvider, this.getDescriptionNameGenerator()));
        usageCompositeEdgeDescriptionProviders.add(new UsageNestedUsageEdgeDescriptionProvider(SysmlPackage.eINSTANCE.getViewUsage(), SysmlPackage.eINSTANCE.getUsage_NestedView(),
                colorProvider, this.getDescriptionNameGenerator()));
    ...
    private DropNodeTool createDropFromDiagramTool(IViewDiagramElementFinder cache) {
        ...
        // this is necessary since ReferenceUsage has been removed from TOOL_SECTIONS
        cache.getNodeDescription(this.getDescriptionNameGenerator().getNodeName(SysmlPackage.eINSTANCE.getReferenceUsage()))
                .ifPresent(acceptedNodeTypes::add);
    ...
    private List<NodeTool> addCustomTools(IViewDiagramElementFinder cache, String sectionName) {
        ...
        if (BEHAVIOR_TOOL_SECTION.name().equals(sectionName)) {
            ...
            cache.getNodeDescription(this.getDescriptionNameGenerator().getNodeName(SysmlPackage.eINSTANCE.getReferenceUsage()))
                    .ifPresent(nd -> nodeTools.add(new ReferenceUsageNodeToolProvider(nd, this.getDescriptionNameGenerator()).create(cache)));
