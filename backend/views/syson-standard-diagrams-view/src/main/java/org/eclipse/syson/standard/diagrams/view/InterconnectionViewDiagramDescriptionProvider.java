...
/**
 * Allows to register the Interconnection View diagram in the application. It is only useful to have the Interconnection
 * View entry in the "New Representation" menu item in the Explorer view. The actual diagram created is the SDV one.
 *
 * @author arichard
 */
@Service
public class InterconnectionViewDiagramDescriptionProvider implements IViewDescriptionProvider {
