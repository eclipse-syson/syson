...
public class StakeholderNodeDescriptionProvider extends UsageNodeDescriptionProvider {
    ...
    protected String getSemanticCandidatesExpression(String domainType) {
        return ServiceMethod.of4(ViewNodeService::getExposedStakeholders).aqlSelf(domainType, org.eclipse.sirius.components.diagrams.description.NodeDescription.ANCESTORS,
