...
public class SubjectNodeDescriptionProvider extends UsageNodeDescriptionProvider {
    ...
    protected String getSemanticCandidatesExpression(String domainType) {
        return ServiceMethod.of4(DiagramQueryAQLService::getExposedSubjects).aqlSelf(domainType, org.eclipse.sirius.components.diagrams.description.NodeDescription.ANCESTORS, CoreVariables.EDITING_CONTEXT.name(),
