...
/**
 * Switch retrieving the list of NodeTools (without Section) for each SysMLv2 concept represented in the Standard
 * Diagram Views.
 *
 * @author arichard
 */
public class SDVNodeToolsWithoutSectionSwitch extends AbstractViewNodeToolsWithoutSectionSwitch {
    ...
    public SDVNodeToolsWithoutSectionSwitch(IViewDiagramElementFinder cache, List<NodeDescription> allNodeDescriptions) {
