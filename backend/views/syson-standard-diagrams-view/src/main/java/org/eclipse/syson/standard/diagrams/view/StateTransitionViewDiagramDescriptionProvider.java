...
/**
 * Allows to register the State Transition View diagram in the application. It is only useful to have the State
 * Transition View entry in the "New Representation" menu item in the Explorer view. The actual diagram created is the
 * SDV one.
 *
 * @author arichard
 */
@Service
public class StateTransitionViewDiagramDescriptionProvider implements IViewDescriptionProvider {
