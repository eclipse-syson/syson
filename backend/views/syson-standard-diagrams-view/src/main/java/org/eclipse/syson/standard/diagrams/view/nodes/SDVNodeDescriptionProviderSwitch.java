...
public class SDVNodeDescriptionProviderSwitch extends SysmlEClassSwitch<INodeDescriptionProvider> {
    ...
    @Override
    public INodeDescriptionProvider caseConnectionDefinition(ConnectionDefinition object) {
        return new DefinitionNodeDescriptionProvider(SysmlPackage.eINSTANCE.getConnectionDefinition(), this.colorProvider);
    }
    ...
    @Override
    public INodeDescriptionProvider caseSatisfyRequirementUsage(SatisfyRequirementUsage object) {
        return new UsageNodeDescriptionProvider(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(), this.colorProvider);
    }
    ...
    public INodeDescriptionProvider caseViewUsage(ViewUsage object) {
        return new ViewUsageNodeDescriptionProvider(this.colorProvider, new SDVDescriptionNameGenerator());
    }
