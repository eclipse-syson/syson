...
/**
 * Checks the structure of the Standard Diagram View.
 *
 * @author gdaniel
 */
public class SDVDiagramDescriptionTests {

    private List<Class<?>> diagramServices;

    private DiagramDescription diagramDescription;

    private final DiagramPredicates diagramPredicates = new DiagramPredicates(SDVDescriptionNameGenerator.PREFIX, new SDVDescriptionNameGenerator());
    ...
    public void setUp() {
        ...
        IRepresentationDescriptionProvider representationDescriptionProvider = new SDVDiagramDescriptionProvider();
        ...
        IJavaServiceProvider serviceProvider = new SDVJavaServiceProvider();
    ...
    public void eachNodeHasDiagramPrefix() {
        ...
        new NodeDescriptionHasNameChecker().withExpectedPrefix(SDVDescriptionNameGenerator.PREFIX).checkAll(nodeDescriptionCandidates);
    }
