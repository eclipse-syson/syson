...
/**
 * Switch retrieving the list of NodeTools (without Section) for each SysMLv2 concept represented in the Interconnection
 * View diagram.
 *
 * @author arichard
 */
public class InterconnectionViewNodeToolsWithoutSectionSwitch extends AbstractViewNodeToolsWithoutSectionSwitch {
    ...
    public InterconnectionViewNodeToolsWithoutSectionSwitch(IViewDiagramElementFinder cache, List<NodeDescription> allNodeDescriptions) {
