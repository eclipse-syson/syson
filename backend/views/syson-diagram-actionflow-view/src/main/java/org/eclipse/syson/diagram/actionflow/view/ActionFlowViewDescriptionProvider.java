 ...
 */
@Configuration
public class ActionFlowViewDescriptionProvider extends AbstractViewDescriptionProvider {

    public ActionFlowViewDescriptionProvider(IViewConverter viewConverter, Registry ePackagesRegistry, IInMemoryViewRegistry inMemoryViewRegistry) {
