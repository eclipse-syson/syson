...
/**
 * Used to add the merge action inside diagrams.
 *
 * @author Jerome Gout
 */
public class MergeActionNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var params = List.of(
                AQLUtils.aqlString(this.descriptionNameGenerator.getNodeName(MergeActionNodeDescriptionProvider.MERGE_ACTION_NAME)),
        ...
        var creationServiceCall = this.viewBuilderHelper.newChangeContext()
                .expression(AQLUtils.getSelfServiceCallExpression("createMergeAction"));
        ...
        return builder.name("New Merge")
                .iconURLsExpression("/icons/full/obj16/MergeNode.svg")
