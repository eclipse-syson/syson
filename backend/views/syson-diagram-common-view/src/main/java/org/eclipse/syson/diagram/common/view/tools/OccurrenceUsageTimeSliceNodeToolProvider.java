...
/**
 * Used to create a time slice from any subclass of {@link org.eclipse.syson.sysml.OccurrenceUsage}.
 *
 * @author gcoutable
 */
public class OccurrenceUsageTimeSliceNodeToolProvider implements INodeToolProvider {
    ...
    public OccurrenceUsageTimeSliceNodeToolProvider(IDescriptionNameGenerator descriptionNameGenerator) {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var setTimeSlice = this.viewBuilderHelper.newSetValue()
                .featureName(SysmlPackage.eINSTANCE.getOccurrenceUsage_PortionKind().getName())
                .valueExpression(PortionKind.TIMESLICE.getLiteral())
        ...
        String toolName = "Timeslice " + this.descriptionNameGenerator.getCreationToolName(this.eClass);
