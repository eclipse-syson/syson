...
/**
 * Data fetcher for the field Mutation#showDiagramsIcons.
 *
 * @author arichard
 */
...
public class MutationShowDiagramsIconsDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationShowDiagramsIconsDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
