...
public abstract class AbstractViewNodeToolSectionSwitch extends SysmlEClassSwitch<List<NodeToolSection>> {
    ...
    /**
     * Creates all compartment item creation tools for all references retrieved by
     * {@link AbstractViewNodeToolSectionSwitch#getElementCompartmentReferences}, that are not part of the given
     * exclusion list. This is useful when some compartment element creation tools are custom.
     *
     * @param element
