...
/**
 * Used to add the standard done action inside diagrams.
 *
 * @author Jerome Gout
 */
public class DoneActionNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var params = List.of(
                AQLUtils.aqlString(this.descriptionNameGenerator.getNodeName(DoneActionNodeDescriptionProvider.DONE_ACTION_NAME)),
        ...
        var creationServiceCall = this.viewBuilderHelper.newChangeContext()
                .expression(AQLUtils.getSelfServiceCallExpression("addDoneAction"));
        ...
        return builder.name("Add Done Action")
                .iconURLsExpression("/icons/done_action.svg")
                .body(creationServiceCall.build())
                .preconditionExpression(AQLUtils.getSelfServiceCallExpression("canAddDoneAction"))
                .build();
    }
}
