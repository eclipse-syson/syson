...
public class ViewEdgeService {
     ...
     * @param input
     *            the input
     * @return a feature or <code>null</code>
     */
    public Feature unwrapReferenceUsage(Object input) {
        if (input instanceof ReferenceUsage refUsage) {

            return refUsage.getOwnedRedefinition().stream()
