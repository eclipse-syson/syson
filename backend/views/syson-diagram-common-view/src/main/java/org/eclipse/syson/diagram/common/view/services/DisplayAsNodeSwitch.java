 ...
 * @author arichard
 */
public class DisplayAsNodeSwitch extends SysmlSwitch<Boolean> {
    ...
    public DisplayAsNodeSwitch(boolean isGeneralView, List<Element> exposedElements, Element parentElement) {
    ...
    public Boolean caseAttributeUsage(AttributeUsage object) {
        ...
        return !this.isNestedNode(object);
    }
