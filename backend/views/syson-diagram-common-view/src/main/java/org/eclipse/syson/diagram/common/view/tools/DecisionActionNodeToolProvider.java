...
/**
 * Used to add the decision action inside diagrams.
 *
 * @author Jerome Gout
 */
public class DecisionActionNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var params = List.of(
                AQLUtils.aqlString(this.descriptionNameGenerator.getNodeName(DecisionActionNodeDescriptionProvider.DECISION_ACTION_NAME)),
        ...
        var creationServiceCall = this.viewBuilderHelper.newChangeContext()
                .expression(AQLUtils.getSelfServiceCallExpression("createDecisionAction"));
        ...
        return builder.name("New Decision")
                .iconURLsExpression("/icons/full/obj16/DecisionNode.svg")
