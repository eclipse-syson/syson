...
/**
 * Used to create an Assume {@link org.eclipse.syson.sysml.ConstraintUsage} in a {@link org.eclipse.syson.sysml.RequirementUsage} or a {@link org.eclipse.syson.sysml.RequirementDefinition}.
 *
 * @author gcoutable
 */
public class AssumeConstraintNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var body = this.viewBuilderHelper.newChangeContext()
                .expression(ServiceMethod.of2(ModelMutationAQLService::createConstraint).aqlSelf("selectedObject", "assumptionConstraint"))
    ...
    private DialogDescription getDialogDescription() {
        ...
        return this.diagramBuilderHelper.newSelectionDialogDescription()
                ...
                .descriptionExpression("Create an Assume Constraint")
                .noSelectionActionLabelExpression("Create a New Assume Constraint")
                .noSelectionActionDescriptionExpression("Create a New Assume Constraint without referencing an existing Constraint")
                .withSelectionActionLabelExpression("Select an existing Constraint to assume")
                .withSelectionActionDescriptionExpression("Create a New Assume Constraint referencing the selected Constraint")
                .noSelectionActionStatusMessageExpression("It will create a New Assume Constraint without referencing an existing Constraint")
                .selectionRequiredWithoutSelectionStatusMessageExpression("Select one Constraint to assume")
