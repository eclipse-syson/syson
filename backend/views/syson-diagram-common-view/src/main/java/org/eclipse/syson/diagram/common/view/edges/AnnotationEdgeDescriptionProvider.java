...
public class AnnotationEdgeDescriptionProvider extends AbstractEdgeDescriptionProvider {
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        cache.getEdgeDescription(this.descriptionNameGenerator.getEdgeName(SysmlPackage.eINSTANCE.getSatisfyRequirementUsage())).ifPresent(targetNodes::add);
    ...
    protected ChangeContextBuilder getTargetReconnectToolBody() {
        return this.viewBuilderHelper.newChangeContext()
                .expression(ServiceMethod.of1(DiagramMutationAQLService::reconnnectTargetAnnotatedEdge)
