 ...
 *
 * <p>
 * Displays the selection dialog to choose which time slice to create.
 * </p>
 *
 * @author gcoutable
 */
public class OccurrenceUsageTimesliceNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var letNewTimeSlice = this.viewBuilderHelper.newLet()
                .variableName("newInstance")
                .valueExpression(ServiceMethod.of1(ModelMutationAQLService::createOccurrenceInOccurrence).aqlSelf("objectToCreate"))
        ...
        var letObjectToCreate = this.viewBuilderHelper.newLet()
                ...
                .children(letNewTimeSlice.build());
