...
/**
 * Used to add the join action inside diagrams.
 *
 * @author Jerome Gout
 */
public class JoinActionNodeToolProvider implements INodeToolProvider {
    ...
    public NodeTool create(IViewDiagramElementFinder cache) {
        ...
        var params = List.of(
                AQLUtils.aqlString(this.descriptionNameGenerator.getNodeName(JoinActionNodeDescriptionProvider.JOIN_ACTION_NAME)),
        ...
        var creationServiceCall = this.viewBuilderHelper.newChangeContext()
                .expression(AQLUtils.getSelfServiceCallExpression("createJoinAction"));
        ...
        return builder.name("New Join")
                .iconURLsExpression("/icons/full/obj16/JoinNode.svg")
