    ...
    public NodeDescription create() {
        return this.diagramBuilderHelper.newNodeDescription()
                ...
                .preconditionExpression(
                        AQLUtils.getSelfServiceCallExpression("isView", List.of("'StandardViewDefinitions::InterconnectionView'", IEditingContext.EDITING_CONTEXT, IDiagramContext.DIAGRAM_CONTEXT)))
