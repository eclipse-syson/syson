...
/**
 * Used to create the Definition items compartment item node description.
 *
 * @author arichard
 */
public class DefinitionItemsCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node DefinitionItemsCompartmentItem";

    public DefinitionItemsCompartmentItemNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
