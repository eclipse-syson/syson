...
/**
 * {@link RequirementUsageActorsCompartmentNodeDescriptionProvider} specialization for
 * {@link RequirementUsage#getStakeholderParameter()}.
 *
 * @author flatombe
 */
public class RequirementUsageStakeholdersCompartmentNodeDescriptionProvider extends AbstractCompartmentNodeDescriptionProvider {

    public RequirementUsageStakeholdersCompartmentNodeDescriptionProvider(EClass eClass, EReference eReference, IColorProvider colorProvider, IDescriptionNameGenerator descriptionNameGenerator) {
