...
public class PerformActionsCompartmentNodeDescriptionProvider extends AbstractCompartmentNodeDescriptionProvider {
    ...
    public static final String PERFORM_ACTIONS_NAME = " perform " + AbstractActionsCompartmentNodeDescriptionProvider.ACTIONS_COMPARTMENT_LABEL;
    ...
    public NodeDescription create() {
        ...
        nd.setName(this.getDescriptionNameGenerator().getCompartmentName(this.eClass, this.eReference) + PERFORM_ACTIONS_NAME);
        return nd;
    }
    ...
    protected List<NodeDescription> getDroppableNodes(IViewDiagramElementFinder cache) {
        ...
        cache.getNodeDescription(this.getDescriptionNameGenerator().getCompartmentItemName(this.eClass, this.eReference) + PERFORM_ACTIONS_NAME).ifPresent(acceptedNodeTypes::add);
        return acceptedNodeTypes;
    }

    @Override
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        cache.getNodeDescription(this.getDescriptionNameGenerator().getCompartmentName(this.eClass, this.eReference) + PERFORM_ACTIONS_NAME).ifPresent(nd -> {
            cache.getNodeDescription(this.getDescriptionNameGenerator().getCompartmentItemName(this.eClass, this.eReference) + PERFORM_ACTIONS_NAME).ifPresent(nd.getChildrenDescriptions()::add);
