...
/**
 * Used to create the Usage ports compartment item node description.
 *
 * @author arichard
 */
public class UsagePortsCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node UsagePortsCompartmentItem";

    public UsagePortsCompartmentItemNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
