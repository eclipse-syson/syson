...
/**
 * Used to create the Usage ports compartment node description.
 *
 * @author arichard
 */
public class UsagePortsCompartmentNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node UsagePortsCompartment";

    public UsagePortsCompartmentNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        NodeDescription nodeDescription = optUsagePortsCompartmentNodeDescription.get();
        nodeDescription.getChildrenDescriptions().add(optUSagePortsCompartmentItemNodeDescription.get());
        nodeDescription.setPalette(this.createPortsCompartmentPalette(cache));
    }

    private NodePalette createPortsCompartmentPalette(IViewDiagramElementFinder cache) {
