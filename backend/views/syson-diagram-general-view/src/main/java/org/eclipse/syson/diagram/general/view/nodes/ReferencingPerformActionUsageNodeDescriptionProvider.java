...
/**
 * Used to create the "referencing" PerformActionUsage node description in the General View diagram.<br>
...
public class ReferencingPerformActionUsageNodeDescriptionProvider extends UsageNodeDescriptionProvider {
    ...
    public ReferencingPerformActionUsageNodeDescriptionProvider(IColorProvider colorProvider) {
        super(SysmlPackage.eINSTANCE.getPerformActionUsage(), colorProvider);
    }
