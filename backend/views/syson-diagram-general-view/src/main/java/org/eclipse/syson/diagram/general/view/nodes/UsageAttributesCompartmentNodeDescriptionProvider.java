...
/**
 * Used to create the Usage attributes compartment node description.
 *
 * @author arichard
 */
public class UsageAttributesCompartmentNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node UsageAttributesCompartment";

    public UsageAttributesCompartmentNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        NodeDescription nodeDescription = optUsageAttributesCompartmentNodeDescription.get();
        nodeDescription.getChildrenDescriptions().add(optUsageAttributesCompartmentItemNodeDescription.get());
