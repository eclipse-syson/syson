...
public class ViewUsageNodeDescriptionProvider extends AbstractNodeDescriptionProvider {
    ...
    public NodeDescription create() {
        ...
        return this.diagramBuilderHelper.newNodeDescription()
                ...
                .semanticCandidatesExpression(AQLUtils.getSelfServiceCallExpression("getExposedElements", List.of(domainType, IEditingContext.EDITING_CONTEXT, IDiagramContext.DIAGRAM_CONTEXT)))
