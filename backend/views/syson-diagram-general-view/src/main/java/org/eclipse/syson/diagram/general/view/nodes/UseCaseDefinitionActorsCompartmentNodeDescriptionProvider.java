...
/**
 * UseCase definition actor Compartment node description.
 *
 * @author gdaniel
 */
public class UseCaseDefinitionActorsCompartmentNodeDescriptionProvider extends AbstractCompartmentNodeDescriptionProvider {

    public UseCaseDefinitionActorsCompartmentNodeDescriptionProvider(IColorProvider colorProvider, IDescriptionNameGenerator descriptionNameGenerator) {
        super(SysmlPackage.eINSTANCE.getUseCaseDefinition(), SysmlPackage.eINSTANCE.getCaseDefinition_ActorParameter(), colorProvider, descriptionNameGenerator);
    }
