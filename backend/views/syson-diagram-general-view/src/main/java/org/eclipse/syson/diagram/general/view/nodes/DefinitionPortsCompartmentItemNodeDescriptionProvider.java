...
/**
 * Used to create the Definition ports compartment item node description.
 *
 * @author arichard
 */
public class DefinitionPortsCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node DefinitionPortsCompartmentItem";

    public DefinitionPortsCompartmentItemNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
