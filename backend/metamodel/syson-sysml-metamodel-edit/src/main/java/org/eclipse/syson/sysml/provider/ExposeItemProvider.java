...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.Expose} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class ExposeItemProvider extends ImportItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Expose_type") : this.getString("_UI_Expose_type") + " " + label;
    }
