...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.MembershipImport} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class MembershipImportItemProvider extends ImportItemProvider {
    ...
    protected void addImportedMembershipPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_MembershipImport_importedMembership_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_MembershipImport_importedMembership_feature", "_UI_MembershipImport_type"),
    ...
    /**
     * This returns MembershipImport.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_MembershipImport_type") : this.getString("_UI_MembershipImport_type") + " " + label;
    }
