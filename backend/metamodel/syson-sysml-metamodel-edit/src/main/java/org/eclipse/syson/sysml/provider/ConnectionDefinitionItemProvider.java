...
public class ConnectionDefinitionItemProvider extends PartDefinitionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addConnectionEndPropertyDescriptor(object);
        }
    ...
    /**
     * This adds a property descriptor for the Connection End feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addConnectionEndPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_ConnectionDefinition_connectionEnd_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ConnectionDefinition_connectionEnd_feature", "_UI_ConnectionDefinition_type"),
    ...
    /**
     * This returns ConnectionDefinition.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ConnectionDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConnectionDefinition_type") : this.getString("_UI_ConnectionDefinition_type") + " " + label;
    }
