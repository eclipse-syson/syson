...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.Featuring} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class FeaturingItemProvider extends RelationshipItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public FeaturingItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((Featuring) object).getName();
        return label == null || label.length() == 0 ? this.getString("_UI_Featuring_type") : this.getString("_UI_Featuring_type") + " " + label;
    }
