...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.CalculationUsage} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class CalculationUsageItemProvider extends ActionUsageItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addCalculationDefinitionPropertyDescriptor(object);
        }
    ...
    /**
     * This adds a property descriptor for the Calculation Definition feature. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    protected void addCalculationDefinitionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CalculationUsage_calculationDefinition_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CalculationUsage_calculationDefinition_feature", "_UI_CalculationUsage_type"),
    ...
    /**
     * This returns CalculationUsage.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CalculationUsage.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_CalculationUsage_type") : this.getString("_UI_CalculationUsage_type") + " " + label;
    }
