...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.MetadataUsage} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class MetadataUsageItemProvider extends ItemUsageItemProvider {
    ...
    /**
     * This adds a property descriptor for the Metadata Definition feature. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    protected void addMetadataDefinitionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_MetadataUsage_metadataDefinition_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_MetadataUsage_metadataDefinition_feature", "_UI_MetadataUsage_type"),
    ...
    /**
     * This returns MetadataUsage.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/MetadataUsage.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_MetadataUsage_type") : this.getString("_UI_MetadataUsage_type") + " " + label;
    }
