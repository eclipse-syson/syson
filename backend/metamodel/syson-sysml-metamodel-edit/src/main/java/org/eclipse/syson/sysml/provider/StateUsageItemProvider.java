...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.StateUsage} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class StateUsageItemProvider extends ActionUsageItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addStateDefinitionPropertyDescriptor(object);
        }
    ...
    protected void addDoActionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_StateUsage_doAction_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateUsage_doAction_feature", "_UI_StateUsage_type"),
    ...
    protected void addEntryActionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_StateUsage_entryAction_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateUsage_entryAction_feature", "_UI_StateUsage_type"),
    ...
    protected void addExitActionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_StateUsage_exitAction_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateUsage_exitAction_feature", "_UI_StateUsage_type"),
    ...
    protected void addIsParallelPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_StateUsage_isParallel_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateUsage_isParallel_feature", "_UI_StateUsage_type"),
    ...
    /**
     * This adds a property descriptor for the State Definition feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addStateDefinitionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_StateUsage_stateDefinition_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateUsage_stateDefinition_feature", "_UI_StateUsage_type"),
    ...
    /**
     * This returns StateUsage.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/StateUsage.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_StateUsage_type") : this.getString("_UI_StateUsage_type") + " " + label;
    }
