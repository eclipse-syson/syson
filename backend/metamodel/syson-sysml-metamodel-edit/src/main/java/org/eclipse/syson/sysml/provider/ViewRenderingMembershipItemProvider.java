...
public class ViewRenderingMembershipItemProvider extends FeatureMembershipItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addReferencedRenderingPropertyDescriptor(object);
        }
    ...
    protected void addOwnedRenderingPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_ViewRenderingMembership_ownedRendering_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ViewRenderingMembership_ownedRendering_feature", "_UI_ViewRenderingMembership_type"),
    ...
    /**
     * This adds a property descriptor for the Referenced Rendering feature. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    protected void addReferencedRenderingPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_ViewRenderingMembership_referencedRendering_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ViewRenderingMembership_referencedRendering_feature", "_UI_ViewRenderingMembership_type"),
    ...
    /**
     * This returns ViewRenderingMembership.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ViewRenderingMembership.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ViewRenderingMembership_type") : this.getString("_UI_ViewRenderingMembership_type") + " " + label;
    }
