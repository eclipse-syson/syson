...
public class VerificationCaseDefinitionItemProvider extends CaseDefinitionItemProvider {
    ...
    protected void addVerifiedRequirementPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_VerificationCaseDefinition_verifiedRequirement_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_VerificationCaseDefinition_verifiedRequirement_feature", "_UI_VerificationCaseDefinition_type"),
    ...
    /**
     * This returns VerificationCaseDefinition.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/VerificationCaseDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_VerificationCaseDefinition_type") : this.getString("_UI_VerificationCaseDefinition_type") + " " + label;
    }
