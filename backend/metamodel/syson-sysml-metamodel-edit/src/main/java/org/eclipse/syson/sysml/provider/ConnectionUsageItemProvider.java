...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.ConnectionUsage} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ConnectionUsageItemProvider extends ConnectorAsUsageItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addPartDefinitionPropertyDescriptor(object);
            this.addConnectionDefinitionPropertyDescriptor(object);
        }
    ...
    /**
     * This adds a property descriptor for the Part Definition feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addPartDefinitionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_PartUsage_partDefinition_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_PartUsage_partDefinition_feature", "_UI_PartUsage_type"),
    ...
    /**
     * This adds a property descriptor for the Connection Definition feature. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    protected void addConnectionDefinitionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_ConnectionUsage_connectionDefinition_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ConnectionUsage_connectionDefinition_feature", "_UI_ConnectionUsage_type"),
    ...
    /**
     * This returns ConnectionUsage.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ConnectionUsage.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConnectionUsage_type") : this.getString("_UI_ConnectionUsage_type") + " " + label;
    }
