...
public class StateSubactionMembershipItemProvider extends FeatureMembershipItemProvider {
    ...
    protected void addActionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_StateSubactionMembership_action_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateSubactionMembership_action_feature", "_UI_StateSubactionMembership_type"),
    ...
    protected void addKindPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_StateSubactionMembership_kind_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_StateSubactionMembership_kind_feature", "_UI_StateSubactionMembership_type"),
    ...
    /**
     * This returns StateSubactionMembership.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/StateSubactionMembership.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_StateSubactionMembership_type") : this.getString("_UI_StateSubactionMembership_type") + " " + label;
    }
