...
public class ConstraintDefinitionItemProvider extends OccurrenceDefinitionItemProvider {
    ...
    /**
     * This returns ConstraintDefinition.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ConstraintDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConstraintDefinition_type") : this.getString("_UI_ConstraintDefinition_type") + " " + label;
    }
