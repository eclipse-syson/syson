...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.FlowDefinition} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class FlowDefinitionItemProvider extends ActionDefinitionItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public FlowDefinitionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addFlowEndPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_FlowDefinition_flowEnd_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_FlowDefinition_flowEnd_feature", "_UI_FlowDefinition_type"),
                SysmlPackage.eINSTANCE.getFlowDefinition_FlowEnd(),
                false,
                false,
                false,
                null,
    ...
    /**
     * This returns FlowDefinition.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/FlowDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        String label = ((FlowDefinition) object).getName();
        return label == null || label.length() == 0 ? this.getString("_UI_FlowDefinition_type") : this.getString("_UI_FlowDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(FlowDefinition.class)) {
