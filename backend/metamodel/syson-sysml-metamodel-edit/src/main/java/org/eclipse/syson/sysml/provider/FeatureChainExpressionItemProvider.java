...
public class FeatureChainExpressionItemProvider extends OperatorExpressionItemProvider {
    ...
    protected void addTargetFeaturePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_FeatureChainExpression_targetFeature_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_FeatureChainExpression_targetFeature_feature", "_UI_FeatureChainExpression_type"),
    ...
    /**
     * This returns FeatureChainExpression.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/FeatureChainExpression.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_FeatureChainExpression_type") : this.getString("_UI_FeatureChainExpression_type") + " " + label;
    }
