...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.FlowConnectionDefinition} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class FlowConnectionDefinitionItemProvider extends ActionDefinitionItemProvider {
    /**
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addAssociationEndPropertyDescriptor(object);
            this.addRelatedTypePropertyDescriptor(object);
            this.addSourceTypePropertyDescriptor(object);
            this.addTargetTypePropertyDescriptor(object);
            this.addFlowConnectionEndPropertyDescriptor(object);
        }
    ...
    /**
     * This adds a property descriptor for the Association End feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addAssociationEndPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_Association_associationEnd_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Association_associationEnd_feature", "_UI_Association_type"),
    ...
    /**
     * This adds a property descriptor for the Related Type feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addRelatedTypePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_Association_relatedType_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Association_relatedType_feature", "_UI_Association_type"),
    ...
    /**
     * This adds a property descriptor for the Source Type feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addSourceTypePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_Association_sourceType_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Association_sourceType_feature", "_UI_Association_type"),
    ...
    protected void addTargetTypePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_Association_targetType_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_Association_targetType_feature", "_UI_Association_type"),
    ...
    /**
     * This adds a property descriptor for the Flow Connection End feature. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    protected void addFlowConnectionEndPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_FlowConnectionDefinition_flowConnectionEnd_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_FlowConnectionDefinition_flowConnectionEnd_feature", "_UI_FlowConnectionDefinition_type"),
                SysmlPackage.eINSTANCE.getFlowConnectionDefinition_FlowConnectionEnd(),
                false,
                false,
                false,
                null,
    ...
    /**
     * This returns FlowConnectionDefinition.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/FlowConnectionDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_FlowConnectionDefinition_type") : this.getString("_UI_FlowConnectionDefinition_type") + " " + label;
    }
