...
public class FlowConnectionDefinitionItemProvider extends ConnectionDefinitionItemProvider {
    ...
    protected void addActionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_ActionDefinition_action_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ActionDefinition_action_feature", "_UI_ActionDefinition_type"),
                SysmlPackage.eINSTANCE.getActionDefinition_Action(),
                true,
                false,
                true,
                null,
