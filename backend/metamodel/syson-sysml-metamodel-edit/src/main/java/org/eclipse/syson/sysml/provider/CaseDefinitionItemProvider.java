...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysml.CaseDefinition} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class CaseDefinitionItemProvider extends CalculationDefinitionItemProvider {
    ...
    protected void addActorParameterPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                ...
                this.getString("_UI_CaseDefinition_actorParameter_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CaseDefinition_actorParameter_feature", "_UI_CaseDefinition_type"),
    ...
    protected void addObjectiveRequirementPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CaseDefinition_objectiveRequirement_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CaseDefinition_objectiveRequirement_feature", "_UI_CaseDefinition_type"),
    ...
    protected void addSubjectParameterPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CaseDefinition_subjectParameter_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CaseDefinition_subjectParameter_feature", "_UI_CaseDefinition_type"),
    ...
    /**
     * This returns CaseDefinition.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CaseDefinition.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_CaseDefinition_type") : this.getString("_UI_CaseDefinition_type") + " " + label;
    }
