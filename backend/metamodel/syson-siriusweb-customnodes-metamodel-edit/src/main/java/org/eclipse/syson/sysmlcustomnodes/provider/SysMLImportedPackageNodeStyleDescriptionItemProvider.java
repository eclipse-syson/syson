 ...
 * {@link org.eclipse.syson.sysmlcustomnodes.SysMLImportedPackageNodeStyleDescription} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class SysMLImportedPackageNodeStyleDescriptionItemProvider
     ...
     * @generated
     */
    public SysMLImportedPackageNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_SysMLImportedPackageNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_SysMLImportedPackageNodeStyleDescription_background_feature", "_UI_SysMLImportedPackageNodeStyleDescription_type"),
                SysMLCustomnodesPackage.Literals.SYS_ML_IMPORTED_PACKAGE_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    /**
     * This returns SysMLImportedPackageNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/SysMLImportedPackageNodeStyleDescription.svg"));
    }
    ...
    public String getText(Object object) {
        SysMLImportedPackageNodeStyleDescription sysMLImportedPackageNodeStyleDescription = (SysMLImportedPackageNodeStyleDescription) object;
        return this.getString("_UI_SysMLImportedPackageNodeStyleDescription_type") + " " + sysMLImportedPackageNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SysMLImportedPackageNodeStyleDescription.class)) {
