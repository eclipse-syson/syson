...
/**
 * This is the item provider adapter for a {@link org.eclipse.syson.sysmlcustomnodes.SysMLNoteNodeStyleDescription}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class SysMLNoteNodeStyleDescriptionItemProvider
     ...
     * @generated
     */
    public SysMLNoteNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_SysMLNoteNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_SysMLNoteNodeStyleDescription_background_feature", "_UI_SysMLNoteNodeStyleDescription_type"),
                SysMLCustomnodesPackage.Literals.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    /**
     * This returns SysMLNoteNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/SysMLNoteNodeStyleDescription.svg"));
    }
    ...
    public String getText(Object object) {
        SysMLNoteNodeStyleDescription sysMLNoteNodeStyleDescription = (SysMLNoteNodeStyleDescription) object;
        return this.getString("_UI_SysMLNoteNodeStyleDescription_type") + " " + sysMLNoteNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SysMLNoteNodeStyleDescription.class)) {
