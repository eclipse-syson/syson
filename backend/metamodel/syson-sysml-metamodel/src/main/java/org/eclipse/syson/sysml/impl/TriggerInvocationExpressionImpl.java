...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trigger Invocation Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TriggerInvocationExpressionImpl extends InvocationExpressionImpl implements TriggerInvocationExpression {
    ...
    public void setKind(TriggerKind newKind) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.TRIGGER_INVOCATION_EXPRESSION__KIND, oldKind, kind));
    }
