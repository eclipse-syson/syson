...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Literal Boolean</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.impl.LiteralBooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralBooleanImpl extends LiteralExpressionImpl implements LiteralBoolean {
    ...
    protected EClass eStaticClass() {
        return SysmlPackage.eINSTANCE.getLiteralBoolean();
    }
    ...
    public void setValue(boolean newValue) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.LITERAL_BOOLEAN__VALUE, oldValue, this.value));
    }
