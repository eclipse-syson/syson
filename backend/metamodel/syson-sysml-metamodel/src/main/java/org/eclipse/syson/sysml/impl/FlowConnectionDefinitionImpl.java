 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#isIsImplied <em>Is Implied</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getOwnedRelatedElement <em>Owned Related
 * Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getOwningRelatedElement <em>Owning Related
 * Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getRelatedElement <em>Related Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getSource <em>Source</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getTarget <em>Target</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getAssociationEnd <em>Association End</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getRelatedType <em>Related Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getSourceType <em>Source Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getTargetType <em>Target Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowConnectionDefinitionImpl#getFlowConnectionEnd <em>Flow Connection
 * End</em>}</li>
 * </ul>
 *
 * @generated
...
public class FlowConnectionDefinitionImpl extends ActionDefinitionImpl implements FlowConnectionDefinition {
    ...
    public void setIsImplied(boolean newIsImplied) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.FLOW_CONNECTION_DEFINITION__IS_IMPLIED, oldIsImplied, this.isImplied));
        }
    }
    ...
    public EList<Element> getOwnedRelatedElement() {
        if (this.ownedRelatedElement == null) {
            this.ownedRelatedElement = new EObjectContainmentWithInverseEList<>(Element.class, this, SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNED_RELATED_ELEMENT,
    ...
    public Element getOwningRelatedElement() {
        if (this.eContainerFeatureID() != SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNING_RELATED_ELEMENT) {
            return null;
        }
    ...
    public NotificationChain basicSetOwningRelatedElement(Element newOwningRelatedElement, NotificationChain msgs) {
        msgs = this.eBasicSetContainer((InternalEObject) newOwningRelatedElement, SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNING_RELATED_ELEMENT, msgs);
        return msgs;
    }
    ...
    public void setOwningRelatedElement(Element newOwningRelatedElement) {
        if (newOwningRelatedElement != this.eInternalContainer()
                || (this.eContainerFeatureID() != SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNING_RELATED_ELEMENT && newOwningRelatedElement != null)) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNING_RELATED_ELEMENT, newOwningRelatedElement, newOwningRelatedElement));
        }
    }
    ...
    public EList<Element> getSource() {
        if (this.source == null) {
            this.source = new EObjectResolvingEList<>(Element.class, this, SysmlPackage.FLOW_CONNECTION_DEFINITION__SOURCE);
        }
        return this.source;
    }
    ...
    public EList<Element> getTarget() {
        if (this.target == null) {
            this.target = new EObjectResolvingEList<>(Element.class, this, SysmlPackage.FLOW_CONNECTION_DEFINITION__TARGET);
        }
        return this.target;
    }
    ...
    public EList<Usage> getFlowConnectionEnd() {
        List<Usage> flowConnectionEnds = new ArrayList<>();
        this.getFeature().stream()
                .filter(Feature::isIsEnd)
                .filter(Usage.class::isInstance)
                .map(Usage.class::cast)
                .forEach(flowConnectionEnds::add);
        return new EcoreEList.UnmodifiableEList<>(this, SysmlPackage.eINSTANCE.getAssociation_AssociationEnd(), flowConnectionEnds.size(), flowConnectionEnds.toArray());
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case SysmlPackage.FLOW_CONNECTION_DEFINITION__FLOW_CONNECTION_END:
                return this.getFlowConnectionEnd();
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case SysmlPackage.FLOW_CONNECTION_DEFINITION__FLOW_CONNECTION_END:
                return !this.getFlowConnectionEnd().isEmpty();
        }
        ...
        if (baseClass == Relationship.class) {
            switch (baseFeatureID) {
                case SysmlPackage.RELATIONSHIP__IS_IMPLIED:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__IS_IMPLIED;
                case SysmlPackage.RELATIONSHIP__OWNED_RELATED_ELEMENT:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNED_RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__OWNING_RELATED_ELEMENT:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__OWNING_RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__RELATED_ELEMENT:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__SOURCE:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__SOURCE;
                case SysmlPackage.RELATIONSHIP__TARGET:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__TARGET;
                default:
                    return -1;
            }
        }
        if (baseClass == Association.class) {
            switch (baseFeatureID) {
                case SysmlPackage.ASSOCIATION__ASSOCIATION_END:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__ASSOCIATION_END;
                case SysmlPackage.ASSOCIATION__RELATED_TYPE:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__RELATED_TYPE;
                case SysmlPackage.ASSOCIATION__SOURCE_TYPE:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__SOURCE_TYPE;
                case SysmlPackage.ASSOCIATION__TARGET_TYPE:
                    return SysmlPackage.FLOW_CONNECTION_DEFINITION__TARGET_TYPE;
                default:
                    return -1;
            }
        }
