...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Owning Membership</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface OwningMembership extends Membership {
    /**
     * Returns the value of the '<em><b>Owned Member Element</b></em>' reference. It is bidirectional and its opposite
     * is '{@link org.eclipse.syson.sysml.Element#getOwningMembership <em>Owning Membership</em>}'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Member Element Id</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Member Name</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Member Short Name</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
