...
public interface Dependency extends Relationship {
    /**
     * Returns the value of the '<em><b>Client</b></em>' reference list. The list contents are of type
    ...
    /**
     * Returns the value of the '<em><b>Supplier</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.Element}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
