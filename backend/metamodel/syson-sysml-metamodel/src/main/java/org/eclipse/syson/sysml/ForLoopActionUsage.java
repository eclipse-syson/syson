...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>For Loop Action Usage</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface ForLoopActionUsage extends LoopActionUsage {
    /**
     * Returns the value of the '<em><b>Loop Variable</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Seq Argument</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
