...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Conjugation</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface Conjugation extends Relationship {
    /**
     * Returns the value of the '<em><b>Conjugated Type</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Conjugation#getConjugatedType <em>Conjugated Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Conjugated Type</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Original Type</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Conjugation#getOriginalType <em>Original Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Original Type</em>' reference.
     * @see #getOriginalType()
     * @generated
     */
     ...
     * '{@link org.eclipse.syson.sysml.Type#getOwnedConjugator <em>Owned Conjugator</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
