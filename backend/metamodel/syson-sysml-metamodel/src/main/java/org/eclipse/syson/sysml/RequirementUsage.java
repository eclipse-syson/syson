...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Requirement Usage</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface RequirementUsage extends ConstraintUsage {
    ...
    /**
     * Returns the value of the '<em><b>Assumed Constraint</b></em>' reference list. The list contents are of type
    ...
    /**
     * Returns the value of the '<em><b>Framed Concern</b></em>' reference list. The list contents are of type
    ...
    /**
     * Returns the value of the '<em><b>Req Id</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     ...
     *
     * @param value
     *            the new value of the '<em>Req Id</em>' attribute.
     * @see #getReqId()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Required Constraint</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.ConstraintUsage}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Requirement Definition</b></em>' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Stakeholder Parameter</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.PartUsage}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Text</b></em>' attribute list. The list contents are of type
