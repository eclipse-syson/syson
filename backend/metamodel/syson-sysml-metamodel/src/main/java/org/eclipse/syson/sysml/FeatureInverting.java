...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Feature Inverting</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface FeatureInverting extends Relationship {
    /**
     * Returns the value of the '<em><b>Feature Inverted</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.FeatureInverting#getFeatureInverted <em>Feature
     * Inverted</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Feature Inverted</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Inverting Feature</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.FeatureInverting#getInvertingFeature <em>Inverting
     * Feature</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Inverting Feature</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Owning Feature</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Feature#getOwnedFeatureInverting <em>Owned Feature Inverting</em>}'. <!--
     ...
     * @model opposite="ownedFeatureInverting" transient="true" changeable="false" volatile="true" derived="true"
     *        ordered="false"
     * @generated
     */
