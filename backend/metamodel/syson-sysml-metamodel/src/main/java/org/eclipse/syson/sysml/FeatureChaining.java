...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Feature Chaining</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface FeatureChaining extends Relationship {
    /**
     * Returns the value of the '<em><b>Chaining Feature</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.FeatureChaining#getChainingFeature <em>Chaining
     * Feature</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Chaining Feature</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Feature Chained</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Feature#getOwnedFeatureChaining <em>Owned Feature Chaining</em>}'. <!--
     ...
     * @model opposite="ownedFeatureChaining" required="true" transient="true" changeable="false" volatile="true"
