...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Disjoining</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface Disjoining extends Relationship {
    /**
     * Returns the value of the '<em><b>Disjoining Type</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Disjoining#getDisjoiningType <em>Disjoining Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Disjoining Type</em>' reference.
     ...
     * '{@link org.eclipse.syson.sysml.Type#getOwnedDisjoining <em>Owned Disjoining</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Type Disjoined</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Disjoining#getTypeDisjoined <em>Type Disjoined</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Type Disjoined</em>' reference.
