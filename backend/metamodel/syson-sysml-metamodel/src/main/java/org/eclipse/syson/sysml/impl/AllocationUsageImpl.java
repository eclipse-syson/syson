...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Allocation Usage</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.impl.AllocationUsageImpl#getAllocationDefinition <em>Allocation
 * Definition</em>}</li>
 * </ul>
 *
 * @generated
...
public class AllocationUsageImpl extends ConnectionUsageImpl implements AllocationUsage {
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SysmlPackage.ALLOCATION_USAGE__ALLOCATION_DEFINITION:
                return this.getAllocationDefinition();
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case SysmlPackage.ALLOCATION_USAGE__ALLOCATION_DEFINITION:
                return !this.getAllocationDefinition().isEmpty();
        }
