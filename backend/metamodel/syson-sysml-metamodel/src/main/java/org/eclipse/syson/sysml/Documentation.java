...
public interface Documentation extends Comment {
    /**
     * Returns the value of the '<em><b>Documented Element</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Element#getDocumentation <em>Documentation</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
