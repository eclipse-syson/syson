...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>If Action Usage</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface IfActionUsage extends ActionUsage {
    /**
     * Returns the value of the '<em><b>Else Action</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>If Argument</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Then Action</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
