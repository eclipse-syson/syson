...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>While Loop Action Usage</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface WhileLoopActionUsage extends LoopActionUsage {
    /**
     * Returns the value of the '<em><b>Until Argument</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Returns the value of the '<em><b>While Argument</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
