...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Feature Typing</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface FeatureTyping extends Specialization {
     ...
     * '{@link org.eclipse.syson.sysml.Feature#getOwnedTyping <em>Owned Typing</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Typed Feature</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.FeatureTyping#getTypedFeature <em>Typed Feature</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Typed Feature</em>' reference.
     * @see #getTypedFeature()
     * @generated
     */
