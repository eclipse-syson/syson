...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Port Conjugation</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.PortConjugation#getConjugatedPortDefinition <em>Conjugated Port
 * Definition</em>}</li>
...
public interface PortConjugation extends Conjugation {
     ...
     * opposite is '{@link org.eclipse.syson.sysml.ConjugatedPortDefinition#getOwnedPortConjugator <em>Owned Port
     * Conjugator</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     ...
     * @model opposite="ownedPortConjugator" required="true" transient="true" changeable="false" volatile="true"
    ...
    /**
     * Returns the value of the '<em><b>Original Port Definition</b></em>' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.PortConjugation#getOriginalPortDefinition <em>Original Port
     * Definition</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Original Port Definition</em>' reference.
