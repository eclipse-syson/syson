...
public interface Differencing extends Relationship {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Differencing#getDifferencingType <em>Differencing Type</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link org.eclipse.syson.sysml.Type#getOwnedDifferencing <em>Owned Differencing</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model opposite="ownedDifferencing" required="true" transient="true" changeable="false" volatile="true" derived="true" ordered="false"
     * @generated
     */
