...
public interface Element extends EModelElement {
    ...
    /**
     * Returns the value of the '<em><b>Declared Name</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     ...
     *
     * @param value
     *            the new value of the '<em>Declared Name</em>' attribute.
     * @see #getDeclaredName()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Declared Short Name</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Element#getDeclaredShortName <em>Declared Short Name</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Declared Short Name</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Documentation</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.Documentation}. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Documentation#getDocumentedElement <em>Documented Element</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Element Id</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Is Implied Included</b></em>' attribute. The default value is
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Element#isIsImpliedIncluded <em>Is Implied Included</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Is Implied Included</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Is Library Element</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Annotation</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.Annotation}. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Annotation#getOwningAnnotatedElement <em>Owning Annotated Element</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Element</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.Element}. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Element#getOwner <em>Owner</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owned Relationship</b></em>' containment reference list. The list contents are
     * of type {@link org.eclipse.syson.sysml.Relationship}. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Relationship#getOwningRelatedElement <em>Owning Related Element</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owner</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Element#getOwnedElement <em>Owned Element</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owning Membership</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.OwningMembership#getOwnedMemberElement <em>Owned Member Element</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     ...
     * @model opposite="ownedMemberElement" transient="true" changeable="false" volatile="true" derived="true"
     *        ordered="false"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Owning Namespace</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Namespace#getOwnedMember <em>Owned Member</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Owning Relationship</b></em>' container reference. It is bidirectional and its
     * opposite is '{@link org.eclipse.syson.sysml.Relationship#getOwnedRelatedElement <em>Owned Related Element</em>}'.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Element#getOwningRelationship <em>Owning
     * Relationship</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Owning Relationship</em>' container reference.
    ...
    /**
     * Returns the value of the '<em><b>Short Name</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Textual Representation</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.TextualRepresentation}. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.TextualRepresentation#getRepresentedElement <em>Represented Element</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
