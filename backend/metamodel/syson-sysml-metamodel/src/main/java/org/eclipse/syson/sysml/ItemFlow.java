...
public interface ItemFlow extends Connector, Step {
    ...
    /**
     * Returns the value of the '<em><b>Item Feature</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Item Flow End</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.syson.sysml.ItemFlowEnd}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Item Type</b></em>' reference list. The list contents are of type
