...
public interface Intersecting extends Relationship {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Intersecting#getIntersectingType <em>Intersecting Type</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link org.eclipse.syson.sysml.Type#getOwnedIntersecting <em>Owned Intersecting</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model opposite="ownedIntersecting" required="true" transient="true" changeable="false" volatile="true" derived="true" ordered="false"
     * @generated
     */
