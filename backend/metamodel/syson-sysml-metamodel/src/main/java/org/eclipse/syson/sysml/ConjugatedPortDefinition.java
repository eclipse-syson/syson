...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Conjugated Port Definition</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.ConjugatedPortDefinition#getOriginalPortDefinition <em>Original Port
 * Definition</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.ConjugatedPortDefinition#getOwnedPortConjugator <em>Owned Port
 * Conjugator</em>}</li>
 * </ul>
 *
...
public interface ConjugatedPortDefinition extends PortDefinition {
    /**
     * Returns the value of the '<em><b>Original Port Definition</b></em>' reference. It is bidirectional and its
     * opposite is '{@link org.eclipse.syson.sysml.PortDefinition#getConjugatedPortDefinition <em>Conjugated Port
    ...
    /**
     * Returns the value of the '<em><b>Owned Port Conjugator</b></em>' reference. It is bidirectional and its opposite
     * is '{@link org.eclipse.syson.sysml.PortConjugation#getConjugatedPortDefinition <em>Conjugated Port
     * Definition</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
