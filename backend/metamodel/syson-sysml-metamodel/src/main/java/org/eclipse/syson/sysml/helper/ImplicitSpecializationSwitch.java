...
public class ImplicitSpecializationSwitch extends SysmlSwitch<List<Specialization>> {
    ...
    public List<Specialization> caseType(Type object) {
        ...
        if (!metadataUsage.isEmpty()) {
             ...
             */
            Type semanticMedatadaMetaclass = this.namespaceProvider.getNamespaceFromStandardLibrary("Metaobjects::SemanticMetadata", Type.class);
    ...
    private List<Type> getBaseTypes(MetadataUsage metadaUsage) {
        ...
        Feature baseTypeFeature = this.namespaceProvider.getNamespaceFromStandardLibrary(baseTypeFeatureQn, Feature.class);
