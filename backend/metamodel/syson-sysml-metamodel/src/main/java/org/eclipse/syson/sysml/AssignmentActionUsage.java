...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Assignment Action Usage</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface AssignmentActionUsage extends ActionUsage {
    /**
     * Returns the value of the '<em><b>Referent</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Target Argument</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Value Expression</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
