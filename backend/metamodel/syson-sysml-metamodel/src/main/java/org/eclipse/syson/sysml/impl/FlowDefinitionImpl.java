...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Flow Definition</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#isIsImplied <em>Is Implied</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getOwnedRelatedElement <em>Owned Related
 * Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getOwningRelatedElement <em>Owning Related
 * Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getRelatedElement <em>Related Element</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getSource <em>Source</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getTarget <em>Target</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getAssociationEnd <em>Association End</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getRelatedType <em>Related Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getSourceType <em>Source Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getTargetType <em>Target Type</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.FlowDefinitionImpl#getFlowEnd <em>Flow End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlowDefinitionImpl extends ActionDefinitionImpl implements FlowDefinition {
    ...
    protected EClass eStaticClass() {
        return SysmlPackage.eINSTANCE.getFlowDefinition();
    }
    ...
    public void setIsImplied(boolean newIsImplied) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.FLOW_DEFINITION__IS_IMPLIED, oldIsImplied, this.isImplied));
        }
    }
    ...
    public EList<Element> getOwnedRelatedElement() {
        if (this.ownedRelatedElement == null) {
            this.ownedRelatedElement = new EObjectContainmentWithInverseEList<>(Element.class, this, SysmlPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT,
    ...
    public Element getOwningRelatedElement() {
        if (this.eContainerFeatureID() != SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT) {
            return null;
        }
    ...
    public NotificationChain basicSetOwningRelatedElement(Element newOwningRelatedElement, NotificationChain msgs) {
        msgs = this.eBasicSetContainer((InternalEObject) newOwningRelatedElement, SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, msgs);
        return msgs;
    }
    ...
    public void setOwningRelatedElement(Element newOwningRelatedElement) {
        if (newOwningRelatedElement != this.eInternalContainer() || (this.eContainerFeatureID() != SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT && newOwningRelatedElement != null)) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, newOwningRelatedElement, newOwningRelatedElement));
        }
    }
    ...
    public EList<Element> getRelatedElement() {
        List<Element> relatedElements = new BasicEList<>();
    ...
    public EList<Element> getSource() {
        if (this.source == null) {
            this.source = new EObjectResolvingEList<>(Element.class, this, SysmlPackage.FLOW_DEFINITION__SOURCE);
        }
        return this.source;
    }
    ...
    public EList<Element> getTarget() {
        if (this.target == null) {
            this.target = new EObjectResolvingEList<>(Element.class, this, SysmlPackage.FLOW_DEFINITION__TARGET);
        }
        return this.target;
    }
    ...
    public EList<Usage> getFlowEnd() {
        List<Usage> flowEnds = new ArrayList<>();
        this.getFeature().stream()
                .filter(Feature::isIsEnd)
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case SysmlPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT:
                return ((InternalEList<InternalEObject>) (InternalEList<?>) this.getOwnedRelatedElement()).basicAdd(otherEnd, msgs);
            case SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT:
                if (this.eInternalContainer() != null) {
                    msgs = this.eBasicRemoveFromContainer(msgs);
                }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SysmlPackage.FLOW_DEFINITION__IS_IMPLIED:
                return this.isIsImplied();
            case SysmlPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT:
                return this.getOwnedRelatedElement();
            case SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT:
                return this.getOwningRelatedElement();
            case SysmlPackage.FLOW_DEFINITION__RELATED_ELEMENT:
                return this.getRelatedElement();
            case SysmlPackage.FLOW_DEFINITION__SOURCE:
                return this.getSource();
            case SysmlPackage.FLOW_DEFINITION__TARGET:
                return this.getTarget();
            case SysmlPackage.FLOW_DEFINITION__ASSOCIATION_END:
                return this.getAssociationEnd();
            case SysmlPackage.FLOW_DEFINITION__RELATED_TYPE:
                return this.getRelatedType();
            case SysmlPackage.FLOW_DEFINITION__SOURCE_TYPE:
                if (resolve) {
                    return this.getSourceType();
                }
                return this.basicGetSourceType();
            case SysmlPackage.FLOW_DEFINITION__TARGET_TYPE:
                return this.getTargetType();
            case SysmlPackage.FLOW_DEFINITION__FLOW_END:
        ...
        if (baseClass == Relationship.class) {
            switch (baseFeatureID) {
                case SysmlPackage.RELATIONSHIP__IS_IMPLIED:
                    return SysmlPackage.FLOW_DEFINITION__IS_IMPLIED;
                case SysmlPackage.RELATIONSHIP__OWNED_RELATED_ELEMENT:
                    return SysmlPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__OWNING_RELATED_ELEMENT:
                    return SysmlPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__RELATED_ELEMENT:
                    return SysmlPackage.FLOW_DEFINITION__RELATED_ELEMENT;
                case SysmlPackage.RELATIONSHIP__SOURCE:
                    return SysmlPackage.FLOW_DEFINITION__SOURCE;
                case SysmlPackage.RELATIONSHIP__TARGET:
                    return SysmlPackage.FLOW_DEFINITION__TARGET;
                default:
                    return -1;
            }
        }
        if (baseClass == Association.class) {
            switch (baseFeatureID) {
                ...
                case SysmlPackage.ASSOCIATION__RELATED_TYPE:
                    return SysmlPackage.FLOW_DEFINITION__RELATED_TYPE;
                case SysmlPackage.ASSOCIATION__SOURCE_TYPE:
                    return SysmlPackage.FLOW_DEFINITION__SOURCE_TYPE;
                case SysmlPackage.ASSOCIATION__TARGET_TYPE:
                    return SysmlPackage.FLOW_DEFINITION__TARGET_TYPE;
                default:
                    return -1;
            }
        }
