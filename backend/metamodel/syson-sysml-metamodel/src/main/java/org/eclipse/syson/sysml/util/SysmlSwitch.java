...
public class SysmlSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case SysmlPackage.CROSS_SUBSETTING: {
                CrossSubsetting crossSubsetting = (CrossSubsetting) theEObject;
                T result = this.caseCrossSubsetting(crossSubsetting);
                if (result == null) {
                    result = this.caseSubsetting(crossSubsetting);
                }
                if (result == null) {
                    result = this.caseSpecialization(crossSubsetting);
                }
                if (result == null) {
                    result = this.caseRelationship(crossSubsetting);
                }
                if (result == null) {
                    result = this.caseElement(crossSubsetting);
                }
                if (result == null) {
                    result = this.caseEModelElement(crossSubsetting);
                }
                if (result == null) {
                    result = this.defaultCase(theEObject);
                }
            ...
            case SysmlPackage.INDEX_EXPRESSION: {
                ...
                T result = this.caseIndexExpression(indexExpression);
                if (result == null) {
                    result = this.caseOperatorExpression(indexExpression);
                }
                if (result == null) {
                ...
                if (result == null) {
                    result = this.caseStep(indexExpression);
                }
                if (result == null) {
                    result = this.caseFeature(indexExpression);
                }
                if (result == null) {
                    result = this.caseType(indexExpression);
                }
                if (result == null) {
                    result = this.caseNamespace(indexExpression);
                }
                if (result == null) {
                    result = this.caseElement(indexExpression);
                }
                if (result == null) {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Cross Subsetting</em>'. <!-- begin-user-doc
     * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
     * -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Cross Subsetting</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseCrossSubsetting(CrossSubsetting object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Index Expression</em>'. <!-- begin-user-doc
     * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
     * -->
     *
     * @param object
