...
public class MetadataUsageImpl extends ItemUsageImpl implements MetadataUsage {
    ...
    public boolean isSemantic() {
        ...
        if (definition != null) {
            ImmutableLibraryNamespaceProvider provider = ImmutableLibraryNamespaceProvider.getFrom(this);
            if (provider != null) {
                Type semanticMetadata = provider.getNamespaceFromStandardLibrary("Metaobjects::SemanticMetadata", Type.class);
