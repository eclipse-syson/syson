...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Constraint Usage</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface ConstraintUsage extends OccurrenceUsage, BooleanExpression {
    /**
     * Returns the value of the '<em><b>Constraint Definition</b></em>' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
