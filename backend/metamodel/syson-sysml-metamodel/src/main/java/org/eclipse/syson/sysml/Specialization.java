...
public interface Specialization extends Relationship {
     ...
     * It is bidirectional and its opposite is '{@link org.eclipse.syson.sysml.Type#getOwnedSpecialization <em>Owned Specialization</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model opposite="ownedSpecialization" transient="true" changeable="false" volatile="true" derived="true" ordered="false"
     * @generated
     */
    Type getOwningType();
