...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Succession Item Flow</b></em>'. <!--
 * end-user-doc -->
 * <p>
        ...
        if (baseClass == Succession.class) {
            switch (baseFeatureID) {
                case SysmlPackage.SUCCESSION__EFFECT_STEP:
                    return SysmlPackage.SUCCESSION_ITEM_FLOW__EFFECT_STEP;
                case SysmlPackage.SUCCESSION__GUARD_EXPRESSION:
                    return SysmlPackage.SUCCESSION_ITEM_FLOW__GUARD_EXPRESSION;
                case SysmlPackage.SUCCESSION__TRANSITION_STEP:
                    return SysmlPackage.SUCCESSION_ITEM_FLOW__TRANSITION_STEP;
                case SysmlPackage.SUCCESSION__TRIGGER_STEP:
                    return SysmlPackage.SUCCESSION_ITEM_FLOW__TRIGGER_STEP;
                default:
                    return -1;
            }
        }
