...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Verification Case Definition</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.impl.VerificationCaseDefinitionImpl#getVerifiedRequirement <em>Verified
 * Requirement</em>}</li>
 * </ul>
 *
 * @generated
...
public class VerificationCaseDefinitionImpl extends CaseDefinitionImpl implements VerificationCaseDefinition {
    ...
    public EList<RequirementUsage> getVerifiedRequirement() {
        ...
        return new EcoreEList.UnmodifiableEList<>(this, SysmlPackage.eINSTANCE.getVerificationCaseDefinition_VerifiedRequirement(), data.size(), data.toArray());
    }
