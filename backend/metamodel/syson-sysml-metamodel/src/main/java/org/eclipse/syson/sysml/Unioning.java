...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Unioning</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface Unioning extends Relationship {
    /**
     * Returns the value of the '<em><b>Type Unioned</b></em>' reference. It is bidirectional and its opposite is
     * '{@link org.eclipse.syson.sysml.Type#getOwnedUnioning <em>Owned Unioning</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Unioning Type</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Unioning#getUnioningType <em>Unioning Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Unioning Type</em>' reference.
     * @see #getUnioningType()
     * @generated
     */
