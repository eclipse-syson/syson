...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Conjugated Port Typing</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysml.ConjugatedPortTyping#getConjugatedPortDefinition <em>Conjugated Port
 * Definition</em>}</li>
...
public interface ConjugatedPortTyping extends FeatureTyping {
    /**
     * Returns the value of the '<em><b>Conjugated Port Definition</b></em>' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.ConjugatedPortTyping#getConjugatedPortDefinition
     * <em>Conjugated Port Definition</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Conjugated Port Definition</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Port Definition</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
