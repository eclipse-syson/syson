...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>State Usage</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface StateUsage extends ActionUsage {
    ...
    /**
     * Returns the value of the '<em><b>State Definition</b></em>' reference list. The list contents are of type
