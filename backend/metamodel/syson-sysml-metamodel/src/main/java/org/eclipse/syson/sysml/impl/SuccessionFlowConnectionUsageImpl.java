...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Succession Flow Connection Usage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.syson.sysml.impl.SuccessionFlowConnectionUsageImpl#getGuardExpression <em>Guard
 * Expression</em>}</li>
 * <li>{@link org.eclipse.syson.sysml.impl.SuccessionFlowConnectionUsageImpl#getTransitionStep <em>Transition
 * Step</em>}</li>
        ...
        if (baseClass == Succession.class) {
            switch (baseFeatureID) {
                case SysmlPackage.SUCCESSION__EFFECT_STEP:
                    return SysmlPackage.SUCCESSION_FLOW_CONNECTION_USAGE__EFFECT_STEP;
                case SysmlPackage.SUCCESSION__GUARD_EXPRESSION:
                    return SysmlPackage.SUCCESSION_FLOW_CONNECTION_USAGE__GUARD_EXPRESSION;
                case SysmlPackage.SUCCESSION__TRANSITION_STEP:
                    return SysmlPackage.SUCCESSION_FLOW_CONNECTION_USAGE__TRANSITION_STEP;
                case SysmlPackage.SUCCESSION__TRIGGER_STEP:
                    return SysmlPackage.SUCCESSION_FLOW_CONNECTION_USAGE__TRIGGER_STEP;
                default:
                    return -1;
            }
        }
