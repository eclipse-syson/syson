...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Subsetting</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface Subsetting extends Specialization {
     ...
     * '{@link org.eclipse.syson.sysml.Feature#getOwnedSubsetting <em>Owned Subsetting</em>}'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @model opposite="ownedSubsetting" transient="true" changeable="false" volatile="true" derived="true"
    ...
    /**
     * Returns the value of the '<em><b>Subsetted Feature</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Subsetting#getSubsettedFeature <em>Subsetted Feature</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Subsetted Feature</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Subsetting Feature</b></em>' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.syson.sysml.Subsetting#getSubsettingFeature <em>Subsetting
     * Feature</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Subsetting Feature</em>' reference.
