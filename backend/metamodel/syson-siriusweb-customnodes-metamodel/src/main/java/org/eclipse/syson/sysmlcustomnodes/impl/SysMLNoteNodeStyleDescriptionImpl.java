...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sys ML Note Node Style Description</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getBorderRadius <em>Border
 * Radius</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getBorderLineStyle <em>Border
 * Line Style</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getChildrenLayoutStrategy
 * <em>Children Layout Strategy</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.syson.sysmlcustomnodes.impl.SysMLNoteNodeStyleDescriptionImpl#getBackground
 * <em>Background</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SysMLNoteNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements SysMLNoteNodeStyleDescription {
    /**
     ...
     * @generated
     */
    protected SysMLNoteNodeStyleDescriptionImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SysMLCustomnodesPackage.Literals.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION;
    }
        ...
        if (this.borderColor != null && this.borderColor.eIsProxy()) {
            ...
            if (this.borderColor != oldBorderColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
            }
        }
    ...
    public void setBorderColor(UserColor newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle, this.borderLineStyle));
    }
    ...
    public NotificationChain basicSetChildrenLayoutStrategy(LayoutStrategyDescription newChildrenLayoutStrategy, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY,
        ...
        if (newChildrenLayoutStrategy != this.childrenLayoutStrategy) {
            ...
            if (this.childrenLayoutStrategy != null)
                msgs = ((InternalEObject) this.childrenLayoutStrategy).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY,
                        null, msgs);
            if (newChildrenLayoutStrategy != null)
                msgs = ((InternalEObject) newChildrenLayoutStrategy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY,
                        null, msgs);
            msgs = this.basicSetChildrenLayoutStrategy(newChildrenLayoutStrategy, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, newChildrenLayoutStrategy,
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
    ...
    public UserColor getBackground() {
        if (this.background != null && this.background.eIsProxy()) {
            ...
            if (this.background != oldBackground) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground, this.background));
            }
        }
    ...
    public void setBackground(UserColor newBackground) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground, this.background));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_COLOR:
                if (resolve)
                    return this.getBorderColor();
                return this.basicGetBorderColor();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_RADIUS:
                return this.getBorderRadius();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_SIZE:
                return this.getBorderSize();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE:
                return this.getBorderLineStyle();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY:
                return this.getChildrenLayoutStrategy();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__DESCRIPTION:
                return this.getDescription();
            case SysMLCustomnodesPackage.SYS_ML_NOTE_NODE_STYLE_DESCRIPTION__BACKGROUND:
                if (resolve)
...
} // SysMLNoteNodeStyleDescriptionImpl
