...
public class IVAddNewBindingConnectorAsUsageFromPartUsageTests extends AbstractIntegrationTests {
    ...
    public void givenASysMLProjectWhenNewBindingConnectorAsUsageToolOfFirstLevelElementIsRequestedOnAPartUsageThenANewPartUsageAndABindingConnectorAsUsageEdgeAreCreated() {
        ...
        String creationToolId = diagramDescriptionIdProvider.getNodeToolId(this.descriptionNameGenerator.getNodeName(SysmlPackage.eINSTANCE.getPartUsage()), "New Binding Connector As Usage");
        assertThat(creationToolId).as("The tool 'New Binding Connector As Usage' should exist on a PartUsage").isNotNull();
    ...
    public void givenASysMLProjectWhenNewBindingConnectorAsUsageToolOfNestedElementIsRequestedOnAPartUsageThenANewPartUsageAndABindingConnectorAsUsageEdgeAreCreated() {
        ...
        String newBindingConnectorAsUsageId = diagramDescriptionIdProvider.getNodeToolId(this.descriptionNameGenerator.getNodeName(SysmlPackage.eINSTANCE.getPartUsage()),
                "New Binding Connector As Usage");
        assertThat(newBindingConnectorAsUsageId).as("The tool 'New Binding Connector As Usage' should exist on a nested PartUsage").isNotNull();
        ...
        Runnable newBindingConnector = () -> this.toolTester.invokeTool(InterconnectionViewWithTopNodesTestProjectData.EDITING_CONTEXT_ID, diagramAfterNestedPartUsageCreation.get().getId(),
                nestedPartNodeId.get(), newBindingConnectorAsUsageId, List.of());
