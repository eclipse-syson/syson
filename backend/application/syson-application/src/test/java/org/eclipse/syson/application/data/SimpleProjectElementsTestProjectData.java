...
/**
 * Identifiers for the "SimpleProject" project.
 *
 * @author Arthur Daussy
 */
public class SimpleProjectElementsTestProjectData {

    public static final String SCRIPT_PATH = "/scripts/database-content/SysMLv2-SimpleProject.sql";

    public static final String PROJECT_NAME = "SysMLv2-SimpleProject";
