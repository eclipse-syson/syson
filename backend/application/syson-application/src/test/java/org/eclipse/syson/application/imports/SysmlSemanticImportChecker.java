 ...
 */
public class SysmlSemanticImportChecker {
    ...
    public SysmlSemanticImportChecker(SysMLExternalResourceLoaderService sysmlLoader, IEditingDomainFactory editingDomainFactory, SysMLEditingContextProcessor sysMLEditingContextProcessor) {
        super();
    ...
    public SysmlSemanticImportChecker checkImportedModel(Consumer<Resource> checker) {
