...
public class GVActionFlowTests extends AbstractIntegrationTests {
    ...
    public void setUp() {
        ...
        this.semanticCheckerService = new SemanticCheckerService(this.semanticRunnableFactory, this.objectService, ActionFlowCompartmentIdentifiers.EDITING_CONTEXT_ID);
    }
    ...
    public void createSuccessionBetweenSubActions() {
        ...
        this.semanticCheckerService.checkElement(this.verifier, SuccessionAsUsage.class, () -> newSuccessionId[0], successionAsUsage -> {
            assertThat(this.objectService.getId(successionAsUsage.getSourceFeature())).isEqualTo(ActionFlowCompartmentIdentifiers.Semantic.SUB_ACTION1_ID);
            assertThat(successionAsUsage.getTargetFeature()).hasSize(1)
                    .allMatch(targetFeature -> ActionFlowCompartmentIdentifiers.Semantic.SUB_ACTION2_ID.equals(this.objectService.getId(targetFeature)));
