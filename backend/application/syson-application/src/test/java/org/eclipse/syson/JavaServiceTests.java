...
public class JavaServiceTests {
    ...
    public void setUp() {
        ...
        List<IRepresentationDescriptionProvider> representationDescriptionProviders = List.of(new GeneralViewDiagramDescriptionProvider());
        ...
        List<IJavaServiceProvider> javaServiceProviders = List.of(new GeneralViewJavaServiceProvider());
