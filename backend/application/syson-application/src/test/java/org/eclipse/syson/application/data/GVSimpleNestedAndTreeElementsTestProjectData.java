...
/**
 * Project data for the "GV-SimpleNestedAndTreeElements" project.
 *
 * @author arichard
 */
public class GVSimpleNestedAndTreeElementsTestProjectData {

    public static final String SCRIPT_PATH = "/scripts/database-content/GV-SimpleNestedAndTreeElements.sql";
    ...
    public static class GraphicalIds {
        ...
        public static final String PARTDEF_A_ID = "00dd8b62-2d00-345c-9f8d-f7cded420b33";

        public static final String PART_A_ID = "7a0c6bd7-d7ae-3c7f-ad9f-28edc92c5e28";
    ...
    public static final class SemanticIds {
        ...
        public static final String PARTDEF_A_ELEMENT_ID = "e9c43f33-f661-4791-bfee-228750340a96";

        public static final String PART_A_ELEMENT_ID = "0a4ab085-3bca-46c6-946c-b24a3b1589d8";
