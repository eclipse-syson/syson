...
public class GVEdgeCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> addAttributeUsageAsNestedOfSourceParameters() {
        return Stream.of(
    ...
    private static Stream<Arguments> makeAttributeUsageBecomingNestedOfTargetParameters() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("addAttributeUsageAsNestedOfSourceParameters")
    public void addAttributeUsageAsNestedOfSource(String sourceClickId, EClass parentClass, String parentLabel, int newNodeCount, ArrowStyle arrowStyle) {
        ...
        String targetClickId = GeneralViewWithTopNodesTestProjectData.GraphicalIds.ATTRIBUTE_USAGE_ID;
        ...
        Consumer<Object> diagramChecker = assertRefreshedDiagramThat(newDiagram -> {
            ...
            assertThat(newEdges)
                    .hasSize(1)
                    .first(EDGE)
                    .hasSourceId(sourceClickId)
                    .hasTargetId(targetClickId)
    ...
    @GivenSysONServer({ GeneralViewWithTopNodesTestProjectData.SCRIPT_PATH })
    @ParameterizedTest
    @MethodSource("makeAttributeUsageBecomingNestedOfTargetParameters")
    public void makeAttributeUsageBecomingNestedOfTarget(String targetClickId, String parentLabel, int newNodeCount, ArrowStyle arrowStyle) {
        SemanticCheckerService semanticCheckerService = new SemanticCheckerService(this.semanticRunnableFactory, this.objectSearchService, GeneralViewWithTopNodesTestProjectData.EDITING_CONTEXT_ID,
                GeneralViewWithTopNodesTestProjectData.SemanticIds.PACKAGE_1_ID);
        var flux = this.givenSubscriptionToDiagram(GeneralViewWithTopNodesTestProjectData.EDITING_CONTEXT_ID, GeneralViewWithTopNodesTestProjectData.GraphicalIds.DIAGRAM_ID);
        ...
        String sourceClickId = GeneralViewWithTopNodesTestProjectData.GraphicalIds.ATTRIBUTE_USAGE_ID;
        ...
        Consumer<Object> diagramChecker = assertRefreshedDiagramThat(newDiagram -> {
            ...
            assertThat(newEdges)
                    .hasSize(1)
                    .first(EDGE)
                    .hasSourceId(targetClickId)
                    .hasTargetId(sourceClickId)
                    .extracting(Edge::getStyle, EDGE_STYLE)
                    .hasSourceArrow(arrowStyle);
        });
