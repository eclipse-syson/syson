...
/**
 * Test configuration to not load KerML and SysML default libraries.
 *
 * @author arichard
 */
@Configuration
...
public class SysONNoDefaultLibrariesTestConfiguration extends SysONDefaultLibrariesConfiguration {

    public SysONNoDefaultLibrariesTestConfiguration(SysONLoadDefaultLibrariesOnApplicationStartConfiguration startConfiguration) {
