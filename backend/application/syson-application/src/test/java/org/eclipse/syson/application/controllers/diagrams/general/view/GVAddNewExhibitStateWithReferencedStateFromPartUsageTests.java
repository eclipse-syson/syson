...
/**
 * Tests the invocation of the "New Exhibit State with referenced State" tool from a Part Usage in the General View diagram.
 *
 * @author Jerome Gout
 */
@Transactional
...
public class GVAddNewExhibitStateWithReferencedStateFromPartUsageTests  extends AbstractIntegrationTests {
    ...
    @Test
    public void testApplyNewExhibitStateWithReferencedStateTool() {
        ...
        this.verifier.then(() -> this.nodeCreationTester.createNode(GeneralViewWithTopNodesTestProjectData.EDITING_CONTEXT_ID,
                ...
                "part",
                creationToolId,
                List.of(new ToolVariable("selectedObject", "15246f9c-231e-4569-8779-074b2fb6d2dc", ToolVariableType.OBJECT_ID))));
