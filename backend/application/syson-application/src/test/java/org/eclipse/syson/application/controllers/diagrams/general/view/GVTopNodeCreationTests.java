...
public class GVTopNodeCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> topNodeParameters() {
        return Stream.of(
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getAllocationDefinition(), 4, ViewConstants.DEFAULT_DEFINITION_NODE_HEIGHT, ViewConstants.DEFAULT_DEFINITION_NODE_WIDTH),
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getComment(), 0, ViewConstants.DEFAULT_NOTE_HEIGHT, ViewConstants.DEFAULT_NOTE_WIDTH),
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getConnectionDefinition(), 4, ViewConstants.DEFAULT_DEFINITION_NODE_HEIGHT, ViewConstants.DEFAULT_DEFINITION_NODE_WIDTH),
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getInterfaceDefinition(), 6, ViewConstants.DEFAULT_DEFINITION_NODE_HEIGHT, ViewConstants.DEFAULT_DEFINITION_NODE_WIDTH),
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getPartDefinition(), 11, ViewConstants.DEFAULT_DEFINITION_NODE_HEIGHT, ViewConstants.DEFAULT_DEFINITION_NODE_WIDTH),
