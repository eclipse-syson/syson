...
public class GVTopNodeCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> topNodeParameters() {
        return Stream.of(
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getReferenceUsage(), 0, 0, 0, 0, ViewConstants.DEFAULT_USAGE_NODE_HEIGHT, ViewConstants.DEFAULT_USAGE_NODE_WIDTH, true),
    ...
    // CHECKSTYLE:ON
        ...
        Runnable semanticCheck = this.semanticRunnableFactory.createQueryRunnable(GeneralViewEmptyTestProjectData.EDITING_CONTEXT_ID,
    ...
    public void givenAnEmptySysMLProjectWhenWeSubscribeToTheSelectionDialogTreeOfTheNamespaceImportToolThenTheTreeIsSent() {
        ...
        Runnable getSelectionDialogId = this.semanticRunnableFactory.createMutationRunnable(GeneralViewEmptyTestProjectData.EDITING_CONTEXT_ID,
                (editingContext, executeEditingContextFunctionInput) -> {
