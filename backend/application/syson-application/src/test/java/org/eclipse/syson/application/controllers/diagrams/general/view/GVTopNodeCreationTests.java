...
public class GVTopNodeCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> topNodeParameters() {
        return Stream.of(
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getAllocationDefinition(), 1),
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getRequirementDefinition(), 5),
                Arguments.of(SysmlPackage.eINSTANCE.getUseCaseUsage(), 2),
                Arguments.of(SysmlPackage.eINSTANCE.getUseCaseDefinition(), 2),
