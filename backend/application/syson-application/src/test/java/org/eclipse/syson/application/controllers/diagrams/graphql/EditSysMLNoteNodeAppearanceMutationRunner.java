...
/**
 *
 * Used to edit a SysMLNote node's appearance.
 *
 * @author arichard
 */
@Service
public class EditSysMLNoteNodeAppearanceMutationRunner implements IMutationRunner<IInput> {

    private static final String EDIT_SYSML_NOTE_NODE_APPEARANCE_MUTATION = """
    ...
    public EditSysMLNoteNodeAppearanceMutationRunner(IGraphQLRequestor graphQLRequestor) {
