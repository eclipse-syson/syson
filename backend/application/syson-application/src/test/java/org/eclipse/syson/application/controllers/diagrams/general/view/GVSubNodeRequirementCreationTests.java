...
public class GVSubNodeRequirementCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> constraintDefinitionSiblingNodeParameters() {
        return Stream.of(
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), SysmlPackage.eINSTANCE.getDefinition_OwnedUsage(), 13))
                .map(TestNameGenerator::namedArguments);
    }
    ...
    private static Stream<Arguments> partRequirementAndConcernChildNodeParameters() {
        return Stream.of(
                Arguments.of(SysmlPackage.eINSTANCE.getPartDefinition(), GeneralViewWithTopNodesTestProjectData.SemanticIds.PART_DEFINITION_ID, "PartDefinition", SysmlPackage.eINSTANCE.getRequirementUsage(), "requirements", 11, SysmlPackage.eINSTANCE.getDefinition_OwnedRequirement()),
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), GeneralViewWithTopNodesTestProjectData.SemanticIds.PART_USAGE_ID, "part", SysmlPackage.eINSTANCE.getRequirementUsage(), "requirements", 11, SysmlPackage.eINSTANCE.getUsage_NestedRequirement()),
                Arguments.of(SysmlPackage.eINSTANCE.getPartDefinition(), GeneralViewWithTopNodesTestProjectData.SemanticIds.PART_DEFINITION_ID, "PartDefinition", SysmlPackage.eINSTANCE.getConcernUsage(), "concerns", 10, SysmlPackage.eINSTANCE.getDefinition_OwnedConcern()),
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), GeneralViewWithTopNodesTestProjectData.SemanticIds.PART_USAGE_ID, "part", SysmlPackage.eINSTANCE.getConcernUsage(), "concerns", 10, SysmlPackage.eINSTANCE.getUsage_NestedConcern()))
                .map(TestNameGenerator::namedArguments);
    }
    ...
    public void createConcernUsageSiblingNodes(EClass childEClass, EReference containmentReference, int compartmentCount) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.CONCERN_USAGE_ID;
    ...
    public void createConcernDefinitionChildNodes(EClass childEClass, String compartmentName, EReference containmentReference, String creationToolNameParameter) {
        ...
        EClass parentEClass = SysmlPackage.eINSTANCE.getConcernDefinition();
        String parentLabel = GeneralViewWithTopNodesTestProjectData.SemanticIds.CONCERN_DEFINITION_ID;
        ...
        Consumer<Object> diagramCheck = assertRefreshedDiagramThat(newDiagram -> {
            ...
            String listStatesNodeDescription = this.descriptionNameGenerator.getCompartmentItemName(parentEClass, containmentReference);
            new CheckNodeInCompartment(diagramDescriptionIdProvider, this.diagramComparator)
                    .withTargetObjectId(parentLabel)
                    .withCompartmentName(compartmentName)
                    .hasNodeDescriptionName(listStatesNodeDescription)
                    .hasCompartmentCount(0)
                    .check(initialDiagram, newDiagram);
    ...
    public void createConstraintUsageSiblingNodes(EClass childEClass, EReference containmentReference, int compartmentCount) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.CONSTRAINT_USAGE_ID;
        Runnable createNodeRunnable = this.creationTestsService.createNode(diagramDescriptionIdProvider, diagram, parentEClass, targetObjectId, childEClass);
        Consumer<Object> diagramCheck = this.diagramCheckerService.siblingNodeGraphicalChecker(diagram, diagramDescriptionIdProvider, childEClass, compartmentCount);
        Runnable semanticCheck = this.semanticCheckerService.checkEditingContext(this.semanticCheckerService.getElementInParentSemanticChecker("constraint", containmentReference, childEClass));
    ...
    public void createConstraintDefinitionSiblingNodes(EClass childEClass, EReference containmentReference, int compartmentCount) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.CONSTRAINT_DEFINITION_ID;
        Runnable createNodeRunnable = this.creationTestsService.createNode(diagramDescriptionIdProvider, diagram, parentEClass, targetObjectId, childEClass);
        Consumer<Object> diagramCheck = this.diagramCheckerService.siblingNodeGraphicalChecker(diagram, diagramDescriptionIdProvider, childEClass, compartmentCount);
        Runnable semanticCheck = this.semanticCheckerService.checkEditingContext(this.semanticCheckerService.getElementInParentSemanticChecker("ConstraintDefinition", containmentReference, childEClass));
    ...
    public void createConstraintDefinitionChildNodes(EClass childEClass, String compartmentName, EReference containmentReference) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.CONSTRAINT_DEFINITION_ID;
        Runnable createNodeRunnable = this.creationTestsService.createNode(diagramDescriptionIdProvider, diagram, parentEClass, targetObjectId, childEClass);
        Consumer<Object> diagramCheck = this.diagramCheckerService.compartmentNodeGraphicalChecker(diagram, diagramDescriptionIdProvider, targetObjectId, parentEClass, containmentReference,
    ...
    @GivenSysONServer({ GeneralViewWithTopNodesTestProjectData.SCRIPT_PATH })
    @ParameterizedTest
    @MethodSource("partRequirementAndConcernChildNodeParameters")
    public void createPartRequirementAndConcernChildNodes(EClass parentEClass, String targetObjectId, String parentLabel, EClass childEClass, String compartmentName, int expectedNewNodeCount,
        ...
        Consumer<Object> diagramCheck = assertRefreshedDiagramThat(newDiagram -> {
            new CheckDiagramElementCount(this.diagramComparator)
                    .hasNewNodeCount(expectedNewNodeCount)
                    .hasNewEdgeCount(1)
                    .check(diagram.get(), newDiagram);
    ...
    public void createSatisfyRequirementUsageChildNodes(EClass childEClass, String compartmentName, EReference containmentReference) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.SATISFY_REQUIREMENT_USAGE_ID;
        Runnable createNodeRunnable = this.creationTestsService.createNode(diagramDescriptionIdProvider, diagram, parentEClass, targetObjectId, childEClass);
        Consumer<Object> diagramCheck = assertRefreshedDiagramThat(newDiagram -> {
            var initialDiagram = diagram.get();
            new CheckDiagramElementCount(this.diagramComparator)
        ...
        Runnable semanticCheck = this.semanticCheckerService.checkEditingContext(this.semanticCheckerService.getElementInParentSemanticChecker("satisfy requirement", containmentReference, childEClass));
    ...
    public void createRequirementDefinitionChildNodes(EClass childEClass, String compartmentName, EReference containmentReference) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.REQUIREMENT_DEFINITION_ID;
        Runnable createNodeRunnable = this.creationTestsService.createNode(diagramDescriptionIdProvider, diagram, parentEClass, targetObjectId, childEClass);
        Consumer<Object> diagramCheck = assertRefreshedDiagramThat(newDiagram -> {
            var initialDiagram = diagram.get();
            new CheckDiagramElementCount(this.diagramComparator)
        ...
        Runnable semanticCheck = this.semanticCheckerService.checkEditingContext(this.semanticCheckerService.getElementInParentSemanticChecker("RequirementDefinition", containmentReference, childEClass));
