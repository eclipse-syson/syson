...
/**
 * Custom condition used to detect that a test requires Elasticsearch.
 *
 * @author gdaniel
 */
public class OnElasticsearchEnabledTests extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        if (sysonTestEnabledFeatures.contains(SysONTestsProperties.ELASTICSEARCH)) {
            message = ConditionMessage.forCondition(this.getClass().getSimpleName()).available(SysONTestsProperties.ELASTICSEARCH_PROPERTY);
