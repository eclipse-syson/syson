...
public class ImportSysMLModelTest extends AbstractIntegrationTests {
    ...
    @Test
    @DisplayName("Given a PartUsage with a Multiplicity with chained FeatureReferenceExpression bounds, when importing the model, then the Multiplicity value is set")
