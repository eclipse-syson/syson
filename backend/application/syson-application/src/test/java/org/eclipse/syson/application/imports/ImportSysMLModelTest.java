...
public class ImportSysMLModelTest extends AbstractIntegrationTests {
    ...
    @Test
    @DisplayName("Given a model with dupplicated names, when importing the model, then the resolution of name shoud match the closest matching element")
    public void checkNameResolutionProcessWithDupplicatedName() throws IOException {
        var input = """
                package p1 {
                    part pa1 {
                        part pa11 :> pa1;
