...
public class ImportSysMLModelTest extends AbstractIntegrationTests {
    ...
    private SysmlSemanticImportChecker checker;

    @BeforeEach
    public void setUp() {
        this.checker = new SysmlSemanticImportChecker(this.sysmlLoader, this.editingDomainFactory, this.sysMLEditingContextProcessor);
    }
