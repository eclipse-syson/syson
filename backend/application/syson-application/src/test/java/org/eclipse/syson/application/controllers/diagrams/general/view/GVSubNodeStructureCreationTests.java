...
public class GVSubNodeStructureCreationTests extends AbstractIntegrationTests {
    ...
    private static Stream<Arguments> connectionDefinitionSiblingNodeParameters() {
        return Stream.of(
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), PARTS_COMPARTMENT, SysmlPackage.eINSTANCE.getDefinition_OwnedPart(), 13, 2))
                .map(TestNameGenerator::namedArguments);
    }
    ...
    private static Stream<Arguments> packageChildNodeParameters() {
        ...
        return Stream.of(
                ...
                Arguments.of(SysmlPackage.eINSTANCE.getPartDefinition(), ownedMember, 13, 0, 0),
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), ownedMember, 13, 0, 0),
    ...
    private static Stream<Arguments> partUsageSiblingAndChildNodeParameters() {
        return Stream.of(
                Arguments.of(SysmlPackage.eINSTANCE.getPartUsage(), "parts", SysmlPackage.eINSTANCE.getUsage_NestedPart(), 15, 1, ""),
