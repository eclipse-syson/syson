...
/**
 * Tests the creation of the "Extension" sub nodes section in the General View diagram.
 *
 * @author arichard
 */
@Transactional
...
public class GVSubNodeExtensionCreationTests extends AbstractIntegrationTests {
    ...
    public void createMetadataDefinitionSiblingNodes(EClass childEClass, EReference containmentReference, int compartmentCount) {
        ...
        String targetObjectId = GeneralViewWithTopNodesTestProjectData.SemanticIds.METADATA_DEFINITION_ID;
        ...
        Runnable semanticCheck = this.semanticCheckerService.checkEditingContext(this.semanticCheckerService.getElementInParentSemanticChecker("MetadataDefinition", containmentReference, childEClass));
    ...
    public void createMetadataDefinitionChildNodes(EClass childEClass, String compartmentName, EReference containmentReference, boolean withSelectionDialog) {
        var flux = this.givenSubscriptionToDiagram();
