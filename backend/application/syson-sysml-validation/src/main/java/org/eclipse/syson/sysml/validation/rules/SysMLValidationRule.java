...
/**
 * All the SysML v2 validation rules from the language specification.
 *
 * @author flatombe
 * @author arichard
 */
public enum SysMLValidationRule implements IValidationRule {
    checkAcceptActionUsageReceiverBindingConnector(
            SysmlPackage.eINSTANCE.getAcceptActionUsage(),
            "checkAcceptActionUsageReceiverBindingConnector",
            "aql:self.payloadArgument <> null and self.payloadArgument.oclIsKindOf(sysml::TriggerInvocationExpression) implies let invocation : sysml::Expression = self.payloadArgument.oclAsType(sysml::Expression) in self.parameter->size() >= 2 and invocation.parameter->size() >= 2 and self.ownedFeature->filter(sysml::BindingConnector)->exists(b | b.relatedFeatures->includes(parameter->at(2)) and b.relatedFeatures->includes(invocation.parameter->at(2)))",
    ...
    checkAcceptActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getAcceptActionUsage(),
            "checkAcceptActionUsageSpecialization",
            "aql:not self.isTriggerAction() implies self.specializesFromLibrary('Actions::acceptActions')",
    ...
    checkAcceptActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getAcceptActionUsage(),
            "checkAcceptActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() and not self.isTriggerAction() implies self.specializesFromLibrary('Actions::Action::acceptSubactions')",
    ...
    checkAcceptActionUsageTriggerActionSpecialization(
            SysmlPackage.eINSTANCE.getAcceptActionUsage(),
            "checkAcceptActionUsageTriggerActionSpecialization",
            "aql:self.isTriggerAction() implies self.specializesFromLibrary('Actions::TransitionAction::accepter')",
    ...
    checkActionDefinitionSpecialization(
            ...
            "checkActionDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Actions::Action')",
    ...
    checkActionUsageOwnedActionSpecialization(
            ...
            "checkActionUsageOwnedActionSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::PartDefinition) or self.owningType.oclIsKindOf(sysml::PartUsage)) implies self.specializesFromLibrary('Parts::Part::ownedActions')",
    ...
    checkActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getActionUsage(),
            "checkActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::actions')",
    ...
    checkActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getActionUsage(),
            "checkActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::subactions')",
    ...
    checkAllocationDefinitionSpecialization(
            ...
            "checkAllocationDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Allocations::Allocation')",
    ...
    checkAllocationUsageSpecialization(
            ...
            "checkAllocationUsageSpecialization",
            "aql:self.specializesFromLibrary('Allocations::allocations')",
    ...
    checkAnalysisCaseDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getAnalysisCaseDefinition(),
            "checkAnalysisCaseDefinitionSpecialization",
            "aql:self.specializesFromLibrary('AnalysisCases::AnalysisCase')",
    ...
    checkAnalysisCaseUsageSpecialization(
            SysmlPackage.eINSTANCE.getAnalysisCaseUsage(),
            "checkAnalysisCaseUsageSpecialization",
            "aql:self.specializesFromLibrary('AnalysisCases::analysisCases')",
    ...
    checkAnalysisCaseUsageSubAnalysisCaseSpecialization(
            SysmlPackage.eINSTANCE.getAnalysisCaseUsage(),
            "checkAnalysisCaseUsageSubAnalysisCaseSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::AnalysisCaseDefinition) or self.owningType.oclIsKindOf(sysml::AnalysisCaseUsage)) implies self.specializesFromLibrary('AnalysisCases::AnalysisCase::subAnalysisCases')",
            "A composite AnalysisCaseUsage whose owningType is an AnalysisCaseDefinition or AnalysisCaseUsage must specialize the AnalysisCaseUsage AnalysisCases::AnalysisCase::subAnalysisCases from the Systems Model Library."),
    checkAssertConstraintUsageSpecialization(
            SysmlPackage.eINSTANCE.getAssertConstraintUsage(),
            "checkAssertConstraintUsageSpecialization",
            "aql:if self.isNegated then self.specializesFromLibrary('Constraints::negatedConstraintChecks') else self.specializesFromLibrary('Constraints::assertedConstraintChecks') endif",
    ...
    checkAssignmentActionUsageAccessedFeatureRedefinition(
            ...
            "checkAssignmentActionUsageAccessedFeatureRedefinition",
            "aql:let targetParameter : sysml::Feature = self.inputParameter(1) in targetParameter <> null and targetParameter.ownedFeature->notEmpty() and targetParameter->first().ownedFeature->notEmpty() and targetParameter->first().ownedFeature->first().redefines('AssigmentAction::target::startingAt::accessedFeature')",
    ...
    checkAssignmentActionUsageReferentRedefinition(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "checkAssignmentActionUsageReferentRedefinition",
            "aql:let targetParameter : sysml::Feature = self.inputParameter(1) in targetParameter <> null and targetParameter.ownedFeature->notEmpty() and targetParameter->first().ownedFeature->notEmpty() and targetParameter->first().ownedFeature->first().redefines(referent)",
    ...
    checkAssignmentActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "checkAssignmentActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::assignmentActions')",
    ...
    checkAssignmentActionUsageStartingAtRedefinition(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "checkAssignmentActionUsageStartingAtRedefinition",
            "aql:let targetParameter : sysml::Feature = self.inputParameter(1) in targetParameter <> null and targetParameter.ownedFeature->notEmpty() and targetParameter.ownedFeature->first().redefines('AssignmentAction::target::startingAt')",
    ...
    checkAssignmentActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "checkAssignmentActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::assignments')",
    ...
    checkAssociationBinarySpecialization(
            SysmlPackage.eINSTANCE.getAssociation(),
            "checkAssociationBinarySpecialization",
            "aql:self.associationEnd->size() = 2 implies self.specializesFromLibrary('Links::BinaryLink')",
    ...
    checkAssociationSpecialization(
            SysmlPackage.eINSTANCE.getAssociation(),
            "checkAssociationSpecialization",
            "aql:self.specializesFromLibrary('Links::Link')",
    ...
    checkAssociationStructureBinarySpecialization(
            SysmlPackage.eINSTANCE.getAssociationStructure(),
            "checkAssociationStructureBinarySpecialization",
            "aql:self.endFeature->size() = 2 implies self.specializesFromLibrary('Objects::BinaryLinkObject')",
    ...
    checkAssociationStructureSpecialization(
            SysmlPackage.eINSTANCE.getAssociationStructure(),
            "checkAssociationStructureSpecialization",
            "aql:self.specializesFromLibrary('Objects::LinkObject')",
    ...
    checkAttributeUsageSpecialization(
            ...
            "checkAttributeUsageSpecialization",
            "aql:self.specializesFromLibrary('Base::dataValues')",
    ...
    checkBehaviorSpecialization(
            SysmlPackage.eINSTANCE.getBehavior(),
            "checkBehaviorSpecialization",
            "aql:self.specializesFromLibrary('Performances::Performance')",
    ...
    checkBindingConnectorSpecialization(
            SysmlPackage.eINSTANCE.getBindingConnector(),
            "checkBindingConnectorSpecialization",
            "aql:self.specializesFromLibrary('Links::selfLinks')",
    ...
    checkBooleanExpressionSpecialization(
            SysmlPackage.eINSTANCE.getBooleanExpression(),
            "checkBooleanExpressionSpecialization",
    ...
    checkCalculationDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getCalculationDefinition(),
            "checkCalculationDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Calculations::Calculation')",
    ...
    checkCalculationUsageSpecialization(
            SysmlPackage.eINSTANCE.getCalculationUsage(),
            "checkCalculationUsageSpecialization",
            "aql:self.specializesFromLibrary('Calculations::calculations')",
    ...
    checkCalculationUsageSubcalculationSpecialization(
            SysmlPackage.eINSTANCE.getCalculationUsage(),
            "checkCalculationUsageSubcalculationSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::CalculationDefinition) or self.owningType.oclIsKindOf(sysml::CalculationUsage)) implies self.specializesFromLibrary('Calculations::Calculation::subcalculations')",
            ""),
    checkCaseDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getCaseDefinition(),
            "checkCaseDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Cases::Case')",
    ...
    checkCaseUsageSpecialization(
            ...
            "checkCaseUsageSpecialization",
            "aql:self.specializesFromLibrary('Cases::cases')",
    ...
    checkCaseUsageSubcaseSpecialization(
            SysmlPackage.eINSTANCE.getCaseUsage(),
            "checkCaseUsageSubcaseSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::CaseDefinition) or self.owningType.oclIsKindOf(sysml::CaseUsage)) implies self.specializesFromLibrary('Cases::Case::subcases')",
    ...
    checkClassSpecialization(
            SysmlPackage.eINSTANCE.getClass_(),
            "checkClassSpecialization",
            "aql:self.specializesFromLibrary('Occurrences::Occurrence')",
    ...
    checkConcernDefinitionSpecialization(
            ...
            "checkConcernDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Requirements::ConcernCheck')",
    ...
    checkConcernUsageFramedConcernSpecialization(
            ...
            "checkConcernUsageFramedConcernSpecialization",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::FramedConcernMembership) implies self.specializesFromLibrary('Requirements::RequirementCheck::concerns')",
    ...
    checkConcernUsageSpecialization(
            SysmlPackage.eINSTANCE.getConcernUsage(),
            "checkConcernUsageSpecialization",
            "aql:self.specializesFromLibrary('Requirements::concernChecks')",
    ...
    checkConnectionDefinitionBinarySpecialization(
            ...
            "checkConnectionDefinitionBinarySpecialization",
            "aql:self.ownedEndFeature->size() = 2 implies self.specializesFromLibrary('Connections::BinaryConnections')",
    ...
    checkConnectionDefinitionSpecializations(
            SysmlPackage.eINSTANCE.getConnectionDefinition(),
            "checkConnectionDefinitionSpecializations",
            "aql:self.specializesFromLibrary('Connections::Connection')",
    ...
    checkConnectionUsageBinarySpecialization(
            SysmlPackage.eINSTANCE.getConnectionUsage(),
            "checkConnectionUsageBinarySpecialization",
            "aql:self.ownedEndFeature->size() = 2 implies self.specializesFromLibrary('Connections::binaryConnections')",
    ...
    checkConnectionUsageSpecialization(
            SysmlPackage.eINSTANCE.getConnectionUsage(),
            "checkConnectionUsageSpecialization",
            "aql:self.specializesFromLibrary('Connections::connections')",
    ...
    checkConnectorBinaryObjectSpecialization(
            SysmlPackage.eINSTANCE.getConnector(),
            "checkConnectorBinaryObjectSpecialization",
            "aql:self.connectorEnd->size() = 2 and self.association->exists(e | e.oclIsKindOf(sysml::AssociationStructure)) implies self.specializesFromLibrary('Objects::binaryLinkObjects')",
    ...
    checkConnectorBinarySpecialization(
            SysmlPackage.eINSTANCE.getConnector(),
            "checkConnectorBinarySpecialization",
            "aql:self.connectorEnd->size() = 2 implies self.specializesFromLibrary('Links::binaryLinks')",
    ...
    checkConnectorObjectSpecialization(
            SysmlPackage.eINSTANCE.getConnector(),
            "checkConnectorObjectSpecialization",
            "aql:self.association->exists(e | e.oclIsKindOf(sysml::AssociationStructure)) implies self.specializesFromLibrary('Objects::linkObjects')",
    ...
    checkConnectorSpecialization(
            SysmlPackage.eINSTANCE.getConnector(),
            "checkConnectorSpecialization",
            "aql:self.specializesFromLibrary('Links::links')",
    ...
    checkConnectorTypeFeaturing(
            SysmlPackage.eINSTANCE.getConnector(),
            "checkConnectorTypeFeaturing",
            "aql:self.relatedFeature->forAll(f | if self.featuringType->isEmpty() then f.isFeaturedWithin(null) else self.featuringType->forAll(t | f.isFeaturedWithin(t)) endif)",
    ...
    checkConstraintDefinitionSpecialization(
            ...
            "checkConstraintDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Constraints::ConstraintCheck')",
    ...
    checkConstraintUsageCheckedConstraintSpecialization(
            ...
            "checkConstraintUsageCheckedConstraintSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ItemDefinition) or self.owningType.oclIsKindOf(sysml::ItemUsage)) implies self.specializesFromLibrary('Items::Item::checkedConstraints')",
    ...
    checkConstraintUsageRequirementConstraintSpecialization(
            SysmlPackage.eINSTANCE.getConstraintUsage(),
            "checkConstraintUsageRequirementConstraintSpecialization",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::RequirementConstraintMembership) implies if self.owningFeatureMembership.oclAsType(sysml::RequirementConstraintMembership).kind = sysml::RequirementConstraintKind::assumption then self.specializesFromLibrary('Requirements::RequirementCheck::assumptions') else self.specializesFromLibrary('Requirements::RequirementCheck::constraints') endif",
    ...
    checkConstraintUsageSpecialization(
            SysmlPackage.eINSTANCE.getConstraintUsage(),
            "checkConstraintUsageSpecialization",
            "aql:self.specializesFromLibrary('Constraints::constraintChecks')",
    ...
    checkConstructorExpressionResultDefaultValueBindingConnector(
            SysmlPackage.eINSTANCE.getConstructorExpression(),
            "checkConstructorExpressionResultDefaultValueBindingConnector",
            "aql:self.TBD",
    ...
    checkConstructorExpressionResultFeatureRedefinition(
            SysmlPackage.eINSTANCE.getConstructorExpression(),
            "checkConstructorExpressionResultFeatureRedefinition",
            "aql:let features : OrderedSet(sysml::Feature) = self.instantiatedType.feature->select(owningMembership.visibility = sysml::VisibilityKind::public) in self.result.ownedFeature->forAll(f | f.ownedRedefinition.redefinedFeature->intersection(features)->size() = 1)",
    ...
    checkConstructorExpressionResultSpecialization(
            SysmlPackage.eINSTANCE.getConstructorExpression(),
            "checkConstructorExpressionResultSpecialization",
            "aql:self.result.specializes(instantiatedType)",
    ...
    checkConstructorExpressionSpecialization(
            SysmlPackage.eINSTANCE.getConstructorExpression(),
            "checkConstructorExpressionSpecialization",
            "aql:self.specializes('Performances::constructorEvaluations')",
    ...
    checkControlNodeSpecialization(
            SysmlPackage.eINSTANCE.getControlNode(),
            "checkControlNodeSpecialization",
            "aql:self.specializesFromLibrary('Action::Action::controls')",
    ...
    checkDataTypeSpecialization(
            SysmlPackage.eINSTANCE.getDataType(),
            "checkDataTypeSpecialization",
            "aql:self.specializesFromLibrary('Base::DataValue')",
    ...
    checkDecisionNodeOutgoingSuccessionSpecialization(
            SysmlPackage.eINSTANCE.getDecisionNode(),
            "checkDecisionNodeOutgoingSuccessionSpecialization",
            "aql:self.sourceConnector->filter(sysml::Succession)->forAll(subsetsChain(self, self.resolveGlobal('ControlPerformances::MergePerformance::outgoingHBLink')))",
    ...
    checkDecisionNodeSpecialization(
            SysmlPackage.eINSTANCE.getDecisionNode(),
            "checkDecisionNodeSpecialization",
            "aql:self.specializesFromLibrary('Actions::Action::decisions')",
    ...
    checkEventOccurrenceUsageSpecialization(
            SysmlPackage.eINSTANCE.getEventOccurrenceUsage(),
            "checkEventOccurrenceUsageSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::OccurrenceDefinition) or self.owningType.oclIsKindOf(sysml::OccurrenceUsage)) implies self.specializesFromLibrary('Occurrences::Occurrence::timeEnclosedOccurrences')",
    ...
    checkExhibitStateUsageSpecialization(
            ...
            "checkExhibitStateUsageSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::PartDefinition) or self.owningType.oclIsKindOf(sysml::PartUsage)) implies self.specializesFromLibrary('Parts::Part::exhibitedStates')",
    ...
    checkExpressionResultBindingConnector(
            SysmlPackage.eINSTANCE.getExpression(),
            "checkExpressionResultBindingConnector",
            "aql:self.ownedMembership->filter(sysml::ResultExpressionMembership)->forAll(mem | self.ownedFeature.oclIsKindOf(sysml::BindingConnector)->exists(binding | binding.relatedFeature->includes(self.result) and binding.relatedFeature->includes(mem.ownedResultExpression.result)))",
    ...
    checkExpressionSpecialization(
            SysmlPackage.eINSTANCE.getExpression(),
            "checkExpressionSpecialization",
            "aql:self.specializesFromLibrary('Performances::evaluations')",
    ...
    checkExpressionTypeFeaturing(
            SysmlPackage.eINSTANCE.getExpression(),
            "checkExpressionTypeFeaturing",
            "aql:self.owningMembership <> null and self.owningMembership.oclIsKindOf(sysml::FeatureValue) implies let featureWithValue : sysml::Feature = self.owningMembership.oclAsType(sysml::FeatureValue).featureWithValue in self.featuringType = featureWithValue.featuringType",
    ...
    checkFeatureChainExpressionResultSpecialization(
            SysmlPackage.eINSTANCE.getFeatureChainExpression(),
            "checkFeatureChainExpressionResultSpecialization",
            "aql:let inputParameters : Sequence(sysml::Feature) = self.ownedFeatures->select(direction = _'in') in let self.sourceTargetFeature : sysml::Feature = owningExpression.sourceTargetFeature() in self.sourceTargetFeature <> null and self.result.subsetsChain(inputParameters->first(), self.sourceTargetFeature) and self.result.owningType = self",
    ...
    checkFeatureChainExpressionSourceTargetRedefinition(
            SysmlPackage.eINSTANCE.getFeatureChainExpression(),
            "checkFeatureChainExpressionSourceTargetRedefinition",
            "aql:let sourceParameter : sysml::Feature = self.sourceTargetFeature() in self.sourceTargetFeature <> null and self.sourceTargetFeature.redefines(targetFeature)",
    ...
    checkFeatureChainExpressionTargetRedefinition(
            SysmlPackage.eINSTANCE.getFeatureChainExpression(),
            "checkFeatureChainExpressionTargetRedefinition",
            "aql:let sourceParameter : sysml::Feature = self.sourceTargetFeature() in self.sourceTargetFeature <> null and self.sourceTargetFeature.redefinesFromLibrary('ControlFunctions::\'.\'::source::target')",
    ...
    checkFeatureCrossingSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureCrossingSpecialization",
            "aql:self.ownedCrossFeature() <> null implies self.crossFeature = self.ownedCrossFeature()",
    ...
    checkFeatureDataValueSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureDataValueSpecialization",
            "aql:self.ownedTyping.type->exists(e | e.oclIsKindOf(sysml::DataType)) implies self.specializesFromLibrary('Base::dataValues')",
    ...
    checkFeatureEndRedefinition(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureEndRedefinition",
            "aql:self.isEnd and self.owningType <> null implies let i : Integer = self.owningType.ownedEndFeature->indexOf(self) in self.owningType.ownedSpecialization.general->forAll(supertype | supertype.endFeature->size() >= i implies self.redefines(supertype.endFeature->at(i)))",
    ...
    checkFeatureEndSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureEndSpecialization",
            "aql:self.isEnd and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Association) or self.owningType.oclIsKindOf(sysml::Connector)) implies self.specializesFromLibrary('Links::Link::participant')",
    ...
    checkFeatureFeatureMembershipTypeFeaturing(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureFeatureMembershipTypeFeaturing",
            "aql:self.owningFeatureMembership <> null implies self.featuringType->exists(t | self.isFeaturingType(t))",
    ...
    checkFeatureObjectSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureObjectSpecialization",
            "aql:self.ownedTyping.type->exists(e | e.oclIsKindOf(sysml::Structure)) implies self.specializesFromLibrary('Objects::objects')",
    ...
    checkFeatureOccurrenceSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureOccurrenceSpecialization",
            "aql:self.ownedTyping.type->exists(e | e.oclIsKindOf(sysml::Class)) implies self.specializesFromLibrary('Occurrences::occurrences')",
    ...
    checkFeatureOwnedCrossFeatureRedefinitionSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureOwnedCrossFeatureRedefinitionSpecialization",
            "aql:self.isOwnedCrossFeature() implies self.ownedSubsetting.subsettedFeature->includesAll( self.owner.oclAsType(sysml::Feature).ownedRedefinition.redefinedFeature->select(crossFeature <> null).crossFeature)",
    ...
    checkFeatureOwnedCrossFeatureSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureOwnedCrossFeatureSpecialization",
            "aql:self.isOwnedCrossFeature() implies self.owner.oclAsType(sysml::Feature).type->forAll(t | self.specializes(t))",
    ...
    checkFeatureParameterRedefinition(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureParameterRedefinition",
            "aql:self.owningType <> null and not self.owningFeatureMembership.oclIsKindOf(sysml::ReturnParameterMembership) and (self.owningType.oclIsKindOf(sysml::Behavior) or self.owningType.oclIsKindOf(sysml::Step) and (self.owningType.oclIsKindOf(sysml::InvocationExpression) implies not self.ownedRedefinition->exists(e | not e.isImplied)) implies let i : Integer = self.owningType.ownedFeature->select(f | f.direction <> null)->reject(i | i.owningFeatureMembership.oclIsKindOf(sysml::ReturnParameterMembership))->indexOf(self) in self.owningType.ownedSpecialization.general->forAll(supertype | let ownedParameters : Sequence(sysml::Feature) = supertype.ownedFeature->select(f | f.direction <> null)->reject(i | i.owningFeatureMembership.oclIsKindOf(sysml::ReturnParameterMembership)) in ownedParameters->size() >= i implies self.redefines(ownedParameters->at(i)))",
            "If a Feature is a parameter of an owningType that is a Behavior or Step, but not a result parameter or a parameter of an InvocationExpression, with at least one non-implied ownedRedefinition, then, for each direct supertype of its owningType that is also a Behavior or Step, it must redefine the parameter at the same position, if any."),
    checkFeaturePortionSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeaturePortionSpecialization",
            "aql:self.isPortion and self.ownedTyping.type->exists(i | i.oclIsKindOf(sysml::Class)) and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Class) or self.owningType.oclIsKindOf(sysml::Feature) and self.owningType.oclAsType(sysml::Feature).type->exists(e | e.oclIsKindOf(sysml::Class))) implies self.specializesFromLibrary('Occurrence::Occurrence::portions')",
    ...
    checkFeatureReferenceExpressionBindingConnector(
            SysmlPackage.eINSTANCE.getFeatureReferenceExpression(),
            "checkFeatureReferenceExpressionBindingConnector",
            "aql:self.ownedMember->filter(sysml::BindingConnector)->exists(b | b.relatedFeatures->includes(targetFeature) and b.relatedFeatures->includes(self.result))",
    ...
    checkFeatureReferenceExpressionResultSpecialization(
            SysmlPackage.eINSTANCE.getFeatureReferenceExpression(),
            "checkFeatureReferenceExpressionResultSpecialization",
            "aql:self.result.owningType = self and self.result.specializes(self.referent)",
    ...
    checkFeatureSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureSpecialization",
            "aql:self.specializesFromLibrary('Base::things')",
    ...
    checkFeatureSubobjectSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureSubobjectSpecialization",
            "aql:self.isComposite and self.ownedTyping.type->exists(i | i.oclIsKindOf(sysml::Structure)) and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Structure) or self.owningType.type->exists(i | i.oclIsKindOf(sysml::Structure))) implies self.specializesFromLibrary('Occurrence::Occurrence::suboccurrences')",
    ...
    checkFeatureValuationSpecialization(
            SysmlPackage.eINSTANCE.getFeature(),
            "checkFeatureValuationSpecialization",
            "aql:self.direction = null and self.ownedSpecialization->forAll(i | i.isImplied) implies self.ownedMembership->filter(sysml::FeatureValue)->forAll(fv | self.specializes(fv.value.result))",
    ...
    checkFlowDefinitionBinarySpecialization(
            SysmlPackage.eINSTANCE.getFlowDefinition(),
            "checkFlowDefinitionBinarySpecialization",
            "aql:self.flowEnd->size() = 2 implies self.specializesFromLibrary('Flows::Message')",
    ...
    checkFlowDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getFlowDefinition(),
            "checkFlowDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Flows::MessageAction')",
    ...
    checkFlowSpecialization(
            SysmlPackage.eINSTANCE.getFlow(),
            "checkFlowSpecialization",
            "aql:self.specializesFromLibrary('Transfers::transfers')",
    ...
    checkFlowUsageFlowSpecialization(
            ...
            "checkFlowUsageFlowSpecialization",
            "aql:self.ownedEndFeatures->notEmpty() implies self.specializesFromLibrary('Flows::flows')",
    ...
    checkFlowUsageSpecialization(
            SysmlPackage.eINSTANCE.getFlowUsage(),
            "checkFlowUsageSpecialization",
            "aql:self.specializesFromLibrary('Flows::messages')",
    ...
    checkFlowWithEndsSpecialization(
            SysmlPackage.eINSTANCE.getFlow(),
            "checkFlowWithEndsSpecialization",
            "aql:self.ownedEndFeatures->notEmpty() implies self.specializesFromLibrary('Transfers::flowTransfers')",
    ...
    checkForLoopActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getForLoopActionUsage(),
            "checkForLoopActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::forLoopActions')",
    ...
    checkForLoopActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getForLoopActionUsage(),
            "checkForLoopActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::forLoops')",
    ...
    checkForLoopActionUsageVarRedefinition(
            SysmlPackage.eINSTANCE.getForLoopActionUsage(),
            "checkForLoopActionUsageVarRedefinition",
            "aql:self.loopVariable <> null and self.loopVariable.redefinesFromLibrary('Actions::ForLoopAction::var')",
    ...
    checkForkNodeSpecialization(
            SysmlPackage.eINSTANCE.getForkNode(),
            "checkForkNodeSpecialization",
            "aql:self.specializesFromLibrary('Actions::Action::forks')",
    ...
    checkFunctionResultBindingConnector(
            SysmlPackage.eINSTANCE.getFunction(),
            "checkFunctionResultBindingConnector",
            "aql:self.ownedMembership->filter(sysml::ResultExpressionMembership)->forAll(mem | self.ownedFeature.oclIsKindOf(sysml::BindingConnector)->exists(binding | binding.relatedFeature->includes(self.result) and binding.relatedFeature->includes(mem.ownedResultExpression.result)))",
    ...
    checkFunctionSpecialization(
            SysmlPackage.eINSTANCE.getFunction(),
            "checkFunctionSpecialization",
            "aql:self.specializesFromLibrary('Performances::Evaluation')",
    ...
    checkIfActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getIfActionUsage(),
            "checkIfActionUsageSpecialization",
            "aql:if self.elseAction = null then self.specializesFromLibrary('Actions::ifThenActions') else self.specializesFromLibrary('Actions::ifThenElseActions') endif",
    ...
    checkIfActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getIfActionUsage(),
            "checkIfActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::ifSubactions')",
    ...
    checkIncludeUseCaseSpecialization(
            SysmlPackage.eINSTANCE.getIncludeUseCaseUsage(),
            "checkIncludeUseCaseSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::UseCaseDefinition) or self.owningType.oclIsKindOf(sysml::UseCaseUsage) implies self.specializesFromLibrary('UseCases::UseCase::includedUseCases')",
    ...
    checkIndexExpressionResultSpecialization(
            SysmlPackage.eINSTANCE.getIndexExpression(),
            "checkIndexExpressionResultSpecialization",
            "aql:self.arguments->notEmpty() and not self.arguments->first().result.specializesFromLibrary('Collections::Array') implies self.result.specializes(arguments->first().result)",
    ...
    checkInterfaceDefinitionBinarySpecialization(
            ...
            "checkInterfaceDefinitionBinarySpecialization",
            "aql:self.ownedEndFeature->size() = 2 implies self.specializesFromLibrary('Interfaces::BinaryInterface')",
    ...
    checkInterfaceDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getInterfaceDefinition(),
            "checkInterfaceDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Interfaces::Interface')",
    ...
    checkInterfaceUsageBinarySpecialization(
            ...
            "checkInterfaceUsageBinarySpecialization",
            "aql:self.ownedEndFeature->size() = 2 implies self.specializesFromLibrary('Interfaces::binaryInterfaces')",
    ...
    checkInterfaceUsageSpecialization(
            SysmlPackage.eINSTANCE.getInterfaceUsage(),
            "checkInterfaceUsageSpecialization",
            "aql:self.specializesFromLibrary('Interfaces::interfaces')",
    ...
    checkInvariantSpecialization(
            SysmlPackage.eINSTANCE.getInvariant(),
            "checkInvariantSpecialization",
            "aql:if self.isNegated then self.specializesFromLibrary('Performances::falseEvaluations') else self.specializesFromLibrary('Performances::trueEvaluations') endif",
    ...
    checkInvocationExpressionBehaviorBindingConnector(
            ...
            "checkInvocationExpressionBehaviorBindingConnector",
            "aql:not self.instantiatedType.oclIsKindOf(sysml::Function) and not (self.instantiatedType.oclIsKindOf(sysml::Feature) and self.instantiatedType.oclAsType(sysml::Feature).type->exists(e | e.oclIsKindOf(sysml::Function))) implies self.ownedFeature.oclIsKindOf(sysml::BindingConnector)->exists( relatedFeature->includes(self) and relatedFeature->includes(self.result))",
    ...
    checkInvocationExpressionBehaviorResultSpecialization(
            SysmlPackage.eINSTANCE.getInvocationExpression(),
            "checkInvocationExpressionBehaviorResultSpecialization",
            "aql:not self.instantiatedType.oclIsKindOf(sysml::Function) and not (self.instantiatedType.oclIsKindOf(sysml::Feature) and self.instantiatedType.oclAsType(sysml::Feature).type->exists(e | e.oclIsKindOf(sysml::Function))) implies self.result.specializes(instantiatedType)",
    ...
    checkInvocationExpressionSpecialization(
            SysmlPackage.eINSTANCE.getInvocationExpression(),
            "checkInvocationExpressionSpecialization",
            "aql:self.specializes(instantiatedType)",
    ...
    checkItemDefinitionSpecialization(
            ...
            "checkItemDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Items::Item')",
    ...
    checkItemUsageSpecialization(
            ...
            "checkItemUsageSpecialization",
            "aql:self.specializesFromLibrary('Items::items')",
    ...
    checkItemUsageSubitemSpecialization(
            SysmlPackage.eINSTANCE.getItemUsage(),
            "checkItemUsageSubitemSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ItemDefinition) or self.owningType.oclIsKindOf(sysml::ItemUsage)) implies self.specializesFromLibrary('Items::Item::subitem')",
            ""),
    checkJoinNodeSpecialization(
            SysmlPackage.eINSTANCE.getJoinNode(),
            "checkJoinNodeSpecialization",
            "aql:self.specializesFromLibrary('Actions::Action::join')",
    ...
    checkLiteralBooleanSpecialization(
            ...
            "checkLiteralBooleanSpecialization",
            "aql:self.specializesFromLibrary('Performances::literalBooleanEvaluations')",
    ...
    checkLiteralExpressionSpecialization(
            SysmlPackage.eINSTANCE.getLiteralExpression(),
            "checkLiteralExpressionSpecialization",
            "aql:self.specializesFromLibrary('Performances::literalEvaluations')",
    ...
    checkLiteralInfinitySpecialization(
            ...
            "checkLiteralInfinitySpecialization",
            "aql:self.specializesFromLibrary('Performances::literalIntegerEvaluations')",
    ...
    checkLiteralRationalSpecialization(
            ...
            "checkLiteralRationalSpecialization",
            "aql:self.specializesFromLibrary('Performances::literalRationalEvaluations')",
    ...
    checkLiteralStringSpecialization(
            ...
            "checkLiteralStringSpecialization",
            "aql:self.specializesFromLibrary('Performances::literalStringEvaluations')",
    ...
    checkMergeNodeIncomingSuccessionSpecialization(
            SysmlPackage.eINSTANCE.getMergeNode(),
            "checkMergeNodeIncomingSuccessionSpecialization",
            "aql:self.targetConnector->filter(sysml::Succession)->forAll(subsetsChain(self, self.resolveGlobal('ControlPerformances::MergePerformance::incomingHBLink')))",
    ...
    checkMergeNodeSpecialization(
            SysmlPackage.eINSTANCE.getMergeNode(),
            "checkMergeNodeSpecialization",
            "aql:self.specializesFromLibrary('Actions::Action::merges')",
    ...
    checkMetaclassSpecialization(
            SysmlPackage.eINSTANCE.getMetaclass(),
            "checkMetaclassSpecialization",
            "aql:self.specializesFromLibrary('Metaobjects::Metaobject')",
    ...
    checkMetadataAccessExpressionSpecialization(
            SysmlPackage.eINSTANCE.getMetadataAccessExpression(),
            "checkMetadataAccessExpressionSpecialization",
            "aql:self.specializesFromLibrary('Performances::metadataAccessEvaluations')",
    ...
    checkMetadataDefinitionSpecialization(
            ...
            "checkMetadataDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Metadata::MetadataItem')",
    ...
    checkMetadataFeatureSpecialization(
            SysmlPackage.eINSTANCE.getMetadataFeature(),
            "checkMetadataFeatureSpecialization",
            "aql:self.specializesFromLibrary('Metaobjects::metaobjects')",
    ...
    checkMetadataUsageSpecialization(
            SysmlPackage.eINSTANCE.getMetadataUsage(),
            "checkMetadataUsageSpecialization",
            "aql:self.specializesFromLibrary('Metadata::metadataItems')",
    ...
    checkMultiplicityRangeExpressionTypeFeaturing(
            SysmlPackage.eINSTANCE.getMultiplicityRange(),
            "checkMultiplicityRangeExpressionTypeFeaturing",
            "aql:self.bound->forAll(b | b.featuringType = self.featuringType)",
    ...
    checkMultiplicitySpecialization(
            SysmlPackage.eINSTANCE.getMultiplicity(),
            "checkMultiplicitySpecialization",
            "aql:self.specializesFromLibrary('Base::naturals')",
    ...
    checkMultiplicityTypeFeaturing(
            SysmlPackage.eINSTANCE.getMultiplicity(),
            "checkMultiplicityTypeFeaturing",
            "aql:if self.owningType <> null and self.owningType.oclIsKindOf(sysml::Feature) then self.featuringType = self.owningType.oclAsType(sysml::Feature).featuringType else self.featuringType->isEmpty() endif",
    ...
    checkNullExpressionSpecialization(
            SysmlPackage.eINSTANCE.getNullExpression(),
            "checkNullExpressionSpecialization",
            "aql:self.specializesFromLibrary('Performances::nullEvaluations')",
    ...
    checkOccurrenceDefinitionIndividualSpecialization(
            ...
            "checkOccurrenceDefinitionIndividualSpecialization",
            "aql:self.isIndividual implies self.specializesFromLibrary('Occurrences::Life')",
    ...
    checkOccurrenceDefinitionMultiplicitySpecialization(
            SysmlPackage.eINSTANCE.getOccurrenceDefinition(),
            "checkOccurrenceDefinitionMultiplicitySpecialization",
            "aql:self.isIndividual implies self.multiplicity <> null and self.multiplicity.specializesFromLibrary('Base::zeroOrOne')",
    ...
    checkOccurrenceUsageSnapshotSpecialization(
            ...
            "checkOccurrenceUsageSnapshotSpecialization",
            "aql:self.portionKind = sysml::PortionKind::snapshot implies self.specializesFromLibrary('Occurrences::Occurrence::snapshots')",
    ...
    checkOccurrenceUsageSpecialization(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "checkOccurrenceUsageSpecialization",
            "aql:self.specializesFromLibrary('Occurrences::occurrences')",
    ...
    checkOccurrenceUsageSuboccurrenceSpecialization(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "checkOccurrenceUsageSuboccurrenceSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Class) or self.owningType.oclIsKindOf(sysml::OccurrenceUsage) or self.owningType.oclIsKindOf(sysml::Feature) and self.owningType.oclAsType(sysml::Feature).type->exists(e | e.oclIsKindOf(sysml::Class))) implies self.specializesFromLibrary('Occurrences::Occurrence::suboccurrences')",
    ...
    checkOccurrenceUsageTimeSliceSpecialization(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "checkOccurrenceUsageTimeSliceSpecialization",
            "aql:self.portionKind = sysml::PortionKind::timeslice implies self.specializesFromLibrary('Occurrences::Occurrence::timeSlices')",
    ...
    checkPartDefinitionSpecialization(
            ...
            "checkPartDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Parts::Part')",
    ...
    checkPartUsageActorSpecialization(
            ...
            "checkPartUsageActorSpecialization",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::ActorMembership) implies if self.owningType.oclIsKindOf(sysml::RequirementDefinition) or self.owningType.oclIsKindOf(sysml::RequirementUsage) then self.specializesFromLibrary('Requirements::RequirementCheck::actors') else self.specializesFromLibrary('Cases::Case::actors') endif",
    ...
    checkPartUsageSpecialization(
            SysmlPackage.eINSTANCE.getPartUsage(),
            "checkPartUsageSpecialization",
            "aql:self.specializesFromLibrary('Parts::parts')",
    ...
    checkPartUsageStakeholderSpecialization(
            SysmlPackage.eINSTANCE.getPartUsage(),
            "checkPartUsageStakeholderSpecialization",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::StakeholderMembership) implies self.specializesFromLibrary('Requirements::RequirementCheck::stakeholders')",
    ...
    checkPartUsageSubpartSpecialization(
            SysmlPackage.eINSTANCE.getPartUsage(),
            "checkPartUsageSubpartSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ItemDefinition) or self.owningType.oclIsKindOf(sysml::ItemUsage)) implies self.specializesFromLibrary('Items::Item::subparts')",
    ...
    checkPayloadFeatureRedefinition(
            SysmlPackage.eINSTANCE.getPayloadFeature(),
            "checkPayloadFeatureRedefinition",
            "aql:self.redefinesFromLibrary('Transfers::Transfer::payload')",
    ...
    checkPerformActionUsageSpecialization(
            ...
            "checkPerformActionUsageSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::PartDefinition) or self.owningType.oclIsKindOf(sysml::PartUsage)) implies self.specializesFromLibrary('Parts::Part::performedActions')",
    ...
    checkPortDefinitionSpecialization(
            ...
            "checkPortDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Ports::Port')",
    ...
    checkPortUsageSpecialization(
            SysmlPackage.eINSTANCE.getPortUsage(),
            "checkPortUsageSpecialization",
            "aql:self.specializesFromLibrary('Ports::ports')",
    ...
    checkPortUsageSubportSpecialization(
            SysmlPackage.eINSTANCE.getPortUsage(),
            "checkPortUsageSubportSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::PortDefinition) or self.owningType.oclIsKindOf(sysml::PortUsage)) implies self.specializesFromLibrary('Ports::Port::subports')",
    ...
    checkPredicateSpecialization(
            SysmlPackage.eINSTANCE.getPredicate(),
            "checkPredicateSpecialization",
            "aql:self.specializesFromLibrary('Performances::BooleanEvaluation')",
    ...
    checkRenderingDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getRenderingDefinition(),
            "checkRenderingDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Views::Rendering')",
    ...
    checkRenderingUsageRedefinition(
            SysmlPackage.eINSTANCE.getRenderingUsage(),
            "checkRenderingUsageRedefinition",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::ViewRenderingMembership) implies self.redefinesFromLibrary('Views::View::viewRendering')",
    ...
    checkRenderingUsageSpecialization(
            SysmlPackage.eINSTANCE.getRenderingUsage(),
            "checkRenderingUsageSpecialization",
            "aql:self.specializesFromLibrary('Views::renderings')",
    ...
    checkRenderingUsageSubrenderingSpecialization(
            SysmlPackage.eINSTANCE.getRenderingUsage(),
            "checkRenderingUsageSubrenderingSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::RenderingDefinition) or self.owningType.oclIsKindOf(sysml::RenderingUsage)) implies self.specializesFromLibrary('Views::Rendering::subrenderings')",
    ...
    checkRequirementDefinitionSpecialization(
            ...
            "checkRequirementDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Requirements::RequirementCheck')",
    ...
    checkRequirementUsageObjectiveRedefinition(
            ...
            "checkRequirementUsageObjectiveRedefinition",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::ObjectiveMembership) implies self.owningType.ownedSpecialization.general->forAll(gen | (gen.oclIsKindOf(sysml::CaseDefinition) implies self.redefines(gen.oclAsType(sysml::CaseDefinition).objectiveRequirement)) and (gen.oclIsKindOf(sysml::CaseUsage) implies self.redefines(gen.oclAsType(sysml::CaseUsage).objectiveRequirement)))",
    ...
    checkRequirementUsageRequirementVerificationSpecialization(
            SysmlPackage.eINSTANCE.getRequirementUsage(),
            "checkRequirementUsageRequirementVerificationSpecialization",
            "aql:self.owningFeatureMembership <> null and self.owningFeatureMembership.oclIsKindOf(sysml::RequirementVerificationMembership) implies self.specializesFromLibrary('VerificationCases::VerificationCase::obj::requirementVerifications')",
    ...
    checkRequirementUsageSpecialization(
            SysmlPackage.eINSTANCE.getRequirementUsage(),
            "checkRequirementUsageSpecialization",
            "aql:self.specializesFromLibrary('Requirements::requirementChecks')",
    ...
    checkRequirementUsageSubrequirementSpecialization(
            SysmlPackage.eINSTANCE.getRequirementUsage(),
            "checkRequirementUsageSubrequirementSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::RequirementDefinition) or self.owningType.oclIsKindOf(sysml::RequirementUsage)) implies self.specializesFromLibrary('Requirements::RequirementCheck::subrequirements')",
    ...
    checkSatisfyRequirementUsageBindingConnector(
            ...
            "checkSatisfyRequirementUsageBindingConnector",
            "aql:self.ownedMember->filter(sysml::BindingConnector)->select(b | b.relatedElement->includes(subjectParameter) and b.relatedElement->exists(r | r <> self.subjectParameter))->size() = 1",
    ...
    checkSatisfyRequirementUsageSpecialization(
            SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(),
            "checkSatisfyRequirementUsageSpecialization",
            "aql:if self.isNegated then self.specializesFromLibrary('Requirements::notSatisfiedRequirementChecks') else self.specializesFromLibrary('Requirements::satisfiedRequirementChecks') endif",
    ...
    checkSelectExpressionResultSpecialization(
            SysmlPackage.eINSTANCE.getSelectExpression(),
            "checkSelectExpressionResultSpecialization",
            "aql:self.arguments->notEmpty() implies self.result.specializes(arguments->first().result)",
    ...
    checkSendActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getSendActionUsage(),
            "checkSendActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::sendActions')",
    ...
    checkSendActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getSendActionUsage(),
            "checkSendActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::acceptSubactions')",
    ...
    checkStateDefinitionSpecialization(
            ...
            "checkStateDefinitionSpecialization",
            "aql:self.specializesFromLibrary('States::StateAction')",
    ...
    checkStateUsageExclusiveStateSpecialization(
            ...
            "checkStateUsageExclusiveStateSpecialization",
            "aql:self.isSubstateUsage(false) implies self.specializesFromLibrary('States::StateAction::exclusiveStates')",
    ...
    checkStateUsageOwnedStateSpecialization(
            SysmlPackage.eINSTANCE.getStateUsage(),
            "checkStateUsageOwnedStateSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::PartDefinition) or self.owningType.oclIsKindOf(sysml::PartUsage)) implies self.specializesFromLibrary('Parts::Part::ownedStates')",
    ...
    checkStateUsageSpecialization(
            SysmlPackage.eINSTANCE.getStateUsage(),
            "checkStateUsageSpecialization",
            "aql:self.specializesFromLibrary('States::stateActions')",
    ...
    checkStateUsageSubstateSpecialization(
            SysmlPackage.eINSTANCE.getStateUsage(),
            "checkStateUsageSubstateSpecialization",
            "aql:self.isSubstateUsage(true) implies self.specializesFromLibrary('States::StateAction::substates')",
    ...
    checkStepEnclosedPerformanceSpecialization(
            SysmlPackage.eINSTANCE.getStep(),
            "checkStepEnclosedPerformanceSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Behavior) or self.owningType.oclIsKindOf(sysml::Step)) implies self.specializesFromLibrary('Performances::Performance::enclosedPerformance')",
            "AStep whose owningType is a Behavior or another Step must directly or indirectly specialize the Step Performances::Performance::enclosedPerformance."),
    checkStepOwnedPerformanceSpecialization(
            SysmlPackage.eINSTANCE.getStep(),
            "checkStepOwnedPerformanceSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Structure) or self.owningType.oclIsKindOf(sysml::Feature) and self.owningType.oclAsType(sysml::Feature).type->exists(e | e.oclIsKindOf(sysml::Structure)) implies self.specializesFromLibrary('Objects::Object::ownedPerformance')",
    ...
    checkStepSpecialization(
            SysmlPackage.eINSTANCE.getStep(),
            "checkStepSpecialization",
            "aql:self.specializesFromLibrary('Performances::performances')",
    ...
    checkStepSubperformanceSpecialization(
            SysmlPackage.eINSTANCE.getStep(),
            "checkStepSubperformanceSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::Behavior) or self.owningType.oclIsKindOf(sysml::Step)) and self.isComposite implies self.specializesFromLibrary('Performances::Performance::subperformance')",
            "AStep whose owningType is a Behavior or another Step, and which is composite, must directly or indirectly specialize the Step Performances::Performance::subperformance."),
    checkStructureSpecialization(
            SysmlPackage.eINSTANCE.getStructure(),
            "checkStructureSpecialization",
            "aql:self.specializesFromLibrary('Objects::Object')",
    ...
    checkSuccessionFlowSpecialization(
            SysmlPackage.eINSTANCE.getSuccessionFlow(),
            "checkSuccessionFlowSpecialization",
            "aql:self.specializesFromLibrary('Transfers::flowTransfersBefore')",
    ...
    checkSuccessionFlowUsageSpecialization(
            SysmlPackage.eINSTANCE.getSuccessionFlowUsage(),
            "checkSuccessionFlowUsageSpecialization",
            "aql:self.specializesFromLibrary('Flows::successionFlows')",
    ...
    checkSuccessionSpecialization(
            SysmlPackage.eINSTANCE.getSuccession(),
            "checkSuccessionSpecialization",
            "aql:self.specializesFromLibrary('Occurrences::happensBeforeLinks')",
    ...
    checkTerminateActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getTerminateActionUsage(),
            "checkTerminateActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::terminateActions')",
    ...
    checkTerminateActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getTerminateActionUsage(),
            "checkTerminateActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::terminateSubactions')",
            "A composite TerminateActionUsage that is a subaction must must directly or indirectly specialize the ActionUsage Actions::Action::terminateSubactions from the Systems Modeling Library."),
    checkTransitionUsageActionSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageActionSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ActionDefinition) or self.owningType.oclIsKindOf(sysml::ActionUsage)) and self.source <> null and not self.source.oclIsKindOf(sysml::StateUsage) implies self.specializesFromLibrary('Actions::Action::decisionTransitions')",
    ...
    checkTransitionUsagePayloadSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsagePayloadSpecialization",
            "aql:self.triggerAction->notEmpty() implies let payloadParameter : sysml::Feature = self.inputParameter(2) in payloadParameter <> null and payloadParameter.subsetsChain(triggerAction->at(1), self.triggerPayloadParameter())",
    ...
    checkTransitionUsageSourceBindingConnector(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageSourceBindingConnector",
            "aql:self.ownedMember->filter(sysml::BindingConnector)->exists(b | b.relatedFeatures->includes(self.source) and b.relatedFeatures->includes(inputParameter(1)))",
    ...
    checkTransitionUsageSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::transitionActions')",
    ...
    checkTransitionUsageStateSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageStateSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::StateDefinition) or self.owningType.oclIsKindOf(sysml::StateUsage)) and self.source <> null and self.source.oclIsKindOf(sysml::StateUsage) implies self.specializesFromLibrary('States::StateAction::stateTransitions')",
    ...
    checkTransitionUsageSuccessionBindingConnector(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageSuccessionBindingConnector",
            "aql:self.ownedMember->filter(sysml::BindingConnector)->exists(b | b.relatedFeatures->includes(succession) and b.relatedFeatures->includes(resolveGlobal( 'TransitionPerformances::TransitionPerformance::transitionLink')))",
    ...
    checkTransitionUsageSuccessionSourceSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageSuccessionSourceSpecialization",
            "aql:self.succession.sourceFeature = self.source",
    ...
    checkTransitionUsageTransitionFeatureSpecialization(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "checkTransitionUsageTransitionFeatureSpecialization",
            "aql:self.triggerAction->forAll(specializesFromLibrary('Actions::TransitionAction::accepter') and self.guardExpression->forAll(specializesFromLibrary('Actions::TransitionAction::guard') and self.effectAction->forAll(specializesFromLibrary('Actions::TransitionAction::effect'))",
    ...
    checkTypeSpecialization(
            SysmlPackage.eINSTANCE.getType(),
            "checkTypeSpecialization",
            "aql:self.specializesFromLibrary('Base::Anything')",
    ...
    checkUseCaseDefinitionSpecialization(
            ...
            "checkUseCaseDefinitionSpecialization",
            "aql:self.specializesFromLibrary('UseCases::UseCase')",
    ...
    checkUseCaseUsageSpecialization(
            ...
            "checkUseCaseUsageSpecialization",
            "aql:self.specializesFromLibrary('UseCases::useCases')",
    ...
    checkUseCaseUsageSubUseCaseSpecialization(
            SysmlPackage.eINSTANCE.getUseCaseUsage(),
            "checkUseCaseUsageSubUseCaseSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::UseCaseDefinition) or self.owningType.oclIsKindOf(sysml::UseCaseUsage)) implies self.specializesFromLibrary('UseCases::UseCase::subUseCases')",
    ...
    checkVerificationCaseSpecialization(
            SysmlPackage.eINSTANCE.getVerificationCaseDefinition(),
            "checkVerificationCaseSpecialization",
            "aql:self.specializesFromLibrary('VerificationCases::VerificationCase')",
    ...
    checkVerificationCaseUsageSpecialization(
            SysmlPackage.eINSTANCE.getVerificationCaseUsage(),
            "checkVerificationCaseUsageSpecialization",
            "aql:self.specializesFromLibrary('VerificationCases::verificationCases')",
    ...
    checkVerificationCaseUsageSubVerificationCaseSpecialization(
            SysmlPackage.eINSTANCE.getVerificationCaseUsage(),
            "checkVerificationCaseUsageSubVerificationCaseSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::VerificationCaseDefinition) or self.owningType.oclIsKindOf(sysml::VerificationCaseUsage)) implies self.specializesFromLibrary('VerificationCases::VerificationCase::subVerificationCases')",
            "If it is composite and owned by a VerificationCaseDefinition or VerificationCaseUsage, then it must specialize VerificationCaseUsage VerificationCases::VerificationCase::subVerificationCases."),
    checkViewDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getViewDefinition(),
            "checkViewDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Views::View')",
    ...
    checkViewUsageSpecialization(
            ...
            "checkViewUsageSpecialization",
            "aql:self.specializesFromLibrary('Views::views')",
    ...
    checkViewUsageSubviewSpecialization(
            SysmlPackage.eINSTANCE.getViewUsage(),
            "checkViewUsageSubviewSpecialization",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ViewDefinition) or self.owningType.oclIsKindOf(sysml::ViewUsage)) implies self.specializesFromLibrary('Views::View::subviews')",
    ...
    checkViewpointDefinitionSpecialization(
            SysmlPackage.eINSTANCE.getViewpointDefinition(),
            "checkViewpointDefinitionSpecialization",
            "aql:self.specializesFromLibrary('Views::Viewpoint')",
    ...
    checkViewpointUsageSpecialization(
            SysmlPackage.eINSTANCE.getViewpointUsage(),
            "checkViewpointUsageSpecialization",
            "aql:self.specializesFromLibrary('Views::viewpoints')",
    ...
    checkViewpointUsageViewpointSatisfactionSpecialization(
            SysmlPackage.eINSTANCE.getViewpointUsage(),
            "checkViewpointUsageViewpointSatisfactionSpecialization",
            "aql:self.isComposite and self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ViewDefinition) or self.owningType.oclIsKindOf(sysml::ViewUsage)) implies self.specializesFromLibrary('Views::View::viewpointSatisfactions')",
    ...
    checkWhileLoopActionUsageSpecialization(
            SysmlPackage.eINSTANCE.getWhileLoopActionUsage(),
            "checkWhileLoopActionUsageSpecialization",
            "aql:self.specializesFromLibrary('Actions::whileLoopActions')",
    ...
    checkWhileLoopActionUsageSubactionSpecialization(
            SysmlPackage.eINSTANCE.getWhileLoopActionUsage(),
            "checkWhileLoopActionUsageSubactionSpecialization",
            "aql:self.isSubactionUsage() implies self.specializesFromLibrary('Actions::Action::whileLoops')",
    ...
    validateAcceptActionUsageParameters(
            SysmlPackage.eINSTANCE.getAcceptActionUsage(),
            "validateAcceptActionUsageParameters",
            "aql:self.inputParameters()->size() >= 2",
    ...
    validateActorMembershipOwningType(
            SysmlPackage.eINSTANCE.getActorMembership(),
            "validateActorMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::RequirementUsage) or self.owningType.oclIsKindOf(sysml::RequirementDefinition) or self.owningType.oclIsKindOf(sysml::CaseDefinition) or self.owningType.oclIsKindOf(sysml::CaseUsage)",
    ...
    validateAnnotationAnnotatedElementOwnership(
            SysmlPackage.eINSTANCE.getAnnotation(),
            "validateAnnotationAnnotatedElementOwnership",
            "aql:(self.owningAnnotatedElement <> null) = (self.ownedAnnotatingElement <> null)",
    ...
    validateAnnotationAnnotatingElement(
            SysmlPackage.eINSTANCE.getAnnotation(),
            "validateAnnotationAnnotatingElement",
            "aql:self.ownedAnnotatingElement <> null xor self.owningAnnotatingElement <> null",
    ...
    validateAssertConstraintUsageReference(
            SysmlPackage.eINSTANCE.getAssertConstraintUsage(),
            "validateAssertConstraintUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::ConstraintUsage)",
    ...
    validateAssignmentActionUsage(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "validateAssignmentActionUsage",
            "aql:self.referent <> null implies self.referent.featureTarget.mayTimeVary",
    ...
    validateAssignmentActionUsageReferent(
            SysmlPackage.eINSTANCE.getAssignmentActionUsage(),
            "validateAssignmentActionUsageReferent",
            "aql:self.ownedMembership->exists(e | not e.oclIsKindOf(sysml::OwningMembership) and self.memberElement.oclIsKindOf(sysml::Feature))",
    ...
    validateAssociationBinarySpecialization(
            SysmlPackage.eINSTANCE.getAssociation(),
            "validateAssociationBinarySpecialization",
            "aql:self.associationEnd->size() > 2 implies not self.specializesFromLibrary('Links::BinaryLink')",
    ...
    validateAssociationEndTypes(
            SysmlPackage.eINSTANCE.getAssociation(),
            "validateAssociationEndTypes",
            "aql:self.ownedEndFeature->forAll(x | x.type->size() = 1)",
            "The ownedEndFeatures of an Association must have exactly one type."),
    validateAssociationRelatedTypes(
            SysmlPackage.eINSTANCE.getAssociation(),
            "validateAssociationRelatedTypes",
            "aql:not self.isAbstract implies self.relatedType->size() >= 2",
    ...
    validateAssociationStructureIntersection(
            SysmlPackage.eINSTANCE.getAssociation(),
            "validateAssociationStructureIntersection",
            "aql:self.oclIsKindOf(sysml::Structure) = self.oclIsKindOf(sysml::AssociationStructure)",
    ...
    validateAttributeDefinitionFeatures(
            ...
            "validateAttributeDefinitionFeatures",
            "aql:self.feature->forAll(i | not i.isComposite)",
    ...
    validateCaseDefinitionOnlyOneSubject(
            SysmlPackage.eINSTANCE.getCaseDefinition(),
            "validateCaseDefinitionOnlyOneSubject",
            "aql:self.featureMembership->filter(sysml::SubjectMembership)->size() <= 1",
    ...
    validateCaseDefinitionSubjectParameterPosition(
            SysmlPackage.eINSTANCE.getCaseDefinition(),
            "validateCaseDefinitionSubjectParameterPosition",
            "aql:self.input->notEmpty() and self.input->first() = self.subjectParameter",
    ...
    validateClassSpecialization(
            SysmlPackage.eINSTANCE.getClass_(),
            "validateClassSpecialization",
            "aql:self.ownedSpecialization.general->forAll(i | not i.oclIsKindOf(sysml::DataType)) and not i.oclIsKindOf(sysml::Association) implies self.ownedSpecialization.general->forAll(i | not i.oclIsKindOf(sysml::Association))",
    ...
    validateClassifierMultiplicityDomain(
            SysmlPackage.eINSTANCE.getClassifier(),
            "validateClassifierMultiplicityDomain",
            "aql:self.multiplicity <> null implies self.multiplicity.featuringType->isEmpty()",
    ...
    validateCollectExpressionOperator(
            SysmlPackage.eINSTANCE.getCollectExpression(),
            "validateCollectExpressionOperator",
            "aql:self.operator = 'collect'",
            "The operator of a CollectExpression must be 'collect'."),
    validateConjugatedPortDefinitionConjugatedPortDefinitionIsEmpty(
            SysmlPackage.eINSTANCE.getConjugatedPortDefinition(),
            "validateConjugatedPortDefinitionConjugatedPortDefinitionIsEmpty",
            "aql:self.conjugatedPortDefinition = null",
    ...
    validateConjugatedPortDefinitionOriginalPortDefinition(
            SysmlPackage.eINSTANCE.getConjugatedPortDefinition(),
            "validateConjugatedPortDefinitionOriginalPortDefinition",
            "aql:self.ownedPortConjugator.originalPortDefinition = self.originalPortDefinition",
    ...
    validateConnectionDefinitionIsSufficient(
            SysmlPackage.eINSTANCE.getConnectionDefinition(),
            "validateConnectionDefinitionIsSufficient",
            "aql:self.isSufficient",
            "A ConnectionDefinition must have isSufficient = true."),
    validateConnectorBinarySpecialization(
            SysmlPackage.eINSTANCE.getConnector(),
            "validateConnectorBinarySpecialization",
            "aql:self.connectorEnd->size() > 2 implies not self.specializesFromLibrary('Links::BinaryLink')",
    ...
    validateConnectorRelatedFeatures(
            SysmlPackage.eINSTANCE.getConnector(),
            "validateConnectorRelatedFeatures",
            "aql:not self.isAbstract implies self.relatedFeature->size() >= 2",
    ...
    validateConstructorExpressionOwnedFeatures(
            SysmlPackage.eINSTANCE.getConstructorExpression(),
            "validateConstructorExpressionOwnedFeatures",
            "aql:self.ownedFeatures->excluding(result)->isEmpty()",
            "A ConstructorExpression must not have any ownedFeatures other than its result."),
    validateControlNodeIncomingSuccessions(
            SysmlPackage.eINSTANCE.getControlNode(),
            "validateControlNodeIncomingSuccessions",
            "aql:self.targetConnector->filter(sysml::Succession)->collect(connectorEnd->at(2).multiplicity)->forAll(targetMult | self.multiplicityHasBounds(targetMult, 1, 1))",
            "All incoming Successions to a ControlNode must have a target multiplicity of 1..1."),
    validateControlNodeIsComposite(
            SysmlPackage.eINSTANCE.getControlNode(),
            "validateControlNodeIsComposite",
            "aql:self.isComposite",
            "A ControlNode must be composite."),
    validateControlNodeOutgoingSuccessions(
            SysmlPackage.eINSTANCE.getControlNode(),
            "validateControlNodeOutgoingSuccessions",
            "aql:self.sourceConnector->filter(sysml::Succession)->collect(connectorEnd->at(1).multiplicity)->forAll(sourceMult | self.multiplicityHasBounds(sourceMult, 1, 1))",
            "All outgoing Successions from a ControlNode must have a source multiplicity of 1..1."),
    validateControlNodeOwningType(
            SysmlPackage.eINSTANCE.getControlNode(),
            "validateControlNodeOwningType",
            "aql:self.owningType <> null and (self.owningType.oclIsKindOf(sysml::ActionDefinition) or self.owningType.oclIsKindOf(sysml::ActionUsage))",
            "The owningType of a ControlNode must be an ActionDefinition or ActionUsage."),
    validateCrossSubsettingCrossedFeature(
            SysmlPackage.eINSTANCE.getCrossSubsetting(),
            "validateCrossSubsettingCrossedFeature",
            "aql:self.crossingFeature.isEnd and self.crossingFeature.owningType <> null implies let endFeatures: Sequence(sysml::Feature) = self.crossingFeature.owningType.endFeature in let chainingFeatures: Sequence(sysml::Feature) = self.crossedFeature.chainingFeature in chainingFeatures->size() = 2 and endFeatures->size() = 2 implies chainingFeatures->at(1) = endFeatures->excluding(crossingFeature)->at(1)",
    ...
    validateCrossSubsettingCrossingFeature(
            SysmlPackage.eINSTANCE.getCrossSubsetting(),
            "validateCrossSubsettingCrossingFeature",
            "aql:self.crossingFeature.isEnd and self.crossingFeature.owningType<>null and self.crossingFeature.owningType.endFeature ->size() > 1",
    ...
    validateDataTypeSpecialization(
            SysmlPackage.eINSTANCE.getDataType(),
            "validateDataTypeSpecialization",
            "aql:self.ownedSpecialization.general->forAll(i | not i.oclIsKindOf(sysml::Class) and not i.oclIsKindOf(sysml::Association))",
            "A DataType must not specialize a Class or an Association."),
    validateDecisionNodeIncomingSuccessions(
            SysmlPackage.eINSTANCE.getDecisionNode(),
            "validateDecisionNodeIncomingSuccessions",
            "aql:self.targetConnector->filter(sysml::Succession)->size() <= 1",
            "A DecisionNode may have at most one incoming Succession."),
    validateDecisionNodeOutgoingSuccessions(
            SysmlPackage.eINSTANCE.getDecisionNode(),
            "validateDecisionNodeOutgoingSuccessions",
            "aql:self.sourceConnector->selectAsKind(Succession)->collect(connectorEnd->at(2))->forAll(targetMult | self.multiplicityHasBounds(targetMult, 0, 1))",
    ...
    validateDefinitionVariationIsAbstract(
            ...
            "validateDefinitionVariationIsAbstract",
            "aql:self.isVariation implies self.isAbstract",
            "If a Definition is a variation, then it must be abstract."),
    validateDefinitionVariationOwnedFeatureMembership(
            SysmlPackage.eINSTANCE.getDefinition(),
            "validateDefinitionVariationOwnedFeatureMembership",
            "aql:self.isVariation implies self.ownedFeatureMembership->isEmpty()",
    ...
    validateDefinitionVariationSpecialization(
            SysmlPackage.eINSTANCE.getDefinition(),
            "validateDefinitionVariationSpecialization",
            "aql:self.isVariation implies not self.ownedSpecialization.specific->exists(e | e.oclIsKindOf(sysml::Definition) and e.oclAsType(sysml::Definition).isVariation)",
    ...
    validateElementFilterMembershipConditionIsBoolean(
            SysmlPackage.eINSTANCE.getElementFilterMembership(),
            "validateElementFilterMembershipConditionIsBoolean",
            "aql:self.condition.result.specializesFromLibrary('ScalarValues::Boolean')",
    ...
    validateElementFilterMembershipConditionIsModelLevelEvaluable(
            SysmlPackage.eINSTANCE.getElementFilterMembership(),
            "validateElementFilterMembershipConditionIsModelLevelEvaluable",
            "aql:self.condition.isModelLevelEvaluable",
            "The condition Expression must be model-level evaluable."),
    validateElementIsImpliedIncluded(
            SysmlPackage.eINSTANCE.getElement(),
            "validateElementIsImpliedIncluded",
            "aql:self.ownedRelationship->exists(e | e.isImplied) implies self.isImpliedIncluded",
    ...
    validateEndFeatureMembershipIsEnd(
            SysmlPackage.eINSTANCE.getEndFeatureMembership(),
            "validateEndFeatureMembershipIsEnd",
            "aql:self.ownedMemberFeature.isEnd",
    ...
    validateEventOccurrenceUsageReference(
            SysmlPackage.eINSTANCE.getEventOccurrenceUsage(),
            "validateEventOccurrenceUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::OccurrenceUsage)",
    ...
    validateExhibitStateUsageReference(
            SysmlPackage.eINSTANCE.getExhibitStateUsage(),
            "validateExhibitStateUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::StateUsage)",
    ...
    validateFeatureChainExpressionConformance(
            SysmlPackage.eINSTANCE.getFeatureChainExpression(),
            "validateFeatureChainExpressionConformance",
            "aql:self.argument->notEmpty() implies self.targetFeature.isFeaturedWithin(argument->first().result)",
    ...
    validateFeatureChainingFeatureConformance(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureChainingFeatureConformance",
            "aql:self.interval(2, self.chainingFeature->size())->forAll(i | self.chainingFeature->at(i).isFeaturedWithin(chainingFeature->at(i-1)))",
    ...
    validateFeatureCrossFeatureType(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureCrossFeatureType",
            "aql:self.crossFeature <> null implies self.crossFeature.type->asSet() = self.type->asSet()",
            "The crossFeature of a Feature must have the same types as the Feature."),
    validateFeatureEndIsConstant(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureEndIsConstant",
            "aql:self.isEnd and self.isVariable implies self.isConstant",
            "A Feature with isEnd = true and isVariable = true must have isConstant = true."),
    validateFeatureEndMultiplicity(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureEndMultiplicity",
            "aql:self.isEnd implies self.multiplicities().allSuperTypes()->flatten()->filter(sysml::MultiplicityRange)->exists(mr | mr.hasBounds(1,1))",
            "If a Feature has isEnd = true, then it must have multiplicity 1..1."),
    validateFeatureEndNoDirection(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureEndNoDirection",
            "aql:self.isEnd implies self.direction = null",
            "A Feature with isEnd = true must have no direction."),
    validateFeatureEndNotDerivedAbstractCompositeOrPortion(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureEndNotDerivedAbstractCompositeOrPortion",
            "aql:self.isEnd implies not (self.isDerived or self.isAbstract or self.isComposite or self.isPortion)",
    ...
    validateFeatureIsVariable(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureIsVariable",
            "aql:self.isVariable implies self.owningType <> null and self.owningType.specializes('Occurrences::Occurrence')",
    ...
    validateFeatureMultiplicityDomain(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureMultiplicityDomain",
            "aql:self.multiplicity <> null implies self.multiplicity.featuringType = self.featuringType",
    ...
    validateFeatureOwnedCrossSubsetting(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureOwnedCrossSubsetting",
            "aql:self.ownedSubsetting->filter(sysml::CrossSubsetting)->size() <= 1",
            "A Feature must have at most one ownedSubsetting that is a CrossSubsetting."),
    validateFeatureOwnedReferenceSubsetting(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeatureOwnedReferenceSubsetting",
            "aql:self.ownedSubsetting->filter(sysml::ReferenceSubsetting)->size() <= 1",
            "A Feature must have at most one ownedSubsetting that is an ReferenceSubsetting."),
    validateFeaturePortionNotVariable(
            SysmlPackage.eINSTANCE.getFeature(),
            "validateFeaturePortionNotVariable",
            "aql:self.isPortion implies not self.isVariable",
            ""),
    validateFeatureReferenceExpressionReferentIsFeature(
            SysmlPackage.eINSTANCE.getFeatureReferenceExpression(),
            "validateFeatureReferenceExpressionReferentIsFeature",
            "aql:let membership : sysml::Membership = self.ownedMembership->reject(m | m.oclIsKindOf(sysml::ParameterMembership)) in self.membership->notEmpty() and self.membership->at(1).memberElement.oclIsKindOf(sysml::Feature)",
    ...
    validateFramedConcernMembershipConstraintKind(
            ...
            "validateFramedConcernMembershipConstraintKind",
            "aql:self.kind = sysml::RequirementConstraintKind::requirement",
    ...
    validateImportTopLevelVisibility(
            SysmlPackage.eINSTANCE.getImport(),
            "validateImportTopLevelVisibility",
            "aql:self.importOwningNamespace.owner = null implies self.visibility = sysml::VisibilityKind::private",
    ...
    validateIncludeUseCaseUsageReference(
            SysmlPackage.eINSTANCE.getIncludeUseCaseUsage(),
            "validateIncludeUseCaseUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::UseCaseUsage)",
    ...
    validateInstantiationExpressionInstantiatedType(
            SysmlPackage.eINSTANCE.getInstantiationExpression(),
            "validateInstantiationExpressionInstantiatedType",
            "aql:self.instantiatedType() <> null",
    ...
    validateInvocationExpressionInstantiatedType(
            SysmlPackage.eINSTANCE.getInvocationExpression(),
            "validateInvocationExpressionInstantiatedType",
            "aql:self.instantiatedType.oclIsKindOf(sysml::Behavior) or self.instantiatedType.oclIsKindOf(sysml::Feature) and self.instantiatedType.type->exists(e | e.oclIsKindOf(sysml::Behavior)) and self.instantiatedType.type->size(1)",
    ...
    validateInvocationExpressionNoDuplicateParameterRedefinition(
            SysmlPackage.eINSTANCE.getInvocationExpression(),
            "validateInvocationExpressionNoDuplicateParameterRedefinition",
            "aql:let features : OrderedSet(sysml::Feature) = self.instantiatedType.feature in self.input->forAll(inp1 | self.input->forAll(inp2 | inp1 <> inp2 implies inp1.ownedRedefinition.redefinedFeature->intersection(inp2.ownedRedefinition.redefinedFeature)->intersection(features)->isEmpty()))",
    ...
    validateInvocationExpressionParameterRedefinition(
            SysmlPackage.eINSTANCE.getInvocationExpression(),
            "validateInvocationExpressionParameterRedefinition",
            "aql:let parameters : OrderedSet(sysml::Feature) = self.instantiatedType.input in self.input->forAll(inp | inp.ownedRedefinition.redefinedFeature->intersection(parameters)->size() = 1)",
    ...
    validateJoinNodeOutgoingSuccessions(
            SysmlPackage.eINSTANCE.getJoinNode(),
            "validateJoinNodeOutgoingSuccessions",
            "aql:self.sourceConnector->filter(sysml::Succession)->size() <= 1",
            "A JoinNode may have at most one outgoing Succession."),
    validateMergeNodeIncomingSuccessions(
            SysmlPackage.eINSTANCE.getMergeNode(),
            "validateMergeNodeIncomingSuccessions",
            "aql:self.targetConnector->filter(sysml::Succession)->collect(connectorEnd->at(1))->forAll(sourceMult | self.multiplicityHasBounds(sourceMult, 0, 1))",
            "All incoming Successions to a MergeNode must have a source multiplicity of 0..1."),
    validateMergeNodeOutgoingSuccessions(
            SysmlPackage.eINSTANCE.getMergeNode(),
            "validateMergeNodeOutgoingSuccessions",
            "aql:self.sourceConnector->selectAsKind(Succession)->size() <= 1",
            "A MergeNode may have at most one outgoing Succession."),
    validateMetadataAccessExpressionReferencedElement(
            SysmlPackage.eINSTANCE.getMetadataAccessExpression(),
            "validateMetadataAccessExpressionReferencedElement",
            "aql:self.ownedMembership->exists(e | not e.oclIsKindOf(sysml::FeatureMembership))",
    ...
    validateMetadataFeatureBody(
            SysmlPackage.eINSTANCE.getMetadataFeature(),
            "validateMetadataFeatureBody",
            "aql:self.ownedFeature->closure(ownedFeature)->forAll(f | f.declaredName = null and f.declaredShortName = null and f.valuation <> null implies f.valuation.value.isModelLevelEvaluable and f.redefinition.redefinedFeature->size() = 1)",
    ...
    validateMetadataFeatureMetaclass(
            SysmlPackage.eINSTANCE.getMetadataFeature(),
            "validateMetadataFeatureMetaclass",
            "aql:self.type->filter(sysml::Metaclass)->size() = 1",
            "A MetadataFeature must have exactly one type that is a Metaclass."),
    validateMetadataFeatureMetaclassNotAbstract(
            SysmlPackage.eINSTANCE.getMetadataFeature(),
            "validateMetadataFeatureMetaclassNotAbstract",
            "aql:not self.metaclass.isAbstract",
            "The metaclass of a MetadataFeature must not be abstract."),
    validateMultiplicityRangeBoundResultTypes(
            SysmlPackage.eINSTANCE.getMultiplicityRange(),
            "validateMultiplicityRangeBoundResultTypes",
            "aql:self.bound->forAll(b | b.result <> null and b.result.specializesFromLibrary('ScalarValues::Integer') and let value : Integer = self.valueOf(b) in value <> null implies value >= 0 )",
    ...
    validateMultiplicityRangeBounds(
            SysmlPackage.eINSTANCE.getMultiplicityRange(),
            "validateMultiplicityRangeBounds",
            "aql:if self.lowerBound = null then self.ownedMember->notEmpty() and self.ownedMember->at(1) = self.upperBound else self.ownedMember->size() > 1 and self.ownedMember->at(1) = self.lowerBound and self.ownedMember->at(2) = self.upperBound endif",
    ...
    validateNamespaceDistinguishibility(
            SysmlPackage.eINSTANCE.getNamespace(),
            "validateNamespaceDistinguishibility",
            "aql:self.ownedMembership->forAll(m1 | self.ownedMembership->forAll(m2 | m1 <> m2 implies m1.isDistinguishableFrom(m2)))",
            "All memberships of a Namespace must be distinguishable from each other."),
    validateObjectiveMembershipIsComposite(
            SysmlPackage.eINSTANCE.getObjectiveMembership(),
            "validateObjectiveMembershipIsComposite",
            "aql:self.ownedObjectiveRequirement.isComposite",
            "The ownedObjectiveRequirement of an ObjectiveMembership must be composite."),
    validateObjectiveMembershipOwningType(
            SysmlPackage.eINSTANCE.getObjectiveMembership(),
            "validateObjectiveMembershipOwningType",
            "aql:self.owningType.ocIsTypeOf(sysml::CaseDefinition) or self.owningType.ocIsTypeOf(sysml::CaseUsage)",
    ...
    validateOccurrenceUsageIndividualDefinition(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "validateOccurrenceUsageIndividualDefinition",
            "aql:self.occurrenceDefinition->filter(sysml::OccurrenceDefinition)->select(e | e.isIndividual)->size() <= 1",
    ...
    validateOccurrenceUsageIndividualUsage(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "validateOccurrenceUsageIndividualUsage",
            "aql:self.isIndividual implies self.individualDefinition <> null",
            "If an OccurrenceUsage has isIndividual = true, then it must have an individualDefinition."),
    validateOccurrenceUsageIsPortion(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "validateOccurrenceUsageIsPortion",
            "aql:self.portionKind <> null implies self.isPortion",
            "If an OccurrenceUsage has a non-null portionKind, then it must have isPortion = true."),
    validateOccurrenceUsagePortionKind(
            SysmlPackage.eINSTANCE.getOccurrenceUsage(),
            "validateOccurrenceUsagePortionKind",
            "aql:self.portionKind <> null implies self.owningType <> null and (self.owningType.oclIsKindOf(sysml::OccurrenceDefinition) or self.owningType.oclIsKindOf(sysml::OccurrenceUsage))",
    ...
    validateParameterMembershipOwningType(
            SysmlPackage.eINSTANCE.getParameterMembership(),
            "validateParameterMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::Behavior) or self.owningType.oclIsKindOf(sysml::Step) or self.owningType.owningMembership.oclIsKindOf(sysml::ReturnParameterMembership) and self.owningType.owningNamespace.oclIsKindOf(sysml::ConstructorExpression)",
    ...
    validateParameterMembershipParameterDirection(
            SysmlPackage.eINSTANCE.getParameterMembership(),
            "validateParameterMembershipParameterDirection",
            "aql:self.ownedMemberParameter.direction = self.parameterDirection()",
    ...
    validatePartUsagePartDefinition(
            SysmlPackage.eINSTANCE.getPartUsage(),
            "validatePartUsagePartDefinition",
            "aql:self.partDefinition->notEmpty()",
            "At least one of the itemDefinitions of a PartUsage must be a PartDefinition."),
    validatePerformActionUsageReference(
            SysmlPackage.eINSTANCE.getPerformActionUsage(),
            "validatePerformActionUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::ActionUsage)",
    ...
    validatePortDefinitionConjugatedPortDefinition(
            SysmlPackage.eINSTANCE.getPortDefinition(),
            "validatePortDefinitionConjugatedPortDefinition",
            "aql:not self.oclIsKindOf(sysml::ConjugatedPortDefinition) implies self.ownedMember->filter(sysml::ConjugatedPortDefinition)->size() = 1",
    ...
    validatePortDefinitionOwnedUsagesNotComposite(
            SysmlPackage.eINSTANCE.getPortDefinition(),
            "validatePortDefinitionOwnedUsagesNotComposite",
            "aql:self.ownedUsage->reject(i | i.oclIsKindOf(sysml::PortUsage))->forAll(i | not i.isComposite)",
            "The ownedUsages of a PortDefinition that are not PortUsages must not be composite."),
    validatePortUsageIsReference(
            SysmlPackage.eINSTANCE.getPortUsage(),
            "validatePortUsageIsReference",
            "aql:self.owningType = null or not self.owningType.oclIsKindOf(sysml::PortDefinition) and not self.owningType.oclIsKindOf(sysml::PortUsage) implies self.isReference",
    ...
    validatePortUsageNestedUsagesNotComposite(
            SysmlPackage.eINSTANCE.getPortUsage(),
            "validatePortUsageNestedUsagesNotComposite",
            "aql:self.nestedUsage->reject(i | i.oclIsKindOf(sysml::PortUsage))->forAll(i | not i.isComposite)",
    ...
    validateRedefinitionEndConformance(
            SysmlPackage.eINSTANCE.getRedefinition(),
            "validateRedefinitionEndConformance",
            "aql:self.redefinedFeature.isEnd implies self.redefiningFeature.isEnd",
    ...
    validateRedefinitionFeaturingTypes(
            SysmlPackage.eINSTANCE.getRedefinition(),
            "validateRedefinitionFeaturingTypes",
            "aql:let anythingType: sysml::Type = self.redefiningFeature.resolveGlobal('Base::Anything').modelElement.oclAsType(sysml::Type) in let redefiningFeaturingTypes: OrderedSet(sysml::Type) = if self.redefiningFeature.isVariable then OrderedSet{redefiningFeature.owningType} else self.redefiningFeature.featuringType->asSet()->including(anythingType) endif in let redefinedFeaturingTypes: OrderedSet(sysml::Type) = if self.redefinedFeature.isVariable then OrderedSet{redefinedFeature.owningType} else self.redefinedFeature.featuringType->asSet()->including(anythingType) endif in redefiningFeaturingTypes <> redefinedFeaturingTypes",
    ...
    validateRequirementConstraintMembershipIsComposite(
            SysmlPackage.eINSTANCE.getRequirementConstraintMembership(),
            "validateRequirementConstraintMembershipIsComposite",
            "aql:self.ownedConstraint.isComposite",
    ...
    validateRequirementConstraintMembershipOwningType(
            SysmlPackage.eINSTANCE.getRequirementConstraintMembership(),
            "validateRequirementConstraintMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::RequirementDefinition) or self.owningType.oclIsKindOf(sysml::RequirementUsage)",
    ...
    validateRequirementDefinitionOnlyOneSubject(
            SysmlPackage.eINSTANCE.getRequirementDefinition(),
            "validateRequirementDefinitionOnlyOneSubject",
            "aql:self.featureMembership-> oclIsKindOf(sysml::SubjectMembership)->size() <= 1",
    ...
    validateRequirementVerificationMembershipKind(
            SysmlPackage.eINSTANCE.getRequirementVerificationMembership(),
            "validateRequirementVerificationMembershipKind",
            "aql:self.kind = sysml::RequirementConstraintKind::requirement",
    ...
    validateRequirementVerificationMembershipOwningType(
            SysmlPackage.eINSTANCE.getRequirementVerificationMembership(),
            "validateRequirementVerificationMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::RequirementUsage) and self.owningType.owningFeatureMembership <> null and self.owningType.owningFeatureMembership.oclIsKindOf(sysml::ObjectiveMembership)",
    ...
    validateResultExpressionMembershipOwningType(
            SysmlPackage.eINSTANCE.getResultExpressionMembership(),
            "validateResultExpressionMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::Function) or self.owningType.oclIsKindOf(sysml::Expression)",
    ...
    validateReturnParameterMembershipOwningType(
            SysmlPackage.eINSTANCE.getReturnParameterMembership(),
            "validateReturnParameterMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::Function) or self.owningType.oclIsKindOf(sysml::Expression)",
    ...
    validateSatisfyRequirementUsageReference(
            SysmlPackage.eINSTANCE.getSatisfyRequirementUsage(),
            "validateSatisfyRequirementUsageReference",
            "aql:self.referencedFeatureTarget() <> null implies self.referencedFeatureTarget().oclIsKindOf(sysml::RequirementUsage)",
    ...
    validateSpecificationSpecificNotConjugated(
            SysmlPackage.eINSTANCE.getSpecialization(),
            "validateSpecificationSpecificNotConjugated",
            "aql:self.specific <> null and not self.specific.isConjugated",
            "The specific Type of a Specialization cannot be a conjugated Type."),
    validateStakeholderMembershipOwningType(
            SysmlPackage.eINSTANCE.getStakeholderMembership(),
            "validateStakeholderMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::RequirementUsage) or self.owningType.oclIsKindOf(sysml::RequirementDefinition)",
    ...
    validateStateDefinitionParallelSubactions(
            SysmlPackage.eINSTANCE.getStateDefinition(),
            "validateStateDefinitionParallelSubactions",
            "aql:self.isParallel implies self.ownedAction.incomingTransition->isEmpty() and self.ownedAction.outgoingTransition->isEmpty()",
    ...
    validateStateDefinitionStateSubactionKind(
            SysmlPackage.eINSTANCE.getStateDefinition(),
            "validateStateDefinitionStateSubactionKind",
            "aql:self.ownedMembership->filter(sysml::StateSubactionMembership)->isUnique(i | i.kind)",
    ...
    validateStateSubactionMembershipOwningType(
            SysmlPackage.eINSTANCE.getStateSubactionMembership(),
            "validateStateSubactionMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::StateDefinition) or self.owningType.oclIsKindOf(sysml::StateUsage)",
    ...
    validateStateUsageParallelSubactions(
            SysmlPackage.eINSTANCE.getStateUsage(),
            "validateStateUsageParallelSubactions",
            "aql:self.isParallel implies self.nestedAction.incomingTransition->isEmpty() and self.nestedAction.outgoingTransition->isEmpty()",
    ...
    validateStructureSpecialization(
            SysmlPackage.eINSTANCE.getStructure(),
            "validateStructureSpecialization",
            "aql:self.ownedSpecialization.general->forAll(i | not i.oclIsKindOf(sysml::Behavior))",
            "A Structure must not specialize a Behavior."),
    validateSubjectMembershipOwningType(
            SysmlPackage.eINSTANCE.getSubjectMembership(),
            "validateSubjectMembershipOwningType",
            "aql:self.owningType.ocIsTypeOf(sysml::RequirementDefinition) or self.owningType.ocIsTypeOf(sysml::RequiremenCaseRequirementDefinition) or self.owningType.ocIsTypeOf(sysml::CaseDefinition) or self.owningType.ocIsTypeOf(sysml::CaseUsage)",
    ...
    validateSubsettingConstantConformance(
            ...
            "validateSubsettingConstantConformance",
            "aql:self.subsettedFeature.isConstant and self.subsettingFeature.isVariable implies self.subsettingFeature.isConstant",
    ...
    validateSubsettingFeaturingTypes(
            SysmlPackage.eINSTANCE.getSubsetting(),
            "validateSubsettingFeaturingTypes",
            "aql:self.subsettingFeature.canAccess(self.subsettedFeature)",
            "The subsettedFeature must be accessible by the subsettingFeature."),
    validateSubsettingUniquenessConformance(
            SysmlPackage.eINSTANCE.getSubsetting(),
            "validateSubsettingUniquenessConformance",
            "aql:self.subsettedFeature.isUnique implies self.subsettingFeature.isUnique",
    ...
    validateTransitionFeatureMembershipEffectAction(
            SysmlPackage.eINSTANCE.getTransitionFeatureMembership(),
            "validateTransitionFeatureMembershipEffectAction",
            "aql:self.kind = sysml::TransitionFeatureKind::effect implies self.transitionFeature.oclIsKindOf(sysml::ActionUsage)",
    ...
    validateTransitionFeatureMembershipGuardExpression(
            SysmlPackage.eINSTANCE.getTransitionFeatureMembership(),
            "validateTransitionFeatureMembershipGuardExpression",
            "aql:self.kind = sysml::TransitionFeatureKind::guard implies self.transitionFeature.oclIsKindOf(sysml::Expression) and let guard : sysml::Expression = self.transitionFeature.oclIsKindOf(sysml::Expression) in guard.result.specializesFromLibrary('ScalarValues::Boolean') and guard.result.multiplicity <> null and guard.result.multiplicity.hasBounds(1,1)",
    ...
    validateTransitionFeatureMembershipOwningType(
            SysmlPackage.eINSTANCE.getTransitionFeatureMembership(),
            "validateTransitionFeatureMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::TransitionUsage)",
    ...
    validateTransitionFeatureMembershipTriggerAction(
            SysmlPackage.eINSTANCE.getTransitionFeatureMembership(),
            "validateTransitionFeatureMembershipTriggerAction",
            "aql:self.kind = sysml::TransitionFeatureKind::trigger implies self.transitionFeature.oclIsKindOf(sysml::AcceptActionUsage)",
    ...
    validateTransitionUsageParameters(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "validateTransitionUsageParameters",
            "aql:if self.triggerAction->isEmpty() then self.inputParameters()->size() >= 1 else self.inputParameters()->size() >= 2 endif",
    ...
    validateTransitionUsageSuccession(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "validateTransitionUsageSuccession",
            "aql:let successions : Sequence(sysml::Successions) = self.ownedMember->filter(sysml::Succession) in self.successions->notEmpty() and self.successions->at(1).targetFeature.featureTarget->forAll(oclIsKindOf(sysml::ActionUsage))",
    ...
    validateTransitionUsageTriggerActions(
            SysmlPackage.eINSTANCE.getTransitionUsage(),
            "validateTransitionUsageTriggerActions",
            "aql:self.source <> null and not self.source.oclIsKindOf(sysml::StateUsage) implies self.triggerAction->isEmpty()",
    ...
    validateTriggerInvocationExpressionAtArgument(
            SysmlPackage.eINSTANCE.getTriggerInvocationExpression(),
            "validateTriggerInvocationExpressionAtArgument",
            "aql:self.kind = sysml::TriggerKind::at implies self.argument->notEmpty() and self.argument->at(1).result.specializesFromLibrary('Time::TimeInstantValue')",
    ...
    validateTriggerInvocationExpressionWhenArgument(
            SysmlPackage.eINSTANCE.getTriggerInvocationExpression(),
            "validateTriggerInvocationExpressionWhenArgument",
            "aql:self.kind = sysml::TriggerKind::when implies self.argument->notEmpty() and self.argument->at(1).oclIsKindOf(sysml::FeatureReferenceExpression) and let referent : sysml::Feature = self.argument->at(1).oclAsType(sysml::FeatureReferenceExpression).referent in referent.oclIsKindOf(sysml::Expression) and referent.oclAsType(sysml::Expression).result.specializesFromLibrary('ScalarValues::Boolean')",
    ...
    validateUsageVariationSpecialization(
            SysmlPackage.eINSTANCE.getUsage(),
            "validateUsageVariationSpecialization",
            "aql:self.isVariation implies not self.ownedSpecialization.specific->exists(e | e.oclIsKindOf(sysml::Definition) and e.oclAsType(sysml::Definition).isVariation or e.oclIsKindOf(sysml::Usage) and e.oclAsType(sysml::Usage).isVariation)",
            "A variation Usage may not specialize any variation Definition or Usage."),
    validateVariantMembershipOwningNamespace(
            SysmlPackage.eINSTANCE.getVariantMembership(),
            "validateVariantMembershipOwningNamespace",
            "aql:self.membershipOwningNamespace.oclIsKindOf(sysml::Definition) and self.membershipOwningNamespace.oclAsType(sysml::Definition).isVariation or self.membershipOwningNamespace.oclIsKindOf(sysml::Usage) and self.membershipOwningNamespace.oclAsType(sysml::Usage).isVariation",
    ...
    validateViewDefinitionOnlyOneViewRendering(
            SysmlPackage.eINSTANCE.getViewDefinition(),
            "validateViewDefinitionOnlyOneViewRendering",
            "aql:self.featureMembership->filter(sysml::ViewRenderingMembership)->size() <= 1",
            "A ViewDefinition must have at most one ViewRenderingMembership."),
    validateViewRenderingMembershipOwningType(
            SysmlPackage.eINSTANCE.getViewRenderingMembership(),
            "validateViewRenderingMembershipOwningType",
            "aql:self.owningType.oclIsKindOf(sysml::ViewDefinition) or self.owningType.oclIsKindOf(sysml::ViewUsage)",
    ...
    SysMLValidationRule(final EClass eClass, final String name, final String expression, final String message) {
        this.eClass = Objects.requireNonNull(eClass);
        this.name = Objects.requireNonNull(name);
        this.expression = Objects.requireNonNull(expression);
        this.message = Objects.requireNonNull(message);
        // For now all validation rules from the specification are arbitrarily treated as WARNING.
        this.severity = Diagnostic.WARNING;
    }
