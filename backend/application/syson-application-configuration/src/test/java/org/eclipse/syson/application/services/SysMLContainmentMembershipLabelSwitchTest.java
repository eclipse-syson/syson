...
public class SysMLContainmentMembershipLabelSwitchTest {
    ...
    @DisplayName("GIVEN a Membership subtype," +
            " WHEN computing the user-friendly label," +
            " THEN a custom label is used for any subtype of Membership")
    @Test
    ...
    @DisplayName("GIVEN a Membership, " +
            "WHEN computing the user-friendly label, " +
            "THEN a custom label is used for a Membership")
    @Test
