...
/**
 * Implementation to handle SysMLPackage node style.
 *
 * @author arichard
 */
@Service
public class DiagramImporterSysMLPackageNodeStyleAppearanceChangeHandler implements IDiagramImporterNodeStyleAppearanceChangeHandler {
    ...
    public Optional<IAppearanceChange> handle(String nodeId, INodeStyle nodeStyle, String customizedStyleProperty) {
        if (nodeStyle instanceof SysMLPackageNodeStyle customNodeStyle) {
            return switch (customizedStyleProperty) {
                case SysMLPackageNodeAppearanceHandler.BACKGROUND -> Optional.of(new NodeBackgroundAppearanceChange(nodeId, customNodeStyle.getBackground()));
                case SysMLPackageNodeAppearanceHandler.BORDER_COLOR -> Optional.of(new NodeBorderColorAppearanceChange(nodeId, customNodeStyle.getBorderColor()));
                case SysMLPackageNodeAppearanceHandler.BORDER_SIZE -> Optional.of(new NodeBorderSizeAppearanceChange(nodeId, customNodeStyle.getBorderSize()));
                case SysMLPackageNodeAppearanceHandler.BORDER_STYLE -> Optional.of(new NodeBorderStyleAppearanceChange(nodeId, customNodeStyle.getBorderStyle()));
