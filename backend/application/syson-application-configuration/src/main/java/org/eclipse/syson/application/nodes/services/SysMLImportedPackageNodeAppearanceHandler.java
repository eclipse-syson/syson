...
/**
 * Service used to handle the customization of a SysMLImportedPackage node's appearance.
 *
 * @author arichard
 */
@Service
public class SysMLImportedPackageNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public boolean canHandle(INodeStyle nodeStyle) {
        return nodeStyle instanceof SysMLImportedPackageNodeStyle;
    }
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof SysMLImportedPackageNodeStyle providedSysMLImportedPackageNodeStyle) {
            SysMLImportedPackageNodeStyle.Builder styleBuilder = SysMLImportedPackageNodeStyle.newSysMLImportedPackageNodeStyle(providedSysMLImportedPackageNodeStyle);
    ...
    private void handleBackground(SysMLImportedPackageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
        ...
        if (!this.handleResetChange(BACKGROUND, changes, customizedStyleProperties)) {
            ...
            if (optionalBackgroundChange.isPresent()) {
                ...
                customizedStyleProperties.add(BACKGROUND);
                    ...
                    && optionalPreviousNodeStyle.get() instanceof SysMLImportedPackageNodeStyle previousNodeStyle) {
    ...
    private void handleBorderColor(SysMLImportedPackageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderSize(SysMLImportedPackageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderStyle(SysMLImportedPackageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
