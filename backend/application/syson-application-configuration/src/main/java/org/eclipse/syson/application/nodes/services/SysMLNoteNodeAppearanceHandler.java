...
/**
 * Service used to handle the customization of a SysMLNote node's appearance.
 *
 * @author arichard
 */
@Service
public class SysMLNoteNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof SysMLNoteNodeStyle providedSysMLNoteNodeStyle) {
            SysMLNoteNodeStyle.Builder styleBuilder = SysMLNoteNodeStyle.newSysMLNoteNodeStyle(providedSysMLNoteNodeStyle);
    ...
    private void handleBackground(SysMLNoteNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
        ...
        if (!this.handleResetChange(BACKGROUND, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BACKGROUND) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof SysMLNoteNodeStyle previousNodeStyle) {
    ...
    private void handleBorderColor(SysMLNoteNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
        if (!this.handleResetChange(BORDER_COLOR, changes, customizedStyleProperties)) {
            ...
            if (optionalBorderColorChange.isPresent()) {
                ...
                customizedStyleProperties.add(BORDER_COLOR);
                    ...
                    && optionalPreviousNodeStyle.get() instanceof SysMLNoteNodeStyle previousNodeStyle) {
    ...
    private void handleBorderSize(SysMLNoteNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
        if (!this.handleResetChange(BORDER_SIZE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_SIZE) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof SysMLNoteNodeStyle previousNodeStyle) {
    ...
    private void handleBorderStyle(SysMLNoteNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
