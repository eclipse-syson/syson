...
public class SysMLv2ProjectTemplatesProvider implements IProjectTemplateProvider {
    ...
    public List<ProjectTemplate> getProjectTemplates() {
        var sysmlv2LibraryTemplate = new ProjectTemplate(SYSMLV2_LIBRARY_TEMPLATE_ID, "SysMLv2-Library", "/images/sysmlv2-logo.png", List.of());
        var sysmlv2Template = new ProjectTemplate(SYSMLV2_TEMPLATE_ID, "SysMLv2", "/images/sysmlv2-logo.png", List.of());
        var batmobileTemplate = new ProjectTemplate(BATMOBILE_TEMPLATE_ID, "Batmobile", "/images/sysmlv2-logo.png", List.of());
