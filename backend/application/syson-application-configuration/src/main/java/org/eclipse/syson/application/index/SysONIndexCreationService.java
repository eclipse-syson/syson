    ...
    public boolean createIndex(String editingContextId) {
        ...
        if (this.optionalElasticSearchClient.isPresent()) {
            ...
            try {
                ...
                if (exception instanceof ElasticsearchException elasticsearchException && "resource_already_exists_exception".equals(elasticsearchException.error().type())) {
                    this.logger.debug("The index for editing context {} already exists", editingContextId);
                } else {
