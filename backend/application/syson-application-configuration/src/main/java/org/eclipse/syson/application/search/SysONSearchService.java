 ...
 *
 * @technical-debt This class should be a delegate (and not use the @Primary annotation) once the <a href="https://github.com/eclipse-sirius/sirius-web/issues/5892">issue 5892</a> is fixed in
 *         Sirius Web.
 *
 * @author gdaniel
 */
