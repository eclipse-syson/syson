...
/**
 * Service used to handle the customization of a SysMLViewFrame node's appearance.
 *
 * @author arichard
 */
@Service
public class SysMLViewFrameNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof SysMLViewFrameNodeStyle providedSysMLViewFrameNodeStyle) {
            SysMLViewFrameNodeStyle.Builder styleBuilder = SysMLViewFrameNodeStyle.newSysMLViewFrameNodeStyle(providedSysMLViewFrameNodeStyle);
    ...
    private void handleBackground(SysMLViewFrameNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
        ...
        if (!this.handleResetChange(BACKGROUND, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BACKGROUND) && optionalPreviousNodeStyle.isPresent()
                    && optionalPreviousNodeStyle.get() instanceof SysMLViewFrameNodeStyle previousNodeStyle) {
    ...
    private void handleBorderColor(SysMLViewFrameNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderSize(SysMLViewFrameNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
        if (!this.handleResetChange(BORDER_SIZE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_SIZE) && optionalPreviousNodeStyle.isPresent()
                    && optionalPreviousNodeStyle.get() instanceof SysMLViewFrameNodeStyle previousNodeStyle) {
    ...
    private void handleBorderStyle(SysMLViewFrameNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderRadius(SysMLViewFrameNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
        if (!this.handleResetChange(BORDER_RADIUS, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_RADIUS) && optionalPreviousNodeStyle.isPresent()
                    && optionalPreviousNodeStyle.get() instanceof SysMLViewFrameNodeStyle previousNodeStyle) {
