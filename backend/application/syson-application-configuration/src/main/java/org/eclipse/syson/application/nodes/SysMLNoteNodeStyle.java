...
/**
 * The SysML note node style. This code has been fully inspired from NoteNodeStyle.java in
 * https://github.com/PapyrusSirius/papyrus-web
 *
 * @author jmallet
 */
@Immutable
public final class SysMLNoteNodeStyle implements INodeStyle {
    ...
    public static Builder newSysMLNoteNodeStyle() {
        return new Builder();
    }
