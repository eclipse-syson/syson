...
public class MutationEditSysMLPackageNodeAppearanceDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationEditSysMLPackageNodeAppearanceDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, EditSysMLPackageNodeAppearanceInput.class);
